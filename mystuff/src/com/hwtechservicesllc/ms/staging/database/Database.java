...
public final class Database {
    ...
    public static final class Query implements BaseColumns {
        ...
        public static final String asColumnsToReturn[] = {
                Portfolio.PORTFOLIO_TABLE_NAME + "." + Portfolio._ID,
                Portfolio.PORTFOLIO_TABLE_NAME + "." + Portfolio.TICKER_SYMBOL,
                Portfolio.PORTFOLIO_TABLE_NAME + "." + Portfolio.OPENING_PRICE,
                Portfolio.PORTFOLIO_TABLE_NAME + "." + Portfolio.PREVIOUS_CLOSING_PRICE,
                Portfolio.PORTFOLIO_TABLE_NAME + "." + Portfolio.LAST_TRADE_PRICE,
                Portfolio.PORTFOLIO_TABLE_NAME + "." + Portfolio.LAST_TRADE_TIME
        };

        public static final String fromDBColumns[] =  {
                Portfolio.TICKER_SYMBOL,
                Portfolio.OPENING_PRICE,
                Portfolio.PREVIOUS_CLOSING_PRICE,
