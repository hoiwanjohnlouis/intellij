package com.hwtechservicesllc.ms.staging.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sbCreateCompanyTable.append(Company.TICKER_SYMBOL);
        sbCreateCompanyTable.append(" TEXT NOT NULL, ");

        sbCreateCompanyTable.append(Company.INSERT_DATETIME);
        sbCreateCompanyTable.append(" DATETIME DEFAULT CURRENT_TIMESTAMP, ");
        ...
        sbCreateExchangeTable.append(" DATETIME DEFAULT CURRENT_TIMESTAMP, ");
        ...
        sbCreateCatalogueTable.append(" DATETIME DEFAULT CURRENT_TIMESTAMP, ");
        ...
        sbCreatePortfolioTable.append(Portfolio.TICKER_SYMBOL);
        ...
        sbCreatePortfolioTable.append(" DATETIME DEFAULT CURRENT_TIMESTAMP, ");
