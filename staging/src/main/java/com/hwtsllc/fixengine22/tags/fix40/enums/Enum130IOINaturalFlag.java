 ...
 *  <p>    Y - Natural
 */
public enum Enum130IOINaturalFlag implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - Not Natural"),
    YES ("Y", "YES", "Y - Natural"),
    ;
    ...
    Enum130IOINaturalFlag(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
