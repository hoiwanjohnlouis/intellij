 ...
 */
public class Tag22EnuSecurityIDSource extends FIX27Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public static void main(String[] args) {
        System.out.println( new Tag22EnuSecurityIDSource(TESTA_ENU_SECURITY_ID_SOURCE).toVerboseString() );
        System.out.println( new Tag22EnuSecurityIDSource(TESTB_ENU_SECURITY_ID_SOURCE).toVerboseString() );

        // loop around the ENUM and display
        for (MyEnumSecurityIDSource oneEnum : MyEnumSecurityIDSource.values()) {
            System.out.println( new Tag22EnuSecurityIDSource(oneEnum).toVerboseString() );
        }
    }
}
