 ...
 */
public class Log106StrIssuer extends FIX30Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log106StrIssuer(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log106StrIssuer(new MyStringType(TESTA_STR_ISSUER) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log106StrIssuer(new MyStringType(TESTB_STR_ISSUER) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
