 ...
 */
public enum Bool113ReportToExch implements LogFIXString, LogVerboseString {
    ...
    Bool113ReportToExch(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
