 ...
 */
public class Log112StrTestReqID extends FIX30Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log112StrTestReqID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log112StrTestReqID(new MyStringType(TESTA_STR_TEST_REQ_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log112StrTestReqID(new MyStringType(TESTB_STR_TEST_REQ_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
