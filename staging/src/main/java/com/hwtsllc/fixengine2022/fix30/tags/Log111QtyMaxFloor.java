 ...
 */
public class Log111QtyMaxFloor extends FIX30Abstract implements LogValuePairString, LogVerboseString {
    private final MyQtyType dataValue;

    public final static int TESTA_QTY_MAX_FLOOR = 111; // fake data
    public final static int TESTB_QTY_MAX_FLOOR = 222;

    public Log111QtyMaxFloor(MyQtyType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log111QtyMaxFloor(new MyQtyType(TESTA_QTY_MAX_FLOOR) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log111QtyMaxFloor(new MyQtyType(TESTB_QTY_MAX_FLOOR) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
