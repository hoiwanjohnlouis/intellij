...
public class Tag104EtIOIQualifier extends TagTypeAbstract {
    ...
    public Tag104EtIOIQualifier(Enum104IOIQualifier dataValue) {
        setFixType(FIXType.FIX104_ET_IOI_QUALIFIER);
    ...
    public static void main(String[] args) {
        Tag104EtIOIQualifier tagData = new Tag104EtIOIQualifier(TESTA_ET_IOI_QUALIFIER);
