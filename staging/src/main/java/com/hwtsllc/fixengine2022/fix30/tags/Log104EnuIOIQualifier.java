 ...
 *  <p>    Z - Pre-open
 */
public class Log104EnuIOIQualifier extends FIX30Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log104EnuIOIQualifier(MyEnumQualifier dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log104EnuIOIQualifier(TESTA_ENU_IOI_QUALIFIER);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log104EnuIOIQualifier(TESTB_ENU_IOI_QUALIFIER);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
