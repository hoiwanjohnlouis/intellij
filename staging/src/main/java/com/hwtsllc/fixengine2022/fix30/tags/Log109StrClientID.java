 ...
 */
// @Deprecated
public class Log109StrClientID extends FIX30Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log109StrClientID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log109StrClientID(new MyStringType(TESTA_STR_CLIENT_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log109StrClientID(new MyStringType(TESTB_STR_CLIENT_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
