 ...
 */
public class Log113BoolReportToExch extends FIX30Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log113BoolReportToExch(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log113BoolReportToExch(TESTA_BOOL_REPORT_TO_EXCH);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log113BoolReportToExch(TESTB_BOOL_REPORT_TO_EXCH);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
