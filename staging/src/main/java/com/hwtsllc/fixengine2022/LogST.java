...
public class LogST extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final DataSType dataValue;

    public LogST(DataSType dataValue) {
    ...
    public static void main(String[] args) {
        LogST tagData = new LogST(new DataSType("3123") );
