...
public class LogIT extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final DataIType dataValue;

    public LogIT(DataIType dataValue) {
    ...
    public static void main(String[] args) {
        LogIT tagData = new LogIT(new DataIType(3123) );
        System.out.println("initial values");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
        System.out.println("after updating dataValue");
        tagData.setDataValue(87654321);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
