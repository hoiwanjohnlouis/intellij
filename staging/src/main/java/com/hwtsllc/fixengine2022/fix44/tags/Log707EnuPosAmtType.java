 ...
 */
public class Log707EnuPosAmtType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log707EnuPosAmtType(Enum707PosAmtType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log707EnuPosAmtType(TESTA_ENU_POS_AMT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log707EnuPosAmtType(TESTB_ENU_POS_AMT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
