 ...
 */
public class Log871EnuInstrAttribType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log871EnuInstrAttribType(Enum871InstrAttribType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log871EnuInstrAttribType(TESTA_ENU_INSTR_ATTRIB_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log871EnuInstrAttribType(TESTB_ENU_INSTR_ATTRIB_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
