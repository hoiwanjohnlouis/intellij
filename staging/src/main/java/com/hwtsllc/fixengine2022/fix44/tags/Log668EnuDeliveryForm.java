 ...
 *      2 - Bearer
 */
public class Log668EnuDeliveryForm extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log668EnuDeliveryForm(Enum668DeliveryForm dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log668EnuDeliveryForm(TESTA_ENU_DELIVERY_FORM);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log668EnuDeliveryForm(TESTB_ENU_DELIVERY_FORM);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
