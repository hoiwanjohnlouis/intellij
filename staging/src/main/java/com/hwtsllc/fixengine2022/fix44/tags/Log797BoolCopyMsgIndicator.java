 ...
 */
public class Log797BoolCopyMsgIndicator extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log797BoolCopyMsgIndicator(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log797BoolCopyMsgIndicator(TESTA_BOOL_COPY_MSG_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log797BoolCopyMsgIndicator(TESTB_BOOL_COPY_MSG_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
