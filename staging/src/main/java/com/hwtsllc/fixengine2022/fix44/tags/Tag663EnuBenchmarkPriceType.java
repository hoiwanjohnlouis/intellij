 ...
 */
public class Tag663EnuBenchmarkPriceType extends FIX44Abstract implements FixTagValuePairString, LogStringVerbose {
    private final Enum663BenchmarkPriceType dataValue;

    public final static Enum663BenchmarkPriceType TESTA_ENU_BENCHMARK_PRICE_TYPE
            = Enum663BenchmarkPriceType.FIXED_TRADE_PRICE;
    public final static Enum663BenchmarkPriceType TESTB_ENU_BENCHMARK_PRICE_TYPE
            = Enum663BenchmarkPriceType.PERCENTAGE;

    public Tag663EnuBenchmarkPriceType(Enum663BenchmarkPriceType dataValue) {
