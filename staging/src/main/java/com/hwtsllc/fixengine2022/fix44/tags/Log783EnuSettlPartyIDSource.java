 ...
 */
public class Log783EnuSettlPartyIDSource extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log783EnuSettlPartyIDSource(MyEnumPartyIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log783EnuSettlPartyIDSource(TESTA_ENU_SETTL_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log783EnuSettlPartyIDSource(TESTB_ENU_SETTL_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
