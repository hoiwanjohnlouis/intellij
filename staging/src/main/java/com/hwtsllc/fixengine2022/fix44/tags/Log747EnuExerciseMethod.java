 ...
 *      M - Manual
 */
public class Log747EnuExerciseMethod extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log747EnuExerciseMethod(Enum747ExerciseMethod dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log747EnuExerciseMethod(TESTA_ENU_EXERCISE_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log747EnuExerciseMethod(TESTB_ENU_EXERCISE_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
