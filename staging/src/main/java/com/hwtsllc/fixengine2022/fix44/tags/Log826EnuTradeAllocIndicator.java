 ...
 */
public class Log826EnuTradeAllocIndicator extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log826EnuTradeAllocIndicator(Enum826TradeAllocIndicator dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log826EnuTradeAllocIndicator(TESTA_ENU_TRADE_ALLOC_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log826EnuTradeAllocIndicator(TESTB_ENU_TRADE_ALLOC_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
