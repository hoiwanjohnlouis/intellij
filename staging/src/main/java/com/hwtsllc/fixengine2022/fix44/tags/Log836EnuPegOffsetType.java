 ...
 */
public class Log836EnuPegOffsetType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log836EnuPegOffsetType(MyEnumOffsetType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log836EnuPegOffsetType(TESTA_ENU_PEG_OFFSET_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log836EnuPegOffsetType(TESTB_ENU_PEG_OFFSET_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
