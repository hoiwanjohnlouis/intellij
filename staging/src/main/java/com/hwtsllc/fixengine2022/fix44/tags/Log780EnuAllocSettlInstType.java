 ...
 */
public class Log780EnuAllocSettlInstType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log780EnuAllocSettlInstType(Enum780AllocSettlInstType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log780EnuAllocSettlInstType(TESTA_ENU_ALLOC_SETTL_INST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log780EnuAllocSettlInstType(TESTB_ENU_ALLOC_SETTL_INST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
