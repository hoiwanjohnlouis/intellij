 ...
 */
public class Log759EnuNested2PartyRole extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log759EnuNested2PartyRole(MyEnumPartyRole dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log759EnuNested2PartyRole(TESTA_ENU_NESTED_2_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log759EnuNested2PartyRole(TESTB_ENU_NESTED_2_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
