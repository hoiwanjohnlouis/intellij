 ...
 */
public class Log805EnuNestedPartySubIDType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log805EnuNestedPartySubIDType(MyEnumPartySubIDType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log805EnuNestedPartySubIDType(TESTA_ENU_NESTED_PARTY_SUB_ID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log805EnuNestedPartySubIDType(TESTB_ENU_NESTED_PARTY_SUB_ID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
