 ...
 */
public class Log686EnuLegPriceType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log686EnuLegPriceType(MyEnumPriceType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log686EnuLegPriceType(TESTA_ENU_LEG_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log686EnuLegPriceType(TESTB_ENU_LEG_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
