 ...
 *      4 - Challenged
 */
public class Log910EnuCollStatus extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log910EnuCollStatus(Enum910CollStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log910EnuCollStatus(TESTA_ENU_COLL_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log910EnuCollStatus(TESTB_ENU_COLL_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
