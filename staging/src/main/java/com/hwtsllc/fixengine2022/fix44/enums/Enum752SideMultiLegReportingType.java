 ...
 *      3 - Multileg Security
 */
public enum Enum752SideMultiLegReportingType implements EnumAccessors, LogVerboseString {
    ...
    Enum752SideMultiLegReportingType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
