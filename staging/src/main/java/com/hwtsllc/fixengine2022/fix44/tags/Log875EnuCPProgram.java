 ...
 */
public class Log875EnuCPProgram extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log875EnuCPProgram(Enum875CPProgram dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log875EnuCPProgram(TESTA_ENU_CP_PROGRAM);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log875EnuCPProgram(TESTB_ENU_CP_PROGRAM);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
