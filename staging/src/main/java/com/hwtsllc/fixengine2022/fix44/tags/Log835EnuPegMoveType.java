 ...
 *  <p>    1 - Fixed
 */
public class Log835EnuPegMoveType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log835EnuPegMoveType(MyEnumMoveType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log835EnuPegMoveType(TESTA_ENU_PEG_MOVE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log835EnuPegMoveType(TESTB_ENU_PEG_MOVE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
