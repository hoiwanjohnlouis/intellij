 ...
 */
public class Log774EnuConfirmRejReason extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log774EnuConfirmRejReason(Enum774ConfirmRejReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log774EnuConfirmRejReason(TESTA_ENU_CONFIRM_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log774EnuConfirmRejReason(TESTB_ENU_CONFIRM_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
