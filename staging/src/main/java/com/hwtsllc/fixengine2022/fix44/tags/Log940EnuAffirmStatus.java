 ...
 *      3 - Affirmed
 */
public class Log940EnuAffirmStatus extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log940EnuAffirmStatus(Enum940AffirmStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log940EnuAffirmStatus(TESTA_ENU_AFFIRM_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log940EnuAffirmStatus(TESTB_ENU_AFFIRM_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
