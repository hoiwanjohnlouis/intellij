 ...
 */
public class Log853EnuShortSaleReason extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log853EnuShortSaleReason(Enum853ShortSaleReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log853EnuShortSaleReason(TESTA_ENU_SHORT_SALE_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log853EnuShortSaleReason(TESTB_ENU_SHORT_SALE_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
