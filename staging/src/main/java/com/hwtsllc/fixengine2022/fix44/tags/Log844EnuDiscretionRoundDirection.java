 ...
 */
public class Log844EnuDiscretionRoundDirection extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log844EnuDiscretionRoundDirection(MyEnumRoundDirection dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log844EnuDiscretionRoundDirection(TESTA_ENU_DISCRETION_ROUND_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log844EnuDiscretionRoundDirection(TESTB_ENU_DISCRETION_ROUND_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
