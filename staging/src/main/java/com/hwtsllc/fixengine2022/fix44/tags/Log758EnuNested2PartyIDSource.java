 ...
 */
public class Log758EnuNested2PartyIDSource extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log758EnuNested2PartyIDSource(MyEnumPartyIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log758EnuNested2PartyIDSource(TESTA_ENU_NESTED_2_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log758EnuNested2PartyIDSource(TESTB_ENU_NESTED_2_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
