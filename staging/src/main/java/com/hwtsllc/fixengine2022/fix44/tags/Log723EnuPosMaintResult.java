 ...
 */
public class Log723EnuPosMaintResult extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log723EnuPosMaintResult(Enum723PosMaintResult dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log723EnuPosMaintResult(TESTA_ENU_POS_MAINT_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log723EnuPosMaintResult(TESTB_ENU_POS_MAINT_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
