 ...
 */
public class Tag807EnuNested2PartySubIDType extends FIX44Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    private final MyEnumPartySubIDType dataValue;

    public final static MyEnumPartySubIDType TESTA_ENU_NESTED_2_PARTY_SUB_ID_TYPE
            = MyEnumPartySubIDType.APPLICATION;
    public final static MyEnumPartySubIDType TESTB_ENU_NESTED_2_PARTY_SUB_ID_TYPE
            = MyEnumPartySubIDType.BIC;

    public Tag807EnuNested2PartySubIDType(MyEnumPartySubIDType dataValue) {
        setFixType(FIX44.FIX807_ENU_NESTED_2_PARTY_SUB_ID_TYPE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag807EnuNested2PartySubIDType(TESTA_ENU_NESTED_2_PARTY_SUB_ID_TYPE);
        System.out.println(tagData.toVerboseString());

        tagData = new Tag807EnuNested2PartySubIDType(TESTB_ENU_NESTED_2_PARTY_SUB_ID_TYPE);
        System.out.println(tagData.toVerboseString());

        // loop around the ENUM and process
        for ( MyEnumPartySubIDType oneEnum : MyEnumPartySubIDType.values()) {
            System.out.println( new Tag807EnuNested2PartySubIDType(oneEnum).toVerboseString() );
        }
    }
}
