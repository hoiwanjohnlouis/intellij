 ...
 */
public enum Enum937NetworkStatusResponseType implements EnumAccessors, LogVerboseString {
    FULL( "1", "FULL", "1 - Full" ),
    ...
    Enum937NetworkStatusResponseType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
