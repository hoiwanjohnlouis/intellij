 ...
 *      2 - Total Return Swap
 */
public class Log775EnuBookingType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log775EnuBookingType(Enum775BookingType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log775EnuBookingType(TESTA_ENU_BOOKING_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log775EnuBookingType(TESTB_ENU_BOOKING_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
