 ...
 */
public class Log751EnuTradeReportRejectReason extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log751EnuTradeReportRejectReason(Enum751TradeReportRejectReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log751EnuTradeReportRejectReason(TESTA_ENU_TRADE_REPORT_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log751EnuTradeReportRejectReason(TESTB_ENU_TRADE_REPORT_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
