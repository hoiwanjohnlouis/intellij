 ...
 *  <p>    3 - End Session
 */
public class Log814EnuApplQueueResolution extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log814EnuApplQueueResolution(MyEnumApplQueue dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log814EnuApplQueueResolution(TESTA_ENU_APPL_QUEUE_RESOLUTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log814EnuApplQueueResolution(TESTB_ENU_APPL_QUEUE_RESOLUTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
