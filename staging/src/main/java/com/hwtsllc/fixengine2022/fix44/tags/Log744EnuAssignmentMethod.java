 ...
 *  <p>    R - Random
 */
public class Log744EnuAssignmentMethod extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log744EnuAssignmentMethod(MyEnumAssignmentMethod dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log744EnuAssignmentMethod(TESTA_ENU_ASSIGNMENT_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log744EnuAssignmentMethod(TESTB_ENU_ASSIGNMENT_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
