 ...
 */
public class Log784EnuSettlPartyRole extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    private final MyEnumPartyRole dataValue;

    public final static MyEnumPartyRole TESTA_ENU_SETTL_PARTY_ROLE
            = MyEnumPartyRole.INTERESTED_PARTY;
    public final static MyEnumPartyRole TESTB_ENU_SETTL_PARTY_ROLE
            = MyEnumPartyRole.ASSET_MANAGER;

    public Log784EnuSettlPartyRole(MyEnumPartyRole dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log784EnuSettlPartyRole(TESTA_ENU_SETTL_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log784EnuSettlPartyRole(TESTB_ENU_SETTL_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
