 ...
 *      2 - Theoretical
 */
public class Log731EnuSettlPriceType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log731EnuSettlPriceType(Enum731SettlPriceType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log731EnuSettlPriceType(TESTA_ENU_SETTL_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log731EnuSettlPriceType(TESTB_ENU_SETTL_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
