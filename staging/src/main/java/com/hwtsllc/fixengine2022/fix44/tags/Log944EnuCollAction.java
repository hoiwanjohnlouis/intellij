 ...
 *      2 - Remove
 */
public class Log944EnuCollAction extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log944EnuCollAction(Enum944CollAction dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log944EnuCollAction(TESTA_ENU_COLL_ACTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log944EnuCollAction(TESTB_ENU_COLL_ACTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
