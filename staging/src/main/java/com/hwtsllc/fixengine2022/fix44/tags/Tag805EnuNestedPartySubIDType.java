 ...
 */
public class Tag805EnuNestedPartySubIDType extends FIX44Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    private final MyEnumPartySubIDType dataValue;

    public final static MyEnumPartySubIDType TESTA_ENU_NESTED_PARTY_SUB_ID_TYPE
            = MyEnumPartySubIDType.SECURITY_LOCATE_ID;
    public final static MyEnumPartySubIDType TESTB_ENU_NESTED_PARTY_SUB_ID_TYPE
            = MyEnumPartySubIDType.FUND_ACCOUNT_NAME;

    public Tag805EnuNestedPartySubIDType(MyEnumPartySubIDType dataValue) {
        setFixType(FIX44.FIX805_ENU_NESTED_PARTY_SUB_ID_TYPE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag805EnuNestedPartySubIDType(TESTA_ENU_NESTED_PARTY_SUB_ID_TYPE);
        System.out.println(tagData.toVerboseString());

        tagData = new Tag805EnuNestedPartySubIDType(TESTB_ENU_NESTED_PARTY_SUB_ID_TYPE);
        System.out.println(tagData.toVerboseString());

        // loop around the ENUM and process
        for ( MyEnumPartySubIDType oneEnum : MyEnumPartySubIDType.values()) {
            System.out.println( new Tag805EnuNestedPartySubIDType(oneEnum).toVerboseString() );
        }
    }
}
