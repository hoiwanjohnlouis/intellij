 ...
 *      2 - Rejected
 */
public enum Enum750TradeRequestStatus implements EnumAccessors, LogVerboseString {
    ...
    Enum750TradeRequestStatus(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
