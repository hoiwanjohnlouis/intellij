 ...
 *      4 - Open
 */
public class Log788EnuTerminationType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log788EnuTerminationType(Enum788TerminationType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log788EnuTerminationType(TESTA_ENU_TERMINATION_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log788EnuTerminationType(TESTB_ENU_TERMINATION_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
