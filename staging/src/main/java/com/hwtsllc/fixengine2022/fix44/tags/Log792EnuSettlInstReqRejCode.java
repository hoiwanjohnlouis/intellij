 ...
 */
public class Log792EnuSettlInstReqRejCode extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log792EnuSettlInstReqRejCode(Enum792SettlInstReqRejCode dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log792EnuSettlInstReqRejCode(TESTA_ENU_SETTL_INST_REQ_REJ_CODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log792EnuSettlInstReqRejCode(TESTB_ENU_SETTL_INST_REQ_REJ_CODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
