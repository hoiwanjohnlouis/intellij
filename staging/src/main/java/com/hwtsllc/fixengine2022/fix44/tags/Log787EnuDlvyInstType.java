 ...
 *      S - Securities
 */
public class Log787EnuDlvyInstType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log787EnuDlvyInstType(Enum787DlvyInstType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log787EnuDlvyInstType(TESTA_ENU_DLVY_INST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log787EnuDlvyInstType(TESTB_ENU_DLVY_INST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
