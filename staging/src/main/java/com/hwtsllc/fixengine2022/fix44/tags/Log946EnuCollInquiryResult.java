 ...
 */
public class Log946EnuCollInquiryResult extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log946EnuCollInquiryResult(Enum946CollInquiryResult dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log946EnuCollInquiryResult(TESTA_ENU_COLL_INQUIRY_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log946EnuCollInquiryResult(TESTB_ENU_COLL_INQUIRY_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
