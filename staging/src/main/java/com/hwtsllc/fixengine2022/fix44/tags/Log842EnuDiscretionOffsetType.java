 ...
 */
public class Log842EnuDiscretionOffsetType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log842EnuDiscretionOffsetType(MyEnumOffsetType dataValue) {
    ...
    public static void main(String[] args) {
        Log842EnuDiscretionOffsetType tagData;

        tagData = new Log842EnuDiscretionOffsetType(TESTA_ENU_DISCRETION_OFFSET_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log842EnuDiscretionOffsetType(TESTB_ENU_DISCRETION_OFFSET_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
