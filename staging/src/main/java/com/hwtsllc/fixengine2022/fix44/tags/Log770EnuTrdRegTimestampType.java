 ...
 *      6 - Desk Receipt
 */
public class Log770EnuTrdRegTimestampType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log770EnuTrdRegTimestampType(Enum770TrdRegTimestampType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log770EnuTrdRegTimestampType(TESTA_ENU_TRD_REG_TIMESTAMP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log770EnuTrdRegTimestampType(TESTB_ENU_TRD_REG_TIMESTAMP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
