 ...
 *  2 - Rejected
 */
public class Log706EnuPosQtyStatus extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log706EnuPosQtyStatus(Enum706PosQtyStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log706EnuPosQtyStatus(TESTA_ENU_POS_QTY_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log706EnuPosQtyStatus(TESTB_ENU_POS_QTY_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
