 ...
 */
public class Log663EnuBenchmarkPriceType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log663EnuBenchmarkPriceType(MyEnumPriceType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log663EnuBenchmarkPriceType(TESTA_ENU_BENCHMARK_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log663EnuBenchmarkPriceType(TESTB_ENU_BENCHMARK_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
