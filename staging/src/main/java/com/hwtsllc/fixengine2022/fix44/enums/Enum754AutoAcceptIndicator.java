 ...
 */
public enum Enum754AutoAcceptIndicator implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - Allocation Pending Accept"),
    YES ("Y", "YES", "Y - Allocation Automatically Accepted"),
    ;
    ...
    Enum754AutoAcceptIndicator(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
