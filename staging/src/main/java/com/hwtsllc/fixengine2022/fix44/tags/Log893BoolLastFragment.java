 ...
 *      Y - Last Message
 */
public class Log893BoolLastFragment extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log893BoolLastFragment(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log893BoolLastFragment(TESTA_BOOL_LAST_FRAGMENT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log893BoolLastFragment(TESTB_BOOL_LAST_FRAGMENT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
