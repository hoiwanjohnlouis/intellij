 ...
 */
public class Log803EnuPartySubIDType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log803EnuPartySubIDType(MyEnumPartySubIDType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log803EnuPartySubIDType(TESTA_ENU_PARTY_SUB_ID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log803EnuPartySubIDType(TESTB_ENU_PARTY_SUB_ID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
