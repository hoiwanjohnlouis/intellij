 ...
 */
public class Log776EnuIndividualAllocRejCode extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log776EnuIndividualAllocRejCode(MyEnumAllocRejCode dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log776EnuIndividualAllocRejCode(TESTA_ENU_INDIVIDUAL_ALLOC_REJ_CODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log776EnuIndividualAllocRejCode(TESTB_ENU_INDIVIDUAL_ALLOC_REJ_CODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
