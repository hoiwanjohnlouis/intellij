 ...
 */
public class Log951EnuNested3PartyRole extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log951EnuNested3PartyRole(MyEnumPartyRole dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log951EnuNested3PartyRole(TESTA_ENU_NESTED_3_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log951EnuNested3PartyRole(TESTB_ENU_NESTED_3_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
