 ...
 *      4 - In Process
 */
public class Log928EnuStatusValue extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log928EnuStatusValue(Enum928StatusValue dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log928EnuStatusValue(TESTA_ENU_STATUS_VALUE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log928EnuStatusValue(TESTB_ENU_STATUS_VALUE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
