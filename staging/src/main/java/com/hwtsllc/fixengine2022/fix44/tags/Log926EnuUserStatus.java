 ...
 *      6 - Other
 */
public class Log926EnuUserStatus extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log926EnuUserStatus(Enum926UserStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log926EnuUserStatus(TESTA_ENU_USER_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log926EnuUserStatus(TESTB_ENU_USER_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
