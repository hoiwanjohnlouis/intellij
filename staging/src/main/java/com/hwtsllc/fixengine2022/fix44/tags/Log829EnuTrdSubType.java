 ...
 */
public class Log829EnuTrdSubType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log829EnuTrdSubType(Enum829TrdSubType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log829EnuTrdSubType(TESTA_ENU_TRD_SUB_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log829EnuTrdSubType(TESTB_ENU_TRD_SUB_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
