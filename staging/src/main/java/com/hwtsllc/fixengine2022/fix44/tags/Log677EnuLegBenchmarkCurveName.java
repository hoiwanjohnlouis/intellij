 ...
 *  <p>    Treasury - Treasury
 */
public class Log677EnuLegBenchmarkCurveName extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log677EnuLegBenchmarkCurveName(MyEnumBenchmarkCurveName dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log677EnuLegBenchmarkCurveName(TESTA_ENU_LEG_BENCHMARK_CURVE_NAME);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log677EnuLegBenchmarkCurveName(TESTB_ENU_LEG_BENCHMARK_CURVE_NAME);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
