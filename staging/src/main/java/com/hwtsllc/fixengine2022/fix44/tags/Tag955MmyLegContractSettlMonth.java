 ...
 */
public class Tag955MmyLegContractSettlMonth extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    private final MyMonthYearType dataValue;

    public final static String TESTA_MMY_LEG_CONTRACT_SETTL_MONTH
            = "GretaGarbo-Tag955MmyLegContractSettlMonth";
    public final static String TESTB_MMY_LEG_CONTRACT_SETTL_MONTH
            = "PauletteGoddard-Tag955MmyLegContractSettlMonth";

    public Tag955MmyLegContractSettlMonth( MyMonthYearType dataValue) {
        setFixType( FIX44.FIX955_MMY_LEG_CONTRACT_SETTL_MONTH );
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag955MmyLegContractSettlMonth(new MyMonthYearType( TESTA_MMY_LEG_CONTRACT_SETTL_MONTH ) );
        System.out.println(tagData.toVerboseString());

        tagData = new Tag955MmyLegContractSettlMonth(new MyMonthYearType( TESTB_MMY_LEG_CONTRACT_SETTL_MONTH ) );
        System.out.println(tagData.toVerboseString());
    }
}
