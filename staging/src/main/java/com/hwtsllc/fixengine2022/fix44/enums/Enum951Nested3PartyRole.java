 ...
 */
public enum Enum951Nested3PartyRole implements EnumAccessors, LogStringVerbose {
    /*
    ...
    Enum951Nested3PartyRole(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
    ...
    public static void main(String[] args) {
         ...
         */
        for (Enum951Nested3PartyRole oneEnum : Enum951Nested3PartyRole.values()) {
