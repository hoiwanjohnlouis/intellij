 ...
 *      6 - Pass
 */
public class Tag694EnuQuoteRespType extends FIX44Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public Tag694EnuQuoteRespType(Enum694QuoteRespType dataValue) {
