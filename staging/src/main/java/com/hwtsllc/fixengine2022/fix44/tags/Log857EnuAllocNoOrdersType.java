 ...
 */
public class Log857EnuAllocNoOrdersType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log857EnuAllocNoOrdersType(Enum857AllocNoOrdersType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log857EnuAllocNoOrdersType(TESTA_ENU_ALLOC_NO_ORDERS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log857EnuAllocNoOrdersType(TESTB_ENU_ALLOC_NO_ORDERS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
