 ...
 *      3 - Rejected
 */
public class Log905EnuCollAsgnRespType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log905EnuCollAsgnRespType(Enum905CollAsgnRespType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log905EnuCollAsgnRespType(TESTA_ENU_COLL_ASGN_RESP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log905EnuCollAsgnRespType(TESTB_ENU_COLL_ASGN_RESP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
