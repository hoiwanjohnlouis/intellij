 ...
 *      3 - Multileg Security
 */
public class Log752EnuSideMultiLegReportingType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log752EnuSideMultiLegReportingType(Enum752SideMultiLegReportingType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log752EnuSideMultiLegReportingType(TESTA_ENU_SIDE_MULTI_LEG_REPORTING_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log752EnuSideMultiLegReportingType(TESTB_ENU_SIDE_MULTI_LEG_REPORTING_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
