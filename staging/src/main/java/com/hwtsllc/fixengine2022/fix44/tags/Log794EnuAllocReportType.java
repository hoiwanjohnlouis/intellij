 ...
 *      14 - Reverse Pending
 */
public class Log794EnuAllocReportType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log794EnuAllocReportType(Enum794AllocReportType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log794EnuAllocReportType(TESTA_ENU_ALLOC_REPORT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log794EnuAllocReportType(TESTB_ENU_ALLOC_REPORT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
