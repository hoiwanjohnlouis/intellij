 ...
 *      2 - Rejected
 */
public enum Enum729PosReqStatus implements EnumAccessors, LogVerboseString {
    ...
    Enum729PosReqStatus(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
