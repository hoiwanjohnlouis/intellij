 ...
 */
public class Log709EnuPosTransType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log709EnuPosTransType(Enum709PosTransType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log709EnuPosTransType(TESTA_ENU_POS_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log709EnuPosTransType(TESTB_ENU_POS_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
