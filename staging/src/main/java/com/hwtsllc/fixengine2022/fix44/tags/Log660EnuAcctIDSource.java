 ...
 */
public class Log660EnuAcctIDSource extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log660EnuAcctIDSource(MyEnumAcctIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log660EnuAcctIDSource(TESTA_ENU_ACCT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log660EnuAcctIDSource(TESTB_ENU_ACCT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
