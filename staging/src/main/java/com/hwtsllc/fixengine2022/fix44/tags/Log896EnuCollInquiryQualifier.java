 ...
 */
public class Log896EnuCollInquiryQualifier extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log896EnuCollInquiryQualifier(Enum896CollInquiryQualifier dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log896EnuCollInquiryQualifier(TESTA_ENU_COLL_INQUIRY_QUALIFIER);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log896EnuCollInquiryQualifier(TESTB_ENU_COLL_INQUIRY_QUALIFIER);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
