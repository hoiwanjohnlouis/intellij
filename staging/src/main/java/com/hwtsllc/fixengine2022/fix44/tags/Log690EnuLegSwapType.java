 ...
 *      5 - Proceeds
 */
public class Log690EnuLegSwapType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log690EnuLegSwapType(Enum690LegSwapType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log690EnuLegSwapType(TESTA_ENU_LEG_SWAP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log690EnuLegSwapType(TESTB_ENU_LEG_SWAP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
