 ...
 */
public class Log924EnuUserRequestType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log924EnuUserRequestType(Enum924UserRequestType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log924EnuUserRequestType(TESTA_ENU_USER_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log924EnuUserRequestType(TESTB_ENU_USER_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
