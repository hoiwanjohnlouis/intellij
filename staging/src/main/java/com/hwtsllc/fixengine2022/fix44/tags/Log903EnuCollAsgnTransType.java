 ...
 *      4 - Reverse
 */
public class Log903EnuCollAsgnTransType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log903EnuCollAsgnTransType(Enum903CollAsgnTransType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log903EnuCollAsgnTransType(TESTA_ENU_COLL_ASGN_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log903EnuCollAsgnTransType(TESTB_ENU_COLL_ASGN_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
