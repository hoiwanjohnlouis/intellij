 ...
 */
public class Log807EnuNested2PartySubIDType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log807EnuNested2PartySubIDType(MyEnumPartySubIDType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log807EnuNested2PartySubIDType(TESTA_ENU_NESTED_2_PARTY_SUB_ID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log807EnuNested2PartySubIDType(TESTB_ENU_NESTED_2_PARTY_SUB_ID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
