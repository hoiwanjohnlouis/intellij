 ...
 *      Y - Report Trade
 */
public class Log852BoolPublishTrdIndicator extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log852BoolPublishTrdIndicator(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log852BoolPublishTrdIndicator(TESTA_BOOL_REVERSAL_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log852BoolPublishTrdIndicator(TESTB_BOOL_REVERSAL_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
