 ...
 */
public class Tag667MmyContractSettlMonth extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    private final MyMonthYearType dataValue;

    public final static String TESTA_MMY_CONTRACT_SETTL_MONTH
            = "ElizabethMontgomery-Tag667MmyContractSettlMonth";
    public final static String TESTB_MMY_CONTRACT_SETTL_MONTH
            = "GeneTierney-Tag667MmyContractSettlMonth";

    public Tag667MmyContractSettlMonth( MyMonthYearType dataValue) {
        setFixType( FIX44.FIX667_MMY_CONTRACT_SETTL_MONTH );
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag667MmyContractSettlMonth(new MyMonthYearType( TESTA_MMY_CONTRACT_SETTL_MONTH ) );
        System.out.println(tagData.toVerboseString());

        tagData = new Tag667MmyContractSettlMonth(new MyMonthYearType( TESTB_MMY_CONTRACT_SETTL_MONTH ) );
        System.out.println(tagData.toVerboseString());
    }
}
