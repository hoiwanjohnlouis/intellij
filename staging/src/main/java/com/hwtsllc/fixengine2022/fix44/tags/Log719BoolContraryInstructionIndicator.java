 ...
 */
public class Log719BoolContraryInstructionIndicator extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log719BoolContraryInstructionIndicator(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log719BoolContraryInstructionIndicator(TESTA_BOOL_CONTRARY_INSTRUCTION_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log719BoolContraryInstructionIndicator(TESTB_BOOL_CONTRARY_INSTRUCTION_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
