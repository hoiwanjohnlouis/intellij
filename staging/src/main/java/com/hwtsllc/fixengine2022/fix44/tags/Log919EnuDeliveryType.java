 ...
 *      3 - Hold In Custody
 */
public class Log919EnuDeliveryType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log919EnuDeliveryType(Enum919DeliveryType dataValue) {
    ...
    public static void main(String[] args) {
        Log919EnuDeliveryType tagData;

        tagData = new Log919EnuDeliveryType(TESTA_ENU_DELIVERY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log919EnuDeliveryType(TESTB_ENU_DELIVERY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
