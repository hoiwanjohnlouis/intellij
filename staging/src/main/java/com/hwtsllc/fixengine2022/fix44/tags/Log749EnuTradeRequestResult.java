 ...
 */
public class Log749EnuTradeRequestResult extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log749EnuTradeRequestResult(Enum749TradeRequestResult dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log749EnuTradeRequestResult(TESTA_ENU_TRADE_REQUEST_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log749EnuTradeRequestResult(TESTB_ENU_TRADE_REQUEST_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
