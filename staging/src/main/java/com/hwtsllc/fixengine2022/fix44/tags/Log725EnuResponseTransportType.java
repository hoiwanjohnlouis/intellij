 ...
 */
public class Log725EnuResponseTransportType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log725EnuResponseTransportType(Enum725ResponseTransportType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log725EnuResponseTransportType(TESTA_ENU_RESPONSE_TRANSPORT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log725EnuResponseTransportType(TESTB_ENU_RESPONSE_TRANSPORT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
