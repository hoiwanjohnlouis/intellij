 ...
 */
public class Log888EnuUnderlyingStipType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log888EnuUnderlyingStipType(MyEnumStipulationType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log888EnuUnderlyingStipType(TESTA_ENU_UNDERLYING_STIP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log888EnuUnderlyingStipType(TESTB_ENU_UNDERLYING_STIP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
