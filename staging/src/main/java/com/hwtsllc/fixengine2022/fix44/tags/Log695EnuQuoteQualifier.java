 ...
 *  <p>    Z - Pre-open
 */
public class Log695EnuQuoteQualifier extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log695EnuQuoteQualifier(MyEnumQualifier dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log695EnuQuoteQualifier(TESTA_ENU_QUOTE_QUALIFIER);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log695EnuQuoteQualifier(TESTB_ENU_QUOTE_QUALIFIER);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
