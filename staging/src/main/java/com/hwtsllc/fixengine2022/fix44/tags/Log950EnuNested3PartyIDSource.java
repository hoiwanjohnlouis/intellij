 ...
 */
public class Log950EnuNested3PartyIDSource extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log950EnuNested3PartyIDSource(MyEnumPartyIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log950EnuNested3PartyIDSource(TESTA_ENU_SETTL_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log950EnuNested3PartyIDSource(TESTB_ENU_SETTL_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
