 ...
 *      2 - Rejected
 */
public class Log750EnuTradeRequestStatus extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log750EnuTradeRequestStatus(Enum750TradeRequestStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log750EnuTradeRequestStatus(TESTA_ENU_TRADE_REQUEST_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log750EnuTradeRequestStatus(TESTB_ENU_TRADE_REQUEST_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
