 ...
 */
public class Log688EnuLegStipulationType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log688EnuLegStipulationType(MyEnumStipulationType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log688EnuLegStipulationType(TESTA_ENU_LEG_STIPULATION_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log688EnuLegStipulationType(TESTB_ENU_LEG_STIPULATION_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
