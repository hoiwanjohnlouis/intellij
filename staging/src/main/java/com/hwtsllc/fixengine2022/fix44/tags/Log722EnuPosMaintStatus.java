 ...
 */
public class Log722EnuPosMaintStatus extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log722EnuPosMaintStatus(Enum722PosMaintStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log722EnuPosMaintStatus(TESTA_ENU_POS_MAINT_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log722EnuPosMaintStatus(TESTB_ENU_POS_MAINT_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
