 ...
 */
public class Log661EnuAllocAcctIDSource extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log661EnuAllocAcctIDSource(MyEnumAcctIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log661EnuAllocAcctIDSource(TESTA_ENU_ALLOC_ACCT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log661EnuAllocAcctIDSource(TESTB_ENU_ALLOC_ACCT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
