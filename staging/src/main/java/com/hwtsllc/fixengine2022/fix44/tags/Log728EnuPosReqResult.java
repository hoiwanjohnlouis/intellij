 ...
 */
public class Log728EnuPosReqResult extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log728EnuPosReqResult(Enum728PosReqResult dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log728EnuPosReqResult(TESTA_ENU_POS_REQ_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log728EnuPosReqResult(TESTB_ENU_POS_REQ_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
