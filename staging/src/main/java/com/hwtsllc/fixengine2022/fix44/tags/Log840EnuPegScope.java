 ...
 */
public class Log840EnuPegScope extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log840EnuPegScope(MyEnumPegDiscretionScope dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log840EnuPegScope(TESTA_ENU_PEG_SCOPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log840EnuPegScope(TESTB_ENU_PEG_SCOPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
