 ...
 *      4 - Rejected
 */
public class Log945EnuCollInquiryStatus extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log945EnuCollInquiryStatus(Enum945CollInquiryStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log945EnuCollInquiryStatus(TESTA_ENU_COLL_INQUIRY_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log945EnuCollInquiryStatus(TESTB_ENU_COLL_INQUIRY_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
