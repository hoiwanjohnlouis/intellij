 ...
 *      Y - Last message
 */
public class Log912BoolLastRptRequested extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log912BoolLastRptRequested(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log912BoolLastRptRequested(TESTA_BOOL_LAST_RPT_REQUESTED);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log912BoolLastRptRequested(TESTB_BOOL_LAST_RPT_REQUESTED);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
