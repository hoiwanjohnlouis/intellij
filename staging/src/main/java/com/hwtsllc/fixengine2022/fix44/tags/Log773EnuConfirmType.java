 ...
 */
public class Log773EnuConfirmType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log773EnuConfirmType(Enum773ConfirmType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log773EnuConfirmType(TESTA_ENU_CONFIRM_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log773EnuConfirmType(TESTB_ENU_CONFIRM_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
