 ...
 */
public class Log935EnuNetworkRequestType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log935EnuNetworkRequestType(Enum935NetworkRequestType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log935EnuNetworkRequestType(TESTA_ENU_NETWORK_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log935EnuNetworkRequestType(TESTB_ENU_NETWORK_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
