 ...
 */
public class Log838EnuPegRoundDirection extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log838EnuPegRoundDirection(MyEnumRoundDirection dataValue) {
    ...
    public static void main(String[] args) {
        Log838EnuPegRoundDirection tagData;

        tagData = new Log838EnuPegRoundDirection(TESTA_ENU_PEG_ROUND_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log838EnuPegRoundDirection(TESTB_ENU_PEG_ROUND_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
