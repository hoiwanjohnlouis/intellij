 ...
 */
public class Log786EnuSettlPartySubIDType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log786EnuSettlPartySubIDType(MyEnumPartySubIDType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log786EnuSettlPartySubIDType(TESTA_ENU_SETTL_PARTY_SUB_ID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log786EnuSettlPartySubIDType(TESTB_ENU_SETTL_PARTY_SUB_ID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
