 ...
 *      2 - Percentage
 */
public class Log891EnuMiscFeeBasis extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log891EnuMiscFeeBasis(Enum891MiscFeeBasis dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log891EnuMiscFeeBasis(TESTA_ENU_MISC_FEE_BASIS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log891EnuMiscFeeBasis(TESTB_ENU_MISC_FEE_BASIS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
