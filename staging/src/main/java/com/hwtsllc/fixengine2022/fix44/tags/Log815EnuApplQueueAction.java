 ...
 *  <p>    3 - End Session
 */
public class Log815EnuApplQueueAction extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log815EnuApplQueueAction(MyEnumApplQueue dataValue) {
    ...
    public static void main(String[] args) {
        Log815EnuApplQueueAction tagData;

        tagData = new Log815EnuApplQueueAction(TESTA_ENU_APPL_QUEUE_ACTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log815EnuApplQueueAction(TESTB_ENU_APPL_QUEUE_ACTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
