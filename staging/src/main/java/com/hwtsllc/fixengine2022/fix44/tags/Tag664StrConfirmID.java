...
public class Tag664StrConfirmID extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag664StrConfirmID(new MyStringType(TESTA_STR_SIDE_COMPLIANCE_ID) );
        System.out.println(tagData.toVerboseString());

        tagData = new Tag664StrConfirmID(new MyStringType(TESTB_STR_SIDE_COMPLIANCE_ID) );
        System.out.println(tagData.toVerboseString());
    }
}
