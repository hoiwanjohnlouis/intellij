 ...
 */
public class Log754BoolAutoAcceptIndicator extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log754BoolAutoAcceptIndicator(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log754BoolAutoAcceptIndicator(TESTA_BOOL_AUTO_ACCEPT_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log754BoolAutoAcceptIndicator(TESTB_BOOL_AUTO_ACCEPT_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
