 ...
 */
public class Log856EnuTradeReportType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log856EnuTradeReportType(Enum856TradeReportType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log856EnuTradeReportType(TESTA_ENU_TRADE_REPORT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log856EnuTradeReportType(TESTB_ENU_TRADE_REPORT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
