 ...
 */
public class Log808EnuAllocIntermedReqType extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log808EnuAllocIntermedReqType(Enum808AllocIntermedReqType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log808EnuAllocIntermedReqType(TESTA_ENU_ALLOC_INTERMED_REQ_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log808EnuAllocIntermedReqType(TESTB_ENU_ALLOC_INTERMED_REQ_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
