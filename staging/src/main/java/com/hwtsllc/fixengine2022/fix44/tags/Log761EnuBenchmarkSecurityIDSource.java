 ...
 */
public class Log761EnuBenchmarkSecurityIDSource extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log761EnuBenchmarkSecurityIDSource(MyEnumSecurityIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log761EnuBenchmarkSecurityIDSource(TESTA_ENU_BENCHMARK_SECURITY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log761EnuBenchmarkSecurityIDSource(TESTB_ENU_BENCHMARK_SECURITY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
