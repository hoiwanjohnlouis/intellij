 ...
 */
public class Log846EnuDiscretionScope extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log846EnuDiscretionScope(MyEnumPegDiscretionScope dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log846EnuDiscretionScope(TESTA_ENU_DISCRETION_SCOPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log846EnuDiscretionScope(TESTB_ENU_DISCRETION_SCOPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
