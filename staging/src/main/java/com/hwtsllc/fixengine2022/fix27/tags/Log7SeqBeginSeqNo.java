 ...
 */
public class Log7SeqBeginSeqNo extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log7SeqBeginSeqNo(final MySeqNumType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log7SeqBeginSeqNo(new MySeqNumType(TESTA_SEQ_BEGIN_SEQ_NO) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
        tagData = new Log7SeqBeginSeqNo(new MySeqNumType(TESTB_SEQ_BEGIN_SEQ_NO) );
