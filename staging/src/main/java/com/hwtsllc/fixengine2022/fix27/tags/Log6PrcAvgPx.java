 ...
 */
public class Log6PrcAvgPx extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyPriceType dataValue;

    public final static double TESTA_PRC_AVG_PX = 12.345D;
    public final static double TESTB_PRC_AVG_PX = 67.89D;

    public Log6PrcAvgPx(MyPriceType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log6PrcAvgPx(new MyPriceType(TESTA_PRC_AVG_PX) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log6PrcAvgPx(new MyPriceType(TESTB_PRC_AVG_PX) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
