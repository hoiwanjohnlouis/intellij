 ...
 */
public class Log72StrRefAllocID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log72StrRefAllocID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log72StrRefAllocID(new MyStringType(TESTA_STR_REF_ALLOC_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log72StrRefAllocID(new MyStringType(TESTB_STR_REF_ALLOC_ID) );
