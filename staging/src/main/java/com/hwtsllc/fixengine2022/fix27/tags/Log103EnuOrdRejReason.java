 ...
 */
public class Log103EnuOrdRejReason extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log103EnuOrdRejReason(Enum103OrdRejReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData =  new Log103EnuOrdRejReason(TESTA_ENU_ORD_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData =  new Log103EnuOrdRejReason(TESTB_ENU_ORD_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
