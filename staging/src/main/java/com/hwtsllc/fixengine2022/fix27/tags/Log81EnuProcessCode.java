 ...
 *      6 - Plan Sponsor
 */
public class Log81EnuProcessCode extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log81EnuProcessCode(Enum81ProcessCode dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log81EnuProcessCode(TESTA_ENU_PROCESS_CODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log81EnuProcessCode(TESTB_ENU_PROCESS_CODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
