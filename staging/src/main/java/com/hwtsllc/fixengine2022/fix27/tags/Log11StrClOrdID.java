 ...
 */
public class Log11StrClOrdID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log11StrClOrdID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log11StrClOrdID(new MyStringType(TESTA_STR_CL_ORD_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log11StrClOrdID(new MyStringType(TESTB_STR_CL_ORD_ID) );
