 ...
 */
// @Deprecated
public class Log92StrBrokerOfCredit extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log92StrBrokerOfCredit(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        Log92StrBrokerOfCredit tagData;

        tagData= new Log92StrBrokerOfCredit(new MyStringType(TESTA_STR_BROKER_OF_CREDIT) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log92StrBrokerOfCredit(new MyStringType(TESTB_STR_BROKER_OF_CREDIT) );
