 ...
 */
public class Log45SeqRefSeqNum extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log45SeqRefSeqNum(MySeqNumType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log45SeqRefSeqNum(new MySeqNumType(TESTA_SEQ_REF_SEQ_NO) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log45SeqRefSeqNum(new MySeqNumType(TESTB_SEQ_REF_SEQ_NO) );
