...
public class Tag84QtCxlQty extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    private final MyQtyType dataValue;

    public final static int TESTA_QT_CXL_QTY = 84; // fake data
    public final static int TESTB_QT_CXL_QTY = 48;

    public Tag84QtCxlQty(MyQtyType dataValue) {
        setFixType(FIX27.FIX84_QT_CXL_QTY);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag84QtCxlQty(new MyQtyType(TESTA_QT_CXL_QTY) );
        ...
        tagData = new Tag84QtCxlQty(new MyQtyType(TESTB_QT_CXL_QTY) );
