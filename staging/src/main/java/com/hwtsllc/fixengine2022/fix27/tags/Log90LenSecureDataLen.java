 ...
 */
public class Log90LenSecureDataLen extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log90LenSecureDataLen(MyLengthType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log90LenSecureDataLen(new MyLengthType(TESTA_LEN_SECURE_DATA_LEN) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log90LenSecureDataLen(new MyLengthType(TESTB_LEN_SECURE_DATA_LEN) );
