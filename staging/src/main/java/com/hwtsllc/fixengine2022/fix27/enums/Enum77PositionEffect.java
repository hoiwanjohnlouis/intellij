...
public enum Enum77PositionEffect implements FixEnumAccessors, LogStringVerbose {
    ...
    Enum77PositionEffect(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
