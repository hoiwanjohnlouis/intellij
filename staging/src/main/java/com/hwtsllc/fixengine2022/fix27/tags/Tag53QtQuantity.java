...
public class Tag53QtQuantity extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    private final MyQtyType dataValue;

    public final static int TESTA_QT_QUANTITY = 1000; // fake data
    public final static int TESTB_QT_QUANTITY = 3300;

    public Tag53QtQuantity(MyQtyType dataValue) {
        setFixType(FIX27.FIX53_QT_QUANTITY);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag53QtQuantity(new MyQtyType(TESTA_QT_QUANTITY) );
        System.out.println("initial values A");
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag53QtQuantity(new MyQtyType(TESTB_QT_QUANTITY) );
