 ...
 */
public class Log54EnuSide extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log54EnuSide(MyEnumSide dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log54EnuSide(TESTA_ENU_SIDE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());

        tagData = new Log54EnuSide(TESTB_ENU_SIDE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
