 ...
 */
public class Tag70StrAllocID extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Tag70StrAllocID(new MyStringType(TESTA_STR_ALLOC_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag70StrAllocID(new MyStringType(TESTB_STR_ALLOC_ID) );
