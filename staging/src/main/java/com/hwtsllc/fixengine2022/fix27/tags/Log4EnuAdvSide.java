 ...
 *      X - Cross
 */
public class Log4EnuAdvSide extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log4EnuAdvSide(Enum4AdvSide dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log4EnuAdvSide(TESTA_ENU_ADV_SIDE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log4EnuAdvSide(TESTB_ENU_ADV_SIDE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
