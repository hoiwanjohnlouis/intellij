 ...
 */
public class Log49StrSenderCompID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log49StrSenderCompID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log49StrSenderCompID(new MyStringType(TESTA_STR_SENDER_COMP_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log49StrSenderCompID(new MyStringType(TESTB_STR_SENDER_COMP_ID) );
