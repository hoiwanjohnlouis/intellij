 ...
 */
public class Log65EnuSymbolSfx extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log65EnuSymbolSfx(MyEnumSymbolSfx dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log65EnuSymbolSfx( TESTA_STR_SYMBOL_SFX );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log65EnuSymbolSfx( TESTB_STR_SYMBOL_SFX );
