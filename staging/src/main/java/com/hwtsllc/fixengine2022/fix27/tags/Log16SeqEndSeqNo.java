 ...
 */
public class Log16SeqEndSeqNo extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log16SeqEndSeqNo(MySeqNumType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log16SeqEndSeqNo(new MySeqNumType(TESTA_SEQ_END_SEQ_NO) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
        tagData = new Log16SeqEndSeqNo(new MySeqNumType(TESTB_SEQ_END_SEQ_NO) );
