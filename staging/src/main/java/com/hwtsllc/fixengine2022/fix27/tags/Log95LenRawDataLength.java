 ...
 */
public class Log95LenRawDataLength extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log95LenRawDataLength(MyLengthType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log95LenRawDataLength(new MyLengthType(TESTA_LEN_RAW_DATA_LENGTH) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log95LenRawDataLength(new MyLengthType(TESTB_LEN_RAW_DATA_LENGTH) );
