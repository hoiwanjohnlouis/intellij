 ...
 */
public class Log80QtyAllocQty extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyQtyType dataValue;

    public final static int TESTA_QTY_ALLOC_QTY = 180;
    public final static int TESTB_QTY_ALLOC_QTY = 220;

    public Log80QtyAllocQty(MyQtyType dataValue) {
    ...
    public static void main(String[] args) {
        Log80QtyAllocQty tagData;
        tagData = new Log80QtyAllocQty(new MyQtyType(TESTA_QTY_ALLOC_QTY) );
        ...
        tagData = new Log80QtyAllocQty(new MyQtyType(TESTB_QTY_ALLOC_QTY) );
