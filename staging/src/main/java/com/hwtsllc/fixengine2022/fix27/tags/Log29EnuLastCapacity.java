 ...
 *      4 - Principal
 */
public class Log29EnuLastCapacity extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log29EnuLastCapacity(Enum29LastCapacity dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log29EnuLastCapacity(TESTA_ENU_LAST_CAPACITY);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log29EnuLastCapacity(TESTB_ENU_LAST_CAPACITY);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
