 ...
 */
public class Log19StrExecRefID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log19StrExecRefID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log19StrExecRefID(new MyStringType(TESTA_STR_EXEC_REF_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
        tagData = new Log19StrExecRefID(new MyStringType(TESTB_STR_EXEC_REF_ID) );
