 ...
 */
// @Deprecated
public class Log46StrRelatdSym extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyStringType dataValue;

    public final static String TESTA_STR_RELATED_SYM = "TESTA";
    public final static String TESTB_STR_RELATED_SYM = "TESTB";

    public Log46StrRelatdSym(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log46StrRelatdSym(new MyStringType(TESTA_STR_RELATED_SYM) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log46StrRelatdSym(new MyStringType(TESTB_STR_RELATED_SYM) );
