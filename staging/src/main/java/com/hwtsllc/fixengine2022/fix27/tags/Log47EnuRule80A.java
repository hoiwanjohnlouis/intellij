 ...
 */
// @Deprecated
public class Log47EnuRule80A extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log47EnuRule80A(Enum47Rule80A dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log47EnuRule80A(TESTA_ENU_RULE_80_A);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log47EnuRule80A(TESTB_ENU_RULE_80_A);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
