 ...
 */
public class Log27EnuIOIQty extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log27EnuIOIQty(MyEnumIOIQty dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log27EnuIOIQty(TESTA_ENU_IOI_QTY);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log27EnuIOIQty(TESTB_ENU_IOI_QTY);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
