 ...
 */
// @Deprecated
public class Log76StrExecBroker extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log76StrExecBroker(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log76StrExecBroker(new MyStringType(TESTA_STR_EXEC_BROKER) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log76StrExecBroker(new MyStringType(TESTB_STR_EXEC_BROKER) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
