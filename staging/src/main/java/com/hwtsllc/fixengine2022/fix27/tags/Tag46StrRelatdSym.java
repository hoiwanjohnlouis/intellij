...
@Deprecated
public class Tag46StrRelatdSym extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Tag46StrRelatdSym(new MyStringType(TESTA_STR_RELATED_SYM) );
        System.out.println("initial values A");
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag46StrRelatdSym(new MyStringType(TESTB_STR_RELATED_SYM) );
