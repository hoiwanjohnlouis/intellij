 ...
 */
public class Log21EnuHandlInst extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log21EnuHandlInst(Enum21HandlInst dataValue) {
    ...
    public static void main(String[] args) {
        Log21EnuHandlInst tagData;

        tagData = new Log21EnuHandlInst(TESTA_ENU_HANDL_INST);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log21EnuHandlInst(TESTB_ENU_HANDL_INST);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
