 ...
 */
public class Log1StrAccount extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log1StrAccount(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log1StrAccount(new MyStringType(TESTA_STR_ACCOUNT) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log1StrAccount(new MyStringType(TESTB_STR_ACCOUNT) );
