 ...
 */
public class Log79StrAllocAccount extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log79StrAllocAccount(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        Log79StrAllocAccount tagData;

        tagData= new Log79StrAllocAccount(new MyStringType(TESTA_STR_ALLOC_ACCOUNT) );
        ...
        tagData = new Log79StrAllocAccount(new MyStringType(TESTB_STR_ALLOC_ACCOUNT) );
