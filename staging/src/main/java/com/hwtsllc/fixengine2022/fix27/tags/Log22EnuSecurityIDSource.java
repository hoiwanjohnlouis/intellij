 ...
 */
public class Log22EnuSecurityIDSource extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log22EnuSecurityIDSource(MyEnumSecurityIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log22EnuSecurityIDSource(TESTA_ENU_SECURITY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log22EnuSecurityIDSource(TESTB_ENU_SECURITY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
