 ...
 */
public class Log37StrOrderID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log37StrOrderID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        Log37StrOrderID tagData;

        tagData= new Log37StrOrderID(new MyStringType(TESTA_STR_ORDER_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log37StrOrderID(new MyStringType(TESTB_STR_ORDER_ID) );
