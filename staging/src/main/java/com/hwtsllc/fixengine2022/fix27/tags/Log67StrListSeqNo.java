 ...
 */
public class Log67StrListSeqNo extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log67StrListSeqNo(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log67StrListSeqNo(new MyStringType(TESTA_STR_LIST_SEQ_NO) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log67StrListSeqNo(new MyStringType(TESTB_STR_LIST_SEQ_NO) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
