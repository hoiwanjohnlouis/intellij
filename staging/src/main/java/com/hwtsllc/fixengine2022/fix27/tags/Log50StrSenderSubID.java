 ...
 */
public class Log50StrSenderSubID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log50StrSenderSubID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log50StrSenderSubID(new MyStringType(TESTA_STR_SENDER_SUB_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log50StrSenderSubID(new MyStringType(TESTB_STR_SENDER_SUB_ID) );
