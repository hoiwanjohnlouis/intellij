 ...
 *      7 - reversed
 */
public class Log87EnuAllocStatus extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log87EnuAllocStatus(Enum87AllocStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log87EnuAllocStatus(TESTA_ENU_ALLOC_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log87EnuAllocStatus(TESTB_ENU_ALLOC_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
