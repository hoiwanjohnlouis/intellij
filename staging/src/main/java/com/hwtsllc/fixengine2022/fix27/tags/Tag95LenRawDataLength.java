...
public class Tag95LenRawDataLength extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag95LenRawDataLength(new MyLengthType(TESTA_LEN_RAW_DATA_LENGTH) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Tag95LenRawDataLength(new MyLengthType(TESTB_LEN_RAW_DATA_LENGTH) );
