 ...
 *      2 - Background
 */
public class Log61EnuUrgency extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log61EnuUrgency(Enum61Urgency dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log61EnuUrgency(TESTA_ENU_URGENCY);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log61EnuUrgency(TESTB_ENU_URGENCY);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
