 ...
 */
public class Log102EnuCxlRejReason extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log102EnuCxlRejReason(Enum102CxlRejReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log102EnuCxlRejReason(TESTA_ENU_CXL_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log102EnuCxlRejReason(TESTB_ENU_CXL_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
