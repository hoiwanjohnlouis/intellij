 ...
 */
public class Log84QtyCxlQty extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyQtyType dataValue;

    public final static int TESTA_QTY_CXL_QTY = 84; // fake data
    public final static int TESTB_QTY_CXL_QTY = 48;

    public Log84QtyCxlQty(MyQtyType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log84QtyCxlQty(new MyQtyType(TESTA_QTY_CXL_QTY) );
        ...
        tagData = new Log84QtyCxlQty(new MyQtyType(TESTB_QTY_CXL_QTY) );
