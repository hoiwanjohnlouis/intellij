...
public class Tag59EtTimeInForce extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public Tag59EtTimeInForce(Enum59TimeInForce dataValue) {
        setFixType(FIX27.FIX59_ET_TIME_IN_FORCE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag59EtTimeInForce(TESTA_ET_TIME_IN_FORCE);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag59EtTimeInForce(TESTB_ET_TIME_IN_FORCE);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());
    }
