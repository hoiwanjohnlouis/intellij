 ...
 *  New sequence number
 */
public class Log36SeqNewSeqNo extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log36SeqNewSeqNo(MySeqNumType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log36SeqNewSeqNo(new MySeqNumType(TESTA_SEQ_NEW_SEQ_NO) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log36SeqNewSeqNo(new MySeqNumType(TESTB_SEQ_NEW_SEQ_NO) );
