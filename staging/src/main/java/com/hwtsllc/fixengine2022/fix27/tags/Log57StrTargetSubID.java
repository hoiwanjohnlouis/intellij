 ...
 */
public class Log57StrTargetSubID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log57StrTargetSubID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log57StrTargetSubID(new MyStringType(TESTA_STR_TARGET_SUB_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log57StrTargetSubID(new MyStringType(TESTB_STR_TARGET_SUB_ID) );
