...
@Deprecated
public class Tag85StNoDlvyInst extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public Tag85StNoDlvyInst(MyStringType dataValue) {
        setFixType(FIX27.FIX85_ST_NO_DLVY_INST);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag85StNoDlvyInst(new MyStringType(TESTA_NO_DLVY_INST) );
        ...
        tagData = new Tag85StNoDlvyInst(new MyStringType(TESTB_NO_DLVY_INST) );
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());
        System.out.println("Accessing FIXType Directly");
