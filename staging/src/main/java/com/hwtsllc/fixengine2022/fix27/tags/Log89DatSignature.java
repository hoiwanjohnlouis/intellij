 ...
 */
public class Log89DatSignature extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log89DatSignature(MyDataType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log89DatSignature(new MyDataType(TESTA_DAT_SIGNATURE) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log89DatSignature(new MyDataType(TESTB_DAT_SIGNATURE) );
