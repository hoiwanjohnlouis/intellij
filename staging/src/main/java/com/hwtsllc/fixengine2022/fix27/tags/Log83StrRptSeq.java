 ...
 */
public class Log83StrRptSeq extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log83StrRptSeq(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log83StrRptSeq(new MyStringType(TESTA_STR_RPT_SEQ) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log83StrRptSeq(new MyStringType(TESTB_STR_RPT_SEQ) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
