 ...
 */
public class Log96DatRawData extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log96DatRawData(MyDataType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log96DatRawData(new MyDataType(TESTA_DAT_RAW_DATA) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log96DatRawData(new MyDataType(TESTB_DAT_RAW_DATA) );
