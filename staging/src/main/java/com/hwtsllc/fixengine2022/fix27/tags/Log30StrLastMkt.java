 ...
 *  See "Appendix 6-C"
 */
public class Log30StrLastMkt extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log30StrLastMkt(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log30StrLastMkt(new MyStringType(TESTA_STR_LAST_MKT) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log30StrLastMkt(new MyStringType(TESTB_STR_LAST_MKT) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
