 ...
 */
public class Log2StrAdvID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log2StrAdvID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log2StrAdvID(new MyStringType(TESTA_STR_ADV_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log2StrAdvID(new MyStringType(TESTB_STR_ADV_ID) );
