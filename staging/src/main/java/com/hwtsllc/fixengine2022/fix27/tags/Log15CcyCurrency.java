 ...
 */
public class Log15CcyCurrency extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log15CcyCurrency(MyCurrencyType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log15CcyCurrency(new MyCurrencyType(TESTA_CCY_CURRENCY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log15CcyCurrency(new MyCurrencyType(TESTB_CCY_CURRENCY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
