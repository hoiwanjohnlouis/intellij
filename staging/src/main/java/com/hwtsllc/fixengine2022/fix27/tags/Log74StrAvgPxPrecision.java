 ...
 */
public class Log74StrAvgPxPrecision extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log74StrAvgPxPrecision(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log74StrAvgPxPrecision(new MyStringType(TESTA_STR_AVG_PX_PRECISION) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log74StrAvgPxPrecision(new MyStringType(TESTB_STR_AVG_PX_PRECISION) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
