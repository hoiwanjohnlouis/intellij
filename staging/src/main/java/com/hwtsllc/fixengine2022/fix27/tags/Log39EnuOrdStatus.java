 ...
 */
public class Log39EnuOrdStatus extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log39EnuOrdStatus(Enum39OrdStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log39EnuOrdStatus(TESTA_ENU_ORDER_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log39EnuOrdStatus(TESTB_ENU_ORDER_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
