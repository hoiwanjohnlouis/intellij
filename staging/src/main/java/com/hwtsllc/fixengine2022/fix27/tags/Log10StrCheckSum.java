 ...
 *  (Always unencrypted)
 */
public class Log10StrCheckSum extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyStringType dataValue;

    public final static String TESTA_STR_CHECK_SUM = "789"; // fake data
    public final static String TESTB_STR_CHECK_SUM = "123";

    public Log10StrCheckSum(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log10StrCheckSum(new MyStringType(TESTA_STR_CHECK_SUM) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log10StrCheckSum(new MyStringType(TESTB_STR_CHECK_SUM) );
