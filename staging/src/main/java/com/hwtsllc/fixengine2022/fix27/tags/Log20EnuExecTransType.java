 ...
 */
// @Deprecated
public class Log20EnuExecTransType extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log20EnuExecTransType(Enum20ExecTransType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log20EnuExecTransType(TESTA_ENU_EXEC_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log20EnuExecTransType(TESTB_ENU_EXEC_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
