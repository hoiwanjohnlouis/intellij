 ...
 */
public class Log23StrIOIID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log23StrIOIID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log23StrIOIID(new MyStringType(TESTA_STR_IOI_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log23StrIOIID(new MyStringType(TESTB_STR_IOI_ID) );
