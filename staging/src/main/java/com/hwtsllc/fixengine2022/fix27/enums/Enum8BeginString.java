...
public enum Enum8BeginString implements FixEnumAccessors, LogStringVerbose {
    ...
    Enum8BeginString(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
