...
public enum Enum21HandlInst implements FixEnumAccessors, LogStringVerbose {
    ...
    Enum21HandlInst(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
