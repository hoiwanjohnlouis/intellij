 ...
 */
public class Log48StrSecurityID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log48StrSecurityID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log48StrSecurityID(new MyStringType(TESTA_STR_SECURITY_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log48StrSecurityID(new MyStringType(TESTB_STR_SECURITY_ID) );
