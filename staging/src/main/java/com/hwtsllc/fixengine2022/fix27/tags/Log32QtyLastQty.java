 ...
 */
public class Log32QtyLastQty extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyQtyType dataValue;

    public final static int TESTA_QTY_LAST_QTY = 100; // fake data
    public final static int TESTB_QTY_LAST_QTY = 20;

    public Log32QtyLastQty(MyQtyType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log32QtyLastQty(new MyQtyType(TESTA_QTY_LAST_QTY) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log32QtyLastQty(new MyQtyType(TESTB_QTY_LAST_QTY) );
