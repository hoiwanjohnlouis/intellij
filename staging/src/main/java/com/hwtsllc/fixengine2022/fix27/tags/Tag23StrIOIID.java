...
public class Tag23StrIOIID extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Tag23StrIOIID(new MyStringType(TESTA_STR_IOI_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag23StrIOIID(new MyStringType(TESTB_STR_IOI_ID) );
