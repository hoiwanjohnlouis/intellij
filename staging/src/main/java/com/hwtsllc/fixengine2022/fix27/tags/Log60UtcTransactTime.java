 ...
 */
public class Log60UtcTransactTime extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log60UtcTransactTime(MyUTCTimestampType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log60UtcTransactTime(new MyUTCTimestampType(TESTA_UTC_TRANSACT_TIME) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log60UtcTransactTime(new MyUTCTimestampType(TESTB_UTC_TRANSACT_TIME) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
