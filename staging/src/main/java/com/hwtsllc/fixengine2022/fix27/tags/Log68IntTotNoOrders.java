 ...
 */
public class Log68IntTotNoOrders extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyIntType dataValue;

    public final static int TESTA_INT_TOT_NO_ORDERS = 1;
    public final static int TESTB_INT_TOT_NO_ORDERS = 3;

    public Log68IntTotNoOrders(MyIntType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log68IntTotNoOrders(new MyIntType(TESTA_INT_TOT_NO_ORDERS) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log68IntTotNoOrders(new MyIntType(TESTB_INT_TOT_NO_ORDERS) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
