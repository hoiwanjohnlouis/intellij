 ...
 */
public class Log66StrListID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log66StrListID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log66StrListID(new MyStringType(TESTA_STR_LIST_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log66StrListID(new MyStringType(TESTB_STR_LIST_ID) );
