 ...
 */
public class Log64StrSettlDate extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log64StrSettlDate(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log64StrSettlDate(new MyStringType(TESTA_STR_SETTL_DATE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log64StrSettlDate(new MyStringType(TESTB_STR_SETTL_DATE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
