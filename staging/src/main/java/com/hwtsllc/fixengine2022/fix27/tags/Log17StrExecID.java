 ...
 */
public class Log17StrExecID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log17StrExecID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log17StrExecID(new MyStringType(TESTA_STR_EXEC_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log17StrExecID(new MyStringType(TESTB_STR_EXEC_ID) );
