 ...
 */
public class Log13EnuCommType extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log13EnuCommType(Enum13CommType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log13EnuCommType(TESTA_ENU_COMMISSION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log13EnuCommType(TESTB_ENU_COMMISSION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
