 ...
 */
public class Log70StrAllocID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log70StrAllocID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log70StrAllocID(new MyStringType(TESTA_STR_ALLOC_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log70StrAllocID(new MyStringType(TESTB_STR_ALLOC_ID) );
