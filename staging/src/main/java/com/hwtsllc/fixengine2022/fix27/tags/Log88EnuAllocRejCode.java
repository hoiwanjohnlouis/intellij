 ...
 */
public class Log88EnuAllocRejCode extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log88EnuAllocRejCode(MyEnumAllocRejCode dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log88EnuAllocRejCode(TESTA_ENU_ALLOC_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log88EnuAllocRejCode(TESTB_ENU_ALLOC_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
