 ...
 */
public class Log38QtyOrderQty extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyQtyType dataValue;

    public final static int TESTA_QTY_ORDER_QTY = 3838;
    public final static int TESTB_QTY_ORDER_QTY = 4545;

    public Log38QtyOrderQty(MyQtyType dataValue) {
    ...
    public static void main(String[] args) {
        Log38QtyOrderQty tagData;

        tagData = new Log38QtyOrderQty(new MyQtyType(TESTA_QTY_ORDER_QTY) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log38QtyOrderQty(new MyQtyType(TESTB_QTY_ORDER_QTY) );
