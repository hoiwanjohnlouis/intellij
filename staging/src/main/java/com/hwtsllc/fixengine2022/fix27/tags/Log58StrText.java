 ...
 */
public class Log58StrText extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log58StrText(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log58StrText(new MyStringType(TESTA_STR_TEXT) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log58StrText(new MyStringType(TESTB_STR_TEXT) );
