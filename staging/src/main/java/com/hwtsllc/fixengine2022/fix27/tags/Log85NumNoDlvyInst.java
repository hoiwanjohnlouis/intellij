 ...
 */
// @Deprecated
public class Log85NumNoDlvyInst extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyNumInGroupType dataValue;

    public final static int TESTA_NUM_NO_DLVY_INST = 85; // fake data
    public final static int TESTB_NUM_NO_DLVY_INST = 58;

    public Log85NumNoDlvyInst(MyNumInGroupType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log85NumNoDlvyInst(new MyNumInGroupType(TESTA_NUM_NO_DLVY_INST) );
        ...
        tagData = new Log85NumNoDlvyInst(new MyNumInGroupType(TESTB_NUM_NO_DLVY_INST) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
        System.out.println("Accessing FIXType Directly");
