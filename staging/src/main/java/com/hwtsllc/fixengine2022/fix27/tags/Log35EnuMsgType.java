 ...
 */
public class Log35EnuMsgType extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log35EnuMsgType(MyEnumMsgType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log35EnuMsgType(TESTA_ENU_MSG_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log35EnuMsgType(TESTB_ENU_MSG_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
