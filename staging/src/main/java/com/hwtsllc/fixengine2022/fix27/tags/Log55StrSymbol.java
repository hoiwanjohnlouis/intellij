 ...
 */
public class Log55StrSymbol extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    private final MyStringType dataValue;

    public final static String TESTA_STR_SYMBOL = "TESTA";
    public final static String TESTB_STR_SYMBOL = "TESTB";

    public Log55StrSymbol(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log55StrSymbol(new MyStringType(TESTA_STR_SYMBOL) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log55StrSymbol(new MyStringType(TESTB_STR_SYMBOL) );
