 ...
 */
// @Deprecated
public class Log86StrDlvyInst extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log86StrDlvyInst(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log86StrDlvyInst(new MyStringType(TESTA_STR_DLVY_INST) );
        ...
        tagData = new Log86StrDlvyInst(new MyStringType(TESTB_STR_DLVY_INST) );
