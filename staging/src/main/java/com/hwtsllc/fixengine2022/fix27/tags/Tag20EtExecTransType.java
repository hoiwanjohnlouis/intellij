...
@Deprecated
public class Tag20EtExecTransType extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public Tag20EtExecTransType(Enum20ExecTransType dataValue) {
        setFixType(FIX27.FIX20_ET_EXEC_TRANS_TYPE);
    ...
    public static void main(String[] args) {
        Tag20EtExecTransType tagData;

        tagData = new Tag20EtExecTransType(TESTA_ET_EXEC_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag20EtExecTransType(TESTB_ET_EXEC_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());
    }
