 ...
 *  <p>    R - Rolled
 */
public class Log77EnuPositionEffect extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log77EnuPositionEffect(MyEnumPositionEffect dataValue) {
    ...
    public static void main(String[] args) {
        Log77EnuPositionEffect tagData;

        tagData = new Log77EnuPositionEffect(TESTA_ENU_POSITION_EFFECT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log77EnuPositionEffect(TESTB_ENU_POSITION_EFFECT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
