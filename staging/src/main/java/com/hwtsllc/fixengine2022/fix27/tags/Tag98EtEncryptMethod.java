...
public class Tag98EtEncryptMethod extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public Tag98EtEncryptMethod(Enum98EncryptMethod dataValue) {
        setFixType(FIX27.FIX98_ET_ENCRYPT_METHOD);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag98EtEncryptMethod(TESTA_ET_ENCRYPT_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag98EtEncryptMethod(TESTB_ET_ENCRYPT_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());
    }
