 ...
 */
public class Log93LenSignatureLength extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log93LenSignatureLength(MyLengthType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log93LenSignatureLength(new MyLengthType(TESTA_LEN_SIGNATURE_LENGTH) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
        tagData = new Log93LenSignatureLength(new MyLengthType(TESTB_LEN_SIGNATURE_LENGTH) );
