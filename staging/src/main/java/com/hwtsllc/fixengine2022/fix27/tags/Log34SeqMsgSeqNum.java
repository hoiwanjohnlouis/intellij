 ...
 */
public class Log34SeqMsgSeqNum extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log34SeqMsgSeqNum(MySeqNumType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log34SeqMsgSeqNum(new MySeqNumType(TESTA_SEQ_MSG_SEQ_NO) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log34SeqMsgSeqNum(new MySeqNumType(TESTB_SEQ_MSG_SEQ_NO) );
