...
public class Tag36SntNewSeqNo extends FIX27Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public Tag36SntNewSeqNo(MySeqNumType dataValue) {
        setFixType(FIX27.FIX36_SNT_NEW_SEQ_NO);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag36SntNewSeqNo(new MySeqNumType(TESTA_SNT_NEW_SEQ_NO) );
        System.out.println("initial values A");
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());
        tagData = new Tag36SntNewSeqNo(new MySeqNumType(TESTB_SNT_NEW_SEQ_NO) );
