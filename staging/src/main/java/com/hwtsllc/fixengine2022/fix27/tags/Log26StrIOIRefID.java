 ...
 */
public class Log26StrIOIRefID extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log26StrIOIRefID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData= new Log26StrIOIRefID(new MyStringType(TESTA_STR_IOI_REF_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log26StrIOIRefID(new MyStringType(TESTB_STR_IOI_REF_ID) );
