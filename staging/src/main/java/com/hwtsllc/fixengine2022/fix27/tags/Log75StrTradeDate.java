 ...
 */
public class Log75StrTradeDate extends FIX27Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log75StrTradeDate(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        Log75StrTradeDate tagData;

        tagData = new Log75StrTradeDate(new MyStringType(TESTA_STR_TRADE_DATE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log75StrTradeDate(new MyStringType(TESTB_STR_TRADE_DATE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
