 ...
 */
public class Log120CcySettlCurrency extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log120CcySettlCurrency(MyCurrencyType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log120CcySettlCurrency(new MyCurrencyType(TESTA_CCY_SETTL_CURRENCY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log120CcySettlCurrency(new MyCurrencyType(TESTB_CCY_SETTL_CURRENCY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
