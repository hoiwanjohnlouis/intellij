 ...
 */
public class Log129StrDeliverToSubID extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log129StrDeliverToSubID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log129StrDeliverToSubID(new MyStringType(TESTA_STR_DELIVER_TO_SUB_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log129StrDeliverToSubID(new MyStringType(TESTB_STR_DELIVER_TO_SUB_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
