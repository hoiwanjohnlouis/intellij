 ...
 */
public class Log116StrOnBehalfOfSubID extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log116StrOnBehalfOfSubID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log116StrOnBehalfOfSubID(new MyStringType(TESTA_STR_ON_BEHALF_OF_SUB_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log116StrOnBehalfOfSubID(new MyStringType(TESTB_STR_ON_BEHALF_OF_SUB_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
