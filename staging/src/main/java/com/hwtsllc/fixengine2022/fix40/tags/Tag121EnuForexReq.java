...
public class Tag121EnuForexReq extends FIX40Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public final static MyBooleanType TESTA_ENU_FOREX_REQ = MyBooleanType.NO; // fake data
    public final static MyBooleanType TESTB_ENU_FOREX_REQ = MyBooleanType.YES;

    public Tag121EnuForexReq(MyBooleanType dataValue) {
