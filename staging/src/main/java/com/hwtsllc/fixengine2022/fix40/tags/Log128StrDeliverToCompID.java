 ...
 */
public class Log128StrDeliverToCompID extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log128StrDeliverToCompID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log128StrDeliverToCompID(new MyStringType(TESTA_STR_DELIVER_TO_COMP_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log128StrDeliverToCompID(new MyStringType(TESTB_STR_DELIVER_TO_COMP_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
