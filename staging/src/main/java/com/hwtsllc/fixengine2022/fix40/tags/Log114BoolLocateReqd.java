 ...
 */
public class Log114BoolLocateReqd extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log114BoolLocateReqd(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log114BoolLocateReqd(TESTA_BOOL_LOCATE_REQD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log114BoolLocateReqd(TESTB_BOOL_LOCATE_REQD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
