 ...
 *  <p>    Y - Natural
 */
public enum Bool130IOINaturalFlag implements LogFIXString, LogVerboseString {
    ...
    Bool130IOINaturalFlag(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
