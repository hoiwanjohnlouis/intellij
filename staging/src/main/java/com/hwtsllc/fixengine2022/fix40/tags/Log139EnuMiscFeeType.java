 ...
 *      14 - Security Lending
 */
public class Log139EnuMiscFeeType extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log139EnuMiscFeeType(Enum139MiscFeeType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log139EnuMiscFeeType(TESTA_ENU_MISC_FEE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log139EnuMiscFeeType(TESTB_ENU_MISC_FEE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
