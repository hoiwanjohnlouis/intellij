 ...
 */
public class Log115StrOnBehalfOfCompID extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log115StrOnBehalfOfCompID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log115StrOnBehalfOfCompID(new MyStringType(TESTA_STR_ON_BEHALF_OF_COMP_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log115StrOnBehalfOfCompID(new MyStringType(TESTB_STR_ON_BEHALF_OF_COMP_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
