 ...
 */
public class Log122UtcOrigSendingTime extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log122UtcOrigSendingTime(MyUTCTimestampType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log122UtcOrigSendingTime(new MyUTCTimestampType(TESTA_UTC_ORIG_SENDING_TIME) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log122UtcOrigSendingTime(new MyUTCTimestampType(TESTB_UTC_ORIG_SENDING_TIME) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
