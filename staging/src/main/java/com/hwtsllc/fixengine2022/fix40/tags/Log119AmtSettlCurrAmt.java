 ...
 */
public class Log119AmtSettlCurrAmt extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    private final MyAmtType dataValue;

    public final static double TESTA_AMT_SETTL_CURR_AMT = 1.19D;
    public final static double TESTB_AMT_SETTL_CURR_AMT = 9.11D;

    public Log119AmtSettlCurrAmt(MyAmtType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log119AmtSettlCurrAmt(new MyAmtType(TESTA_AMT_SETTL_CURR_AMT) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log119AmtSettlCurrAmt(new MyAmtType(TESTB_AMT_SETTL_CURR_AMT) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
