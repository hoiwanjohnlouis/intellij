 ...
 */
public class Log123BoolGapFillFlag extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log123BoolGapFillFlag(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log123BoolGapFillFlag(TESTA_BOOL_GAP_FILL_FLAG);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log123BoolGapFillFlag(TESTB_BOOL_GAP_FILL_FLAG);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
