 ...
 */
public class Log118AmtNetMoney extends FIX40Abstract implements LogValuePairString, LogVerboseString {
    private final MyAmtType dataValue;

    public final static double TESTA_AMT_NET_MONEY = 1.18D;
    public final static double TESTB_AMT_NET_MONEY = 8.11D;

    public Log118AmtNetMoney(MyAmtType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log118AmtNetMoney(new MyAmtType(TESTA_AMT_NET_MONEY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log118AmtNetMoney(new MyAmtType(TESTB_AMT_NET_MONEY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
