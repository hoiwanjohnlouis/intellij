 ...
 *  <p>    3 - Manual
 */
public enum Enum1002AllocMethod implements LogFIXString, LogVerboseString {
    ...
    Enum1002AllocMethod(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
