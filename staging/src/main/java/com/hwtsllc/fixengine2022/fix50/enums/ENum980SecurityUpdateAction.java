 ...
 *  <p>    M - Modify
 */
public enum ENum980SecurityUpdateAction implements LogFIXString, LogVerboseString {
    ADD( "A", "ADD", "A - Add" ),
    ...
    ENum980SecurityUpdateAction(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
