 ...
 */
public enum Enum1057AggressorIndicator implements EnumAccessors, LogStringVerbose {
    ...
    Enum1057AggressorIndicator(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
