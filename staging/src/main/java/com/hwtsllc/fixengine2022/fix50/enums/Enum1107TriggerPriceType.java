 ...
 *  <p>    6 - Best Mid
 */
public enum Enum1107TriggerPriceType implements EnumAccessors, LogVerboseString {
    ...
    Enum1107TriggerPriceType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
