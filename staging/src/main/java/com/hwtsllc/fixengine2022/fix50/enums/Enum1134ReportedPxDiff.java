 ...
 */
public enum Enum1134ReportedPxDiff implements LogFIXString, LogVerboseString {
    ...
    Enum1134ReportedPxDiff(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
