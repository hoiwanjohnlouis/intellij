 ...
 */
public enum Enum1036ExecAckStatus implements LogFIXString, LogVerboseString {
    ...
    Enum1036ExecAckStatus(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
