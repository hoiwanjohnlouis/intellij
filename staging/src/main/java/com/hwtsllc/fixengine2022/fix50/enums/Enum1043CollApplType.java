 ...
 *  <p>    1 - General
 */
public enum Enum1043CollApplType implements EnumAccessors, LogVerboseString {
    ...
    Enum1043CollApplType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
