 ...
 */
public enum Enum992IndividualAllocType implements LogFIXString, LogVerboseString {
    ...
    Enum992IndividualAllocType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
