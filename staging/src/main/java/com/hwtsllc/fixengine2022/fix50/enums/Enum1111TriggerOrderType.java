 ...
 *  <p>    2 - Limit
 */
public enum Enum1111TriggerOrderType implements EnumAccessors, LogVerboseString {
    ...
    Enum1111TriggerOrderType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
