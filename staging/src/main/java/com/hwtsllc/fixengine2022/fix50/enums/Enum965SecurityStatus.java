 ...
 *  <p>    2 - Inactive
 */
public enum Enum965SecurityStatus implements EnumAccessors, LogVerboseString {
    ...
    Enum965SecurityStatus(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
