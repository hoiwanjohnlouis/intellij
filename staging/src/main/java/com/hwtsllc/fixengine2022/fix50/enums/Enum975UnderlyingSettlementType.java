 ...
 *  <p>    5 - T+4
 */
public enum Enum975UnderlyingSettlementType implements LogFIXString, LogVerboseString {
    ...
    Enum975UnderlyingSettlementType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
