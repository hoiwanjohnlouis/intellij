 ...
 *  <p>    3 - Cancel
 */
public enum Enum1101TriggerAction implements EnumAccessors, LogVerboseString {
    ...
    Enum1101TriggerAction(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
