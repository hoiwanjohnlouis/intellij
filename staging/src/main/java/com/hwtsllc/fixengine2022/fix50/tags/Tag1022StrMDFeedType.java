 ...
 */
public class Tag1022StrMDFeedType extends FIX50Abstract implements LogValuePairString, LogVerboseString {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag1022StrMDFeedType(new MyStringType(TESTA_STR_MD_FEED_TYPE) );
        System.out.println(tagData.toVerboseString());

        tagData = new Tag1022StrMDFeedType(new MyStringType(TESTB_STR_MD_FEED_TYPE) );
        System.out.println(tagData.toVerboseString());
    }
}
