 ...
 */
public class Tag979StrInputSource extends FIX50Abstract implements LogValuePairString, LogVerboseString {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag979StrInputSource(new MyStringType(TESTA_STR_INPUT_SOURCE) );
        System.out.println(tagData.toVerboseString());

        tagData = new Tag979StrInputSource(new MyStringType(TESTB_STR_INPUT_SOURCE) );
        System.out.println(tagData.toVerboseString());
    }
}
