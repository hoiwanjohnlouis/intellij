 ...
 */
public enum Enum1028ManualOrderIndicator implements LogFIXString, LogVerboseString {
    ...
    Enum1028ManualOrderIndicator(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
