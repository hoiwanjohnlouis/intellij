 ...
 */
public enum Enum978LateIndicator implements LogFIXString, LogVerboseString {
    ...
    Enum978LateIndicator(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
