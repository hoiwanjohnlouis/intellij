 ...
 */
public enum Enum1015AsOfIndicator implements EnumAccessors, LogVerboseString {
    ...
    Enum1015AsOfIndicator(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
