 ...
 */
public class Tag1086QtyDisplayHighQty extends FIX50Abstract implements LogValuePairString, LogVerboseString {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag1086QtyDisplayHighQty(new MyQtyType(TESTA_QTY_DISPLAY_HIGH_QTY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Tag1086QtyDisplayHighQty(new MyQtyType(TESTB_QTY_DISPLAY_HIGH_QTY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
