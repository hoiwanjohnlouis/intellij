 ...
 */
public enum Bool1134ReportedPxDiff implements LogFIXString, LogVerboseString {
    ...
    Bool1134ReportedPxDiff(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
    ...
    public static void main(String[] args) {
         ...
         */
        for (Bool1134ReportedPxDiff oneEnum : Bool1134ReportedPxDiff.values()) {
