 ...
 *  <p>    2 - Theoretical
 */
public enum MyEnumSettlPriceType implements LogFIXString, LogVerboseString {
    ...
    MyEnumSettlPriceType( final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
