 ...
 *  <p>    R - Random
 */
public enum MyEnumAssignmentMethod implements EnumAccessors, LogStringVerbose {
    ...
    MyEnumAssignmentMethod(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
