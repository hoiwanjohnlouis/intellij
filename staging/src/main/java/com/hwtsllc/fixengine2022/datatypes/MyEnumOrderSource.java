 ...
 *  <p>    1 - NASD OATS
 */
public enum MyEnumOrderSource implements EnumAccessors, LogVerboseString {
    NASD_OATS( "1", "NASD_OATS", "1 - NASD OATS" ),
    ;
    ...
    MyEnumOrderSource(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
