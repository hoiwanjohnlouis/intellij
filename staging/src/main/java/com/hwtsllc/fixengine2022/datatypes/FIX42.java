 ...
 */
public enum FIX42 implements LogFIXString, LogVerboseString {
    ...
    FIX243_INT_UNDERLYING_REPO_COLLATERAL_SECURITY_TYPE(243, "UNDERLYING_REPO_COLLATERAL_SECURITY_TYPE",
    ...
    FIX258_BOOL_TRADED_FLAT_SWITCH(258, "TRADED_FLAT_SWITCH", "TradedFlatSwitch"),
    FIX259_LMD_BASIS_FEATURE_DATE(259, "BASIS_FEATURE_DATE", "BasisFeatureDate"),
    FIX260_PRC_BASIS_FEATURE_PRICE(260, "BASIS_FEATURE_PRICE", "BasisFeaturePrice"),
    ...
    FIX266_BOOL_AGGREGATED_BOOK(266, "AGGREGATED_BOOK", "AggregatedBook"),
    ...
    FIX305_ENU_UNDERLYING_SECURITY_ID_SOURCE(305, "UNDERLYING_SECURITY_ID_SOURCE", "UnderlyingSecurityIDSource"),
    ...
    FIX313_STR_UNDERLYING_MATURITY_MONTH_YEAR(313, "UNDERLYING_MATURITY_MONTH_YEAR", "UnderlyingMaturityMonthYear"),
    FIX314_INT_UNDERLYING_MATURITY_DAY(314, "UNDERLYING_MATURITY_DAY", "UnderlyingMaturityDay (replaced)"),
    FIX315_ENU_UNDERLYING_PUT_OR_CALL(315, "UNDERLYING_PUT_OR_CALL", "UnderlyingPutOrCall (replaced)"),
    FIX316_PRC_UNDERLYING_STRIKE_PRICE(316, "UNDERLYING_STRIKE_PRICE", "UnderlyingStrikePrice"),
    FIX317_STR_UNDERLYING_OPT_ATTRIBUTE(317, "UNDERLYING_OPT_ATTRIBUTE", "UnderlyingOptAttribute"),
    ...
    FIX325_BOOL_UNSOLICITED_INDICATOR(325, "UNSOLICITED_INDICATOR", "UnsolicitedIndicator"),
    ...
    FIX328_BOOL_IN_VIEW_OF_COMMON(328, "IN_VIEW_OF_COMMON", "InViewOfCommon"),
    FIX329_BOOL_DUE_TO_RELATED(329, "DUE_TO_RELATED", "DueToRelated"),
    ...
    FIX336_STR_TRADING_SESSION_ID(336, "TRADING_SESSION_ID", "TradingSessionID"),
    ...
    FIX347_STR_MESSAGE_ENCODING(347, "MESSAGE_ENCODING", "MessageEncoding"),
    ...
    FIX369_SEQ_LAST_MSG_SEQ_NUM_PROCESSED(369, "LAST_MSG_SEQ_NUM_PROCESSED", "LastMsgSeqNumProcessed"),
    ...
    FIX377_BOOL_SOLICITED_FLAG(377, "SOLICITED_FLAG", "SolicitedFlag"),
    ...
    FIX383_LEN_MAX_MESSAGE_SIZE(383, "MAX_MESSAGE_SIZE", "MaxMessageSize"),
    ...
    FIX389_FLO_DISCRETION_OFFSET_VALUE(389, "DISCRETION_OFFSET_VALUE", "DiscretionOffsetValue"),
    ...
    FIX411_BOOL_EXCHANGE_FOR_PHYSICAL(411, "EXCHANGE_FOR_PHYSICAL", "ExchangeForPhysical"),
