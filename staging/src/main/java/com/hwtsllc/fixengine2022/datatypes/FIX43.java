 ...
 */
public enum FIX43 implements EnumAccessors, LogVerboseString {
    ...
    FIX464_BOOL_TEST_MESSAGE_INDICATOR(464, "TEST_MESSAGE_INDICATOR", "TestMessageIndicator"),
    ...
    FIX477_ENU_DISTRIB_PAYMENT_METHOD(477, "DISTRIB_PAYMENT_METHOD", "DistribPaymentMethod"),
    FIX478_CCY_CASH_DISTRIB_CURR(478, "CASH_DISTRIB_CURR", "CashDistribCurr"),
    ...
    FIX557_INT_TOT_NO_SECURITY_TYPES(557, "TOT_NO_SECURITY_TYPES", "TotNoSecurityTypes"),
    ...
    FIX561_QTY_ROUND_LOT(561, "ROUND_LOT", "RoundLot"),
    FIX562_QTY_MIN_TRADE_VOL(562, "MIN_TRADE_VOL", "MinTradeVol"),
    ...
    FIX566_PRC_LEG_PRICE(566, "LEG_PRICE", "LegPrice"),
    ...
    FIX570_BOOL_PREVIOUSLY_REPORTED(570, "PREVIOUSLY_REPORTED", "PreviouslyReported"),
    ...
    FIX575_BOOL_ODD_LOT(575, "ODD_LOT", "OddLot"),
    ...
    FIX588_LMD_LEG_SETTL_DATE(588, "LEG_SETTL_DATE", "LegSettlDate (formerly named LegFutSettlDate prior to FIX 4.4)"),
    ...
    FIX604_STR_NO_LEG_SECURITY_ALT_ID(604, "NO_LEG_SECURITY_ALT_ID", "NoLegSecurityAltID"),
    ...
    FIX612_PRC_LEG_STRIKE_PRICE(612, "LEG_STRIKE_PRICE", "LegStrikePrice"),
    ...
    FIX616_EXC_LEG_SECURITY_EXCHANGE(616, "LEG_SECURITY_EXCHANGE", "LegSecurityExchange"),
    FIX617_STR_LEG_ISSUER(617, "LEG_ISSUER", "LegIssuer"),
    FIX618_LEN_ENCODED_LEG_ISSUER_LEN(618, "ENCODED_LEG_ISSUER_LEN", "EncodedLegIssuerLen"),
    FIX619_DAT_ENCODED_LEG_ISSUER(619, "ENCODED_LEG_ISSUER", "EncodedLegIssuer"),
    FIX620_STR_LEG_SECURITY_DESC(620, "LEG_SECURITY_DESC", "LegSecurityDesc"),

    FIX621_LEN_ENCODED_LEG_SECURITY_DESC_LEN(621, "ENCODED_LEG_SECURITY_DESC_LEN", "EncodedLegSecurityDescLen"),
    FIX622_DAT_ENCODED_LEG_SECURITY_DESC(622, "ENCODED_LEG_SECURITY_DESC", "EncodedLegSecurityDesc"),
    ...
    FIX631_PRC_MID_PX(631, "MID_PX", "MidPx"),
    ...
    FIX636_BOOL_WORKING_INDICATOR(636, "WORKING_INDICATOR", "WorkingIndicator"),
    FIX637_PRC_LEG_LAST_PX(637, "LEG_LAST_PX", "LegLastPx"),
    ...
    FIX640_PRC_PRICE_2(640, "PRICE_2", "Price2"),
    ...
    FIX645_PRC_MKT_BID_PX(645, "MKT_BID_PX", "MktBidPx"),
    FIX646_PRC_MKT_OFFER_PX(646, "MKT_OFFER_PX", "MktOfferPx"),
    FIX647_QTY_MIN_BID_SIZE(647, "MIN_BID_SIZE", "MinBidSize"),
    FIX648_QTY_MIN_OFFER_SIZE(648, "MIN_OFFER_SIZE", "MinOfferSize"),
    FIX649_STR_QUOTE_STATUS_REQ_ID(649, "QUOTE_STATUS_REQ_ID", "QuoteStatusReqID"),
    FIX650_BOOL_LEGAL_CONFIRM(650, "LEGAL_CONFIRM", "LegalConfirm"),

    FIX651_PRC_UNDERLYING_LAST_PX(651, "UNDERLYING_LAST_PX", "UnderlyingLastPx"),
    FIX652_QTY_UNDERLYING_LAST_QTY(652, "UNDERLYING_LAST_QTY", "UnderlyingLastQty"),
