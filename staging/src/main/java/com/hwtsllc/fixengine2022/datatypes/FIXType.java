...
public enum FIXType {
    ...
    ADV_ID(2, "ADV_ID", "AdvId"),
    FIX3_ADV_REF_ID(3, "ADV_REF_ID", "AdvRefId"),
    ADV_SIDE(4, "ADV_SIDE", "AdvSide"),
    ADV_TRANS_TYPE(5, "ADV_TRANS_TYPE", "AdvTransType"),
    AVG_PX(6, "AVG_PX", "AvgPx"),
    BEGIN_SEQ_NO(7, "BEGIN_SEQ_NO", "BeginSeqNo"),
    BEGIN_STRING(8, "BEGIN_STRING", "BeginString"),
    BODY_LENGTH(9, "BODY_LENGTH", "BodyLength"),
    CHECK_SUM(10, "CHECK_SUM", "CheckSum"),

    CL_ORD_ID(11, "CL_ORD_ID", "ClOrdID"),
    COMMISSION(12, "COMMISSION", "Commission"),
    COMM_TYPE(13, "COMM_TYPE", "CommType"),
    CUM_QTY(14, "CUM_QTY", "CumQty"),
    CURRENCY(15, "CURRENCY", "Currency"),
    END_SEQ_NO(16, "END_SEQ_NO", "EndSeqNo"),
    EXEC_ID(17, "EXEC_ID", "ExecID"),
    EXEC_INST(18, "EXEC_INST", "ExecInst"),
    EXEC_REF_ID(19, "EXEC_REF_ID", "ExecRefID"),
    EXEC_TRANS_TYPE(20, "EXEC_TRANS_TYPE", "ExecTransType (replaced)"),

    HANDL_INST(21, "HANDL_INST", "HandlInst"),
    ID_SOURCE(22, "ID_SOURCE", "IDSource"),
    IOI_ID(23, "IOI_ID", "IOIid"),
    IOI_OTH_SVC(24, "IOI_OTH_SVC", "IOIOthSvc (no longer used)"),
    IOI_QLTY_IND(25, "IOI_QLTY_IND", "IOIQltyInd"),
    IOI_REF_ID(26, "IOI_REF_ID", "IOIRefID"),
    IOI_SHARES(27, "IOI_SHARES", "IOIShares"),
    IOI_TRANS_TYPE(28, "IOI_TRANS_TYPE", "IOITransType"),
    LAST_CAPACITY(29, "LAST_CAPACITY", "LastCapacity"),
    LAST_MKT(30, "LAST_MKT", "LastMkt"),

    LAST_PX(31, "LAST_PX", "LastPx"),
    LAST_QTY(32, "LAST_QTY", "LastQty"),
    LINES_OF_TEXT(33, "LINES_OF_TEXT", "LinesOfText"),
    MSG_SEQ_NUM(34, "MSG_SEQ_NUM", "MsgSeqNum"),
    MSG_TYPE(35, "MSG_TYPE", "MsgType"),
    NEW_SEQ_NO(36, "NEW_SEQ_NO", "NewSeqNo"),
    ORDER_ID(37, "ORDER_ID", "OrderID"),
    ORDER_QTY(38, "ORDER_QTY", "OrderQty"),
    ORD_STATUS(39, "ORD_STATUS", "OrdStatus"),
    ORD_TYPE(40, "ORD_TYPE", "OrdType"),

    ORIG_CL_ORD_ID(41, "ORIG_CL_ORD_ID", "OrigClOrdID"),
    ORIG_TIME(42, "ORIG_TIME", "OrigTime"),
    POSS_DUP_FLAG(43, "POSS_DUP_FLAG", "PossDupFlag"),
    PRICE(44, "PRICE", "Price"),
    REF_SEQ_NUM(45, "REF_SEQ_NUM", "RefSeqNum"),
    RELATD_SYM(46, "RELATD_SYM", "RelatdSym (No longer used)"),
    RULE_80_A(47, "RULE_80_A", "Rule80A (no longer used)"),
    SECURITY_ID(48, "SECURITY_ID", "SecurityID"),
    SENDER_COMP_ID(49, "SENDER_COMP_ID", "SenderCompID"),
    SENDER_SUB_ID(50, "SENDER_SUB_ID", "SenderSubID"),

    SENDING_DATE(51, "SENDING_DATE", "SendingDate (no longer used)"),
    SENDING_TIME(52, "SENDING_TIME", "SendingTime"),
    QUANTITY(53, "QUANTITY", "Quantity (formerly Shares)"),
    SIDE(54, "SIDE", "Side"),
    SYMBOL(55, "SYMBOL", "Symbol"),
    TARGET_COMP_ID(56, "TARGET_COMP_ID", "TargetCompID"),
    TARGET_SUB_ID(57, "TARGET_SUB_ID", "TargetSubID"),
    FIX58_TEXT(58, "TEXT", "Text"),
    TIME_IN_FORCE(59, "TIME_IN_FORCE", "TimeInForce"),
    TRANSACT_TIME(60, "TRANSACT_TIME", "TransactTime"),

    URGENCY(61, "URGENCY", "Urgency"),
    VALID_UNTIL_TIME(62, "VALID_UNTIL_TIME", "ValidUntilTime"),
    SETTLMNT_TYP(63, "SETTLMNT_TYP", "SettlmntTyp"),
    FUT_SETT_DATE(64, "FUT_SETT_DATE", "FutSettDate"),
    SYMBOL_SFX(65, "SYMBOL_SFX", "SymbolSfx"),
    LIST_ID(66, "LIST_ID", "ListID"),
    LIST_SEQ_NO(67, "LIST_SEQ_NO", "ListSeqNo"),
    TOT_NO_ORDERS(68, "TOT_NO_ORDERS", "TotNoOrders (formerly named: ListNoOrds)"),
    LIST_EXEC_INST(69, "LIST_EXEC_INST", "ListExecInst"),
    ALLOC_ID(70, "ALLOC_ID", "AllocID"),

    ALLOC_TRANS_TYPE(71, "ALLOC_TRANS_TYPE", "AllocTransType"),
    REF_ALLOC_ID(72, "REF_ALLOC_ID", "RefAllocID"),
    NO_ORDERS(73, "NO_ORDERS", "NoOrders"),
    AVG_PRX_PRECISION(74, "AVG_PRX_PRECISION", "AvgPrxPrecision"),
    TRADE_DATE(75, "TRADE_DATE", "TradeDate"),
    EXEC_BROKER(76, "EXEC_BROKER", "ExecBroker (replaced)"),
    OPEN_CLOSE(77, "OPEN_CLOSE", "OpenClose"),
    NO_ALLOCS(78, "NO_ALLOCS", "NoAllocs"),
    ALLOC_ACCOUNT(79, "ALLOC_ACCOUNT", "AllocAccount"),
    ALLOC_SHARES(80, "ALLOC_SHARES", "AllocShares"),

    PROCESS_CODE(81, "PROCESS_CODE", "ProcessCode"),
    NO_RPTS(82, "NO_RPTS", "NoRpts"),
    RPT_SEQ(83, "RPT_SEQ", "RptSeq"),
    CXL_QTY(84, "CXL_QTY", "CxlQty"),
    NO_DLVY_INST(85, "NO_DLVY_INST", "NoDlvyInst (no longer used)"),
    DLVY_INST(86, "DLVY_INST", "DlvyInst (no longer used)"),
    ALLOC_STATUS(87, "ALLOC_STATUS", "AllocStatus"),
    ALLOC_REJ_CODE(88, "ALLOC_REJ_CODE", "AllocRejCode"),
    SIGNATURE(89, "SIGNATURE", "Signature"),
    SECURE_DATA_LEN(90, "SECURE_DATA_LEN", "SecureDataLen"),

    SECURE_DATA(91, "SECURE_DATA", "SecureData"),
    BROKER_OF_CREDIT(92, "BROKER_OF_CREDIT", "BrokerOfCredit (replaced)"),
    SIGNATURE_LENGTH(93, "SIGNATURE_LENGTH", "SignatureLength"),
    EMAIL_TYPE(94, "EMAIL_TYPE", "EmailType"),
    RAW_DATA_LENGTH(95, "RAW_DATA_LENGTH", "RawDataLength"),
    RAW_DATA(96, "RAW_DATA", "RawData"),
    POSS_RESEND(97, "POSS_RESEND", "PossResend"),
    ENCRYPT_METHOD(98, "ENCRYPT_METHOD", "EncryptMethod"),
    STOP_PX(99, "STOP_PX", "StopPx"),
    EX_DESTINATION(100, "EX_DESTINATION", "ExDestination"),


    // 101-200

    CXL_REJ_REASON(102, "CXL_REJ_REASON", "CxlRejReason"),
    ORD_REJ_REASON(103, "ORD_REJ_REASON", "OrdRejReason"),
    IOI_QUALIFIER(104, "IOI_QUALIFIER", "IOIQualifier"),
    WAVE_NO(105, "WAVE_NO", "WaveNo"),
    ISSUER(106, "ISSUER", "Issuer"),
    SECURITY_DESC(107, "SECURITY_DESC", "SecurityDesc"),
    HEART_BT_INT(108, "HEART_BT_INT", "HeartBtInt"),
    CLIENT_ID(109, "CLIENT_ID", "ClientID (replaced)"),
    MIN_QTY(110, "MIN_QTY", "MinQty"),

    MAX_FLOOR(111, "MAX_FLOOR", "MaxFloor"),
    TEST_REQ_ID(112, "TEST_REQ_ID", "TestReqID"),
    REPORT_TO_EXCH(113, "REPORT_TO_EXCH", "ReportToExch"),
    LOCATE_REQD(114, "LOCATE_REQD", "LocateReqd"),
    ON_BEHALF_OF_COMP_ID(115, "ON_BEHALF_OF_COMP_ID", "OnBehalfOfCompID"),
    ON_BEHALF_OF_SUB_ID(116, "ON_BEHALF_OF_SUB_ID", "OnBehalfOfSubID"),
    QUOTE_ID(117, "QUOTE_ID", "QuoteID"),
    NET_MONEY(118, "NET_MONEY", "NetMoney"),
    SETTL_CURR_AMT(119, "SETTL_CURR_AMT", "SettlCurrAmt"),
    SETTL_CURRENCY(120, "SETTL_CURRENCY", "SettlCurrency"),

    FOREX_REQ(121, "FOREX_REQ", "ForexReq"),
    ORIG_SENDING_TIME(122, "ORIG_SENDING_TIME", "OrigSendingTime"),
    GAP_FILL_FLAG(123, "GAP_FILL_FLAG", "GapFillFlag"),
    NO_EXECS(124, "NO_EXECS", "NoExecs"),
    CXL_TYPE(125, "CXL_TYPE", "CxlType (no longer used)"),
    EXPIRE_TIME(126, "EXPIRE_TIME", "ExpireTime"),
    DK_REASON(127, "DK_REASON", "DKReason"),
    DELIVER_TO_COMP_ID(128, "DELIVER_TO_COMP_ID", "DeliverToCompID"),
    DELIVER_TO_SUB_ID(129, "DELIVER_TO_SUB_ID", "DeliverToSubID"),
    IOI_NATURAL_FLAG(130, "IOI_NATURAL_FLAG", "IOINaturalFlag"),

    QUOTE_REQ_ID(131, "QUOTE_REQ_ID", "QuoteReqID"),
    BID_PX(132, "BID_PX", "BidPx"),
    OFFER_PX(133, "OFFER_PX", "OfferPx"),
    BID_SIZE(134, "BID_SIZE", "BidSize"),
    OFFER_SIZE(135, "OFFER_SIZE", "OfferSize"),
    NO_MISC_FEES(136, "NO_MISC_FEES", "NoMiscFees"),
    MISC_FEE_AMT(137, "MISC_FEE_AMT", "MiscFeeAmt"),
    MISC_FEE_CURR(138, "MISC_FEE_CURR", "MiscFeeCurr"),
    MISC_FEE_TYPE(139, "MISC_FEE_TYPE", "MiscFeeType"),
    PREV_CLOSE_PX(140, "PREV_CLOSE_PX", "PrevClosePx"),
    /*
     *
     * End of FIX4.0
     *
    ...
    UNDERLYING_TIME_UNIT(1000, "UNDERLYING_TIME_UNIT", "UnderlyingTimeUnit"),
