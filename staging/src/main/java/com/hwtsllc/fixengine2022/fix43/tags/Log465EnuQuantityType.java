...
// @Deprecated
public class Log465EnuQuantityType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log465EnuQuantityType(Enum465QuantityType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log465EnuQuantityType(TESTA_ENU_QUANTITY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log465EnuQuantityType(TESTB_ENU_QUANTITY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
