 ...
 */
public class Log459EnuUnderlyingSecurityAltIDSource extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log459EnuUnderlyingSecurityAltIDSource(MyEnumSecurityIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log459EnuUnderlyingSecurityAltIDSource(TESTA_ENU_UNDERLYING_SECURITY_ALT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log459EnuUnderlyingSecurityAltIDSource(TESTB_ENU_UNDERLYING_SECURITY_ALT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
