 ...
 */
public enum Enum570PreviouslyReported implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - Not reported to counterparty"),
    YES ("Y", "YES", "Y - Previously reported to counterparty"),
    ;
    ...
    Enum570PreviouslyReported(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
