...
public class Log507EnuRegistRejReasonCode extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log507EnuRegistRejReasonCode(Enum507RegistRejReasonCode dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log507EnuRegistRejReasonCode(TESTA_ENU_REGIST_REJ_REASON_CODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log507EnuRegistRejReasonCode(TESTB_ENU_REGIST_REJ_REASON_CODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
