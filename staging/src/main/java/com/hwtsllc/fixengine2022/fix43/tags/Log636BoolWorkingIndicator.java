...
public class Log636BoolWorkingIndicator extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log636BoolWorkingIndicator(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log636BoolWorkingIndicator(TESTA_BOOL_WORKING_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log636BoolWorkingIndicator(TESTB_BOOL_WORKING_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
