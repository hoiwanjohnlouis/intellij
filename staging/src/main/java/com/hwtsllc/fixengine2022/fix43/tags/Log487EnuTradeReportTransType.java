...
public class Log487EnuTradeReportTransType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log487EnuTradeReportTransType(Enum487TradeReportTransType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log487EnuTradeReportTransType(TESTA_ENU_TRADE_REPORT_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log487EnuTradeReportTransType(TESTB_ENU_TRADE_REPORT_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
