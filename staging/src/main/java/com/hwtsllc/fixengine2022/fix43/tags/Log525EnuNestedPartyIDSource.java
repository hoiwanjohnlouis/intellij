 ...
 */
public class Log525EnuNestedPartyIDSource extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    private final MyEnumPartyIDSource dataValue;

    public final static MyEnumPartyIDSource TESTA_ENU_NESTED_PARTY_ID_SOURCE
            = MyEnumPartyIDSource.KOREAN_INVESTOR_ID;
    public final static MyEnumPartyIDSource TESTB_ENU_NESTED_PARTY_ID_SOURCE
            = MyEnumPartyIDSource.BANK_IDENTIFICATION_CODE;

    public Log525EnuNestedPartyIDSource(MyEnumPartyIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log525EnuNestedPartyIDSource(TESTA_ENU_NESTED_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log525EnuNestedPartyIDSource(TESTB_ENU_NESTED_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
