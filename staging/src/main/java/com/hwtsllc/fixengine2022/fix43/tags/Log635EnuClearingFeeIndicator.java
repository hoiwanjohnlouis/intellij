...
public class Log635EnuClearingFeeIndicator extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log635EnuClearingFeeIndicator(Enum635ClearingFeeIndicator dataValue) {
    ...
    public static void main(String[] args) {
        Log635EnuClearingFeeIndicator tagData;

        tagData = new Log635EnuClearingFeeIndicator(TESTA_ENU_CLEARING_FEE_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log635EnuClearingFeeIndicator(TESTB_ENU_CLEARING_FEE_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
