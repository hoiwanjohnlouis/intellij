 ...
 */
public class Log606EnuLegSecurityAltIDSource extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log606EnuLegSecurityAltIDSource(MyEnumSecurityIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log606EnuLegSecurityAltIDSource(TESTA_ENU_LEG_SECURITY_ALT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log606EnuLegSecurityAltIDSource(TESTB_ENU_LEG_SECURITY_ALT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
