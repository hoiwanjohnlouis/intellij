...
public class Log497EnuFundRenewWaiv extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log497EnuFundRenewWaiv(Enum497FundRenewWaiv dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log497EnuFundRenewWaiv(TESTA_ENU_FUND_RENEW_WAIV);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log497EnuFundRenewWaiv(TESTB_ENU_FUND_RENEW_WAIV);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
