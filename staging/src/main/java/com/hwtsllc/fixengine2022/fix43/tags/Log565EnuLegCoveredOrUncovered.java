 ...
 *  <p>    1 - Uncovered
 */
public class Log565EnuLegCoveredOrUncovered extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log565EnuLegCoveredOrUncovered(MyEnumCoveredOrUncovered dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log565EnuLegCoveredOrUncovered(TESTA_ENU_LEG_COVERED_OR_UNCOVERED);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log565EnuLegCoveredOrUncovered(TESTB_ENU_LEG_COVERED_OR_UNCOVERED);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
