...
public class Log519EnuContAmtType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log519EnuContAmtType(Enum519ContAmtType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log519EnuContAmtType(TESTA_ENU_CONT_AMT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log519EnuContAmtType(TESTB_ENU_CONT_AMT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
