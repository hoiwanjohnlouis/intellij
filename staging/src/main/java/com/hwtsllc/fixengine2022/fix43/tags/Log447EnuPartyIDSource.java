 ...
 */
public class Log447EnuPartyIDSource extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    private final MyEnumPartyIDSource dataValue;

    public final static MyEnumPartyIDSource TESTA_ENU_PARTY_ID_SOURCE
            = MyEnumPartyIDSource.AUSTRALIAN_BUSINESS_NUMBER;
    public final static MyEnumPartyIDSource TESTB_ENU_PARTY_ID_SOURCE
            = MyEnumPartyIDSource.TAIWANESE_QUALIFIED_FOREIGN_INVESTOR_ID;

    public Log447EnuPartyIDSource(MyEnumPartyIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log447EnuPartyIDSource(TESTA_ENU_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log447EnuPartyIDSource(TESTB_ENU_PARTY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
