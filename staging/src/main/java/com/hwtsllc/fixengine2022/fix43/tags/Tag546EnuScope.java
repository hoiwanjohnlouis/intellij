...
public class Tag546EnuScope extends FIX43Abstract implements FixTagValuePairString, LogStringVerbose {
    private final Enum546Scope dataValue;

    public final static Enum546Scope TESTA_ENU_SCOPE = Enum546Scope.LOCAL_MARKET;
    public final static Enum546Scope TESTB_ENU_SCOPE = Enum546Scope.GLOBAL;
