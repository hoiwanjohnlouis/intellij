...
public class Log480EnuCancellationRights extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log480EnuCancellationRights(Enum480CancellationRights dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log480EnuCancellationRights(TESTA_ENU_CANCELLATION_RIGHTS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log480EnuCancellationRights(TESTB_ENU_CANCELLATION_RIGHTS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
