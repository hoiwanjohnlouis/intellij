 ...
 *  <p>     13 - FINANCING
 */
public class Log607EnuLegProduct extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log607EnuLegProduct(MyEnumProduct dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log607EnuLegProduct(TESTA_ENU_LEG_PRODUCT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log607EnuLegProduct(TESTB_ENU_LEG_PRODUCT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
