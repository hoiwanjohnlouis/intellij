...
public class Log587EnuLegSettlType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log587EnuLegSettlType(Enum587LegSettlType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log587EnuLegSettlType(TESTA_ENU_LEG_SETTL_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log587EnuLegSettlType(TESTB_ENU_LEG_SETTL_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
