...
public class Log537EnuQuoteType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log537EnuQuoteType(Enum537QuoteType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log537EnuQuoteType(TESTA_ENU_QUOTE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log537EnuQuoteType(TESTB_ENU_QUOTE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
