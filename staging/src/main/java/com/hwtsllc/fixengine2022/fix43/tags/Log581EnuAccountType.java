 ...
 */
public class Log581EnuAccountType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log581EnuAccountType(MyEnumAccountType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log581EnuAccountType(TESTA_ENU_ACCOUNT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log581EnuAccountType(TESTB_ENU_ACCOUNT_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
