...
public class Log477EnuDistribPaymentMethod extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log477EnuDistribPaymentMethod(Enum477DistribPaymentMethod dataValue) {
    ...
    public static void main(String[] args) {
        Log477EnuDistribPaymentMethod tagData;

        tagData = new Log477EnuDistribPaymentMethod(TESTA_ENU_DISTRIB_PAYMENT_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log477EnuDistribPaymentMethod(TESTB_ENU_DISTRIB_PAYMENT_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
