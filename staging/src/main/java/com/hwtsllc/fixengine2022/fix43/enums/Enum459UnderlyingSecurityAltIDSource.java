 ...
 *      L - Letter of Credit
 */
public enum Enum459UnderlyingSecurityAltIDSource implements EnumAccessors, LogStringVerbose {
    ...
    Enum459UnderlyingSecurityAltIDSource(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
    ...
    public static void main(String[] args) {
         ...
         */
        for (Enum459UnderlyingSecurityAltIDSource oneEnum : Enum459UnderlyingSecurityAltIDSource.values()) {
