 ...
 */
public class Log609EnuLegSecurityType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log609EnuLegSecurityType(MyEnumSecurityType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log609EnuLegSecurityType(TESTA_ENU_LEG_SECURITY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log609EnuLegSecurityType(TESTB_ENU_LEG_SECURITY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
