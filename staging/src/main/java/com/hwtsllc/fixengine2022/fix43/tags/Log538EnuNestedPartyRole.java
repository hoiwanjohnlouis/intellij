 ...
 */
public class Log538EnuNestedPartyRole extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public final static MyEnumPartyRole TESTB_ENU_NESTED_PARTY_ROLE
            = MyEnumPartyRole.ALLOCATION_ENTITY;

    public Log538EnuNestedPartyRole(MyEnumPartyRole dataValue) {
        setFixType(FIX43.FIX538_ENU_NESTED_PARTY_ROLE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log538EnuNestedPartyRole(TESTA_ENU_NESTED_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log538EnuNestedPartyRole(TESTB_ENU_NESTED_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
