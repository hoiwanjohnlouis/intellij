...
public class Log577EnuClearingInstruction extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log577EnuClearingInstruction(Enum577ClearingInstruction dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log577EnuClearingInstruction(TESTA_ENU_CLEARING_INSTRUCTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log577EnuClearingInstruction(TESTB_ENU_CLEARING_INSTRUCTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
