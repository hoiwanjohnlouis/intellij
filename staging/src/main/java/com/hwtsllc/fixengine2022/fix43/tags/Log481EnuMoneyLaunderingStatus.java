...
public class Log481EnuMoneyLaunderingStatus extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log481EnuMoneyLaunderingStatus(Enum481MoneyLaunderingStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log481EnuMoneyLaunderingStatus(TESTA_ENU_MONEY_LAUNDERING_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log481EnuMoneyLaunderingStatus(TESTB_ENU_MONEY_LAUNDERING_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
