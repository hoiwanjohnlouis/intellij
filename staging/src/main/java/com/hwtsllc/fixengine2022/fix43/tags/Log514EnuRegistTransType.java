...
public class Log514EnuRegistTransType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log514EnuRegistTransType(Enum514RegistTransType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log514EnuRegistTransType(TESTA_ENU_REGIST_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log514EnuRegistTransType(TESTB_ENU_REGIST_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
