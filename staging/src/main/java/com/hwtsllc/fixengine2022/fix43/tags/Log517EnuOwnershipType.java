...
public class Log517EnuOwnershipType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log517EnuOwnershipType(Enum517OwnershipType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log517EnuOwnershipType(TESTA_ENU_OWNERSHIP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log517EnuOwnershipType(TESTB_ENU_OWNERSHIP_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
