...
public class Log553StrUsername extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    private final MyStringType dataValue;

    public final static String TESTA_STR_USERNAME = "BilboBaggins-Log553StrUsername";
    public final static String TESTB_STR_USERNAME = "Gandalf-Log553StrUsername";

    public Log553StrUsername(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log553StrUsername( new MyStringType(TESTA_STR_USERNAME) );
        ...
        tagData = new Log553StrUsername( new MyStringType(TESTB_STR_USERNAME) );
        System.out.println("t1.1:" + tagData);
        System.out.println("t1.2:" + tagData.toVerboseString());
        System.out.println("t1.3.FIXTypeName:" + tagData.getEnumName());
        System.out.println("t1.4.FIXNumber:" + tagData.getID());
