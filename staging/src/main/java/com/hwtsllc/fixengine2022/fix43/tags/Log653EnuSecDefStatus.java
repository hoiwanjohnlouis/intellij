...
// @Deprecated
public class Log653EnuSecDefStatus extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log653EnuSecDefStatus(Enum653SecDefStatus dataValue) {
    ...
    public static void main(String[] args) {
        Log653EnuSecDefStatus tagData;

        tagData = new Log653EnuSecDefStatus(TESTA_ENU_SEC_DEF_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log653EnuSecDefStatus(TESTB_ENU_SEC_DEF_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
