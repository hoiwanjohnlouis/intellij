 ...
 */
public class Log603EnuLegSecurityIDSource extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    private final MyEnumSecurityIDSource dataValue;

    public final static MyEnumSecurityIDSource TESTA_ENU_LEG_SECURITY_ID_SOURCE
            = MyEnumSecurityIDSource.ISIN;
    public final static MyEnumSecurityIDSource TESTB_ENU_LEG_SECURITY_ID_SOURCE
            = MyEnumSecurityIDSource.LETTER_OF_CREDIT;

    public Log603EnuLegSecurityIDSource(MyEnumSecurityIDSource dataValue) {
        setFixType(FIX43.FIX603_ENU_LEG_SECURITY_ID_SOURCE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log603EnuLegSecurityIDSource(TESTA_ENU_LEG_SECURITY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log603EnuLegSecurityIDSource(TESTB_ENU_LEG_SECURITY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
