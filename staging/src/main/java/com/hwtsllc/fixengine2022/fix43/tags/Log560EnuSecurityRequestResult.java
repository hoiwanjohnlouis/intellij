...
public class Log560EnuSecurityRequestResult extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log560EnuSecurityRequestResult(Enum560SecurityRequestResult dataValue) {
    ...
    public static void main(String[] args) {
        Log560EnuSecurityRequestResult tagData;

        tagData = new Log560EnuSecurityRequestResult(TESTA_ENU_SECURITY_REQUEST_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log560EnuSecurityRequestResult(TESTB_ENU_SECURITY_REQUEST_RESULT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
