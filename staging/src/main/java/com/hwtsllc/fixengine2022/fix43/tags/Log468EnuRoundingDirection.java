...
public class Log468EnuRoundingDirection extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log468EnuRoundingDirection(Enum468RoundingDirection dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log468EnuRoundingDirection(TESTA_ENU_ROUNDING_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log468EnuRoundingDirection(TESTB_ENU_ROUNDING_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
