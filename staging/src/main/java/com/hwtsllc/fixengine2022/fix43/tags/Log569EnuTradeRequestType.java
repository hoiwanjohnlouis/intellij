...
public class Log569EnuTradeRequestType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log569EnuTradeRequestType(Enum569TradeRequestType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log569EnuTradeRequestType(TESTA_ENU_TRADE_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log569EnuTradeRequestType(TESTB_ENU_TRADE_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
