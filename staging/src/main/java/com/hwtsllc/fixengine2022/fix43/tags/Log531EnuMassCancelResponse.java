...
public class Log531EnuMassCancelResponse extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log531EnuMassCancelResponse(Enum531MassCancelResponse dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log531EnuMassCancelResponse(TESTA_ENU_MASS_CANCEL_RESPONSE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log531EnuMassCancelResponse(TESTB_ENU_MASS_CANCEL_RESPONSE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
