...
public class Log532EnuMassCancelRejectReason extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log532EnuMassCancelRejectReason(Enum532MassCancelRejectReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log532EnuMassCancelRejectReason(TESTA_ENU_MASS_CANCEL_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log532EnuMassCancelRejectReason(TESTB_ENU_MASS_CANCEL_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
