...
public class Log573EnuMatchStatus extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log573EnuMatchStatus(Enum573MatchStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log573EnuMatchStatus(TESTA_ENU_MATCH_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log573EnuMatchStatus(TESTB_ENU_MATCH_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
