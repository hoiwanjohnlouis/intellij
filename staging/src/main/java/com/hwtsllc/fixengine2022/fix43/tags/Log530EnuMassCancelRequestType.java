...
public class Log530EnuMassCancelRequestType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log530EnuMassCancelRequestType(Enum530MassCancelRequestType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log530EnuMassCancelRequestType(TESTA_ENU_MASS_CANCEL_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log530EnuMassCancelRequestType(TESTB_ENU_MASS_CANCEL_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
