...
public class Log550EnuCrossPrioritization extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log550EnuCrossPrioritization(Enum550CrossPrioritization dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log550EnuCrossPrioritization(TESTA_ENU_CROSS_PRIORITIZATION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log550EnuCrossPrioritization(TESTB_ENU_CROSS_PRIORITIZATION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
