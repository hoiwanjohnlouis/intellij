...
public class Log484EnuExecPriceType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log484EnuExecPriceType(Enum484PriceType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log484EnuExecPriceType(TESTA_ENU_EXEC_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log484EnuExecPriceType(TESTB_ENU_EXEC_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
