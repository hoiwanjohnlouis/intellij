...
public class Log585EnuMassStatusReqType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log585EnuMassStatusReqType(Enum585MassStatusReqType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log585EnuMassStatusReqType(TESTA_ENU_MASS_STATUS_REQ_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log585EnuMassStatusReqType(TESTB_ENU_MASS_STATUS_REQ_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
