...
public class Log554StrPassword extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    private final MyStringType dataValue;

    public final static String TESTA_STR_PASSWORD = "BilboBaggins-Log554StrPassword";
    public final static String TESTB_STR_PASSWORD = "Gandalf-Log554StrPassword";

    public Log554StrPassword(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log554StrPassword( new MyStringType(TESTA_STR_PASSWORD) );
        ...
        tagData = new Log554StrPassword( new MyStringType(TESTB_STR_PASSWORD) );
        System.out.println("t1.1:" + tagData);
        System.out.println("t1.2:" + tagData.toVerboseString());
        System.out.println("t1.3.FIXTypeName:" + tagData.getEnumName());
        System.out.println("t1.4.FIXNumber:" + tagData.getID());
