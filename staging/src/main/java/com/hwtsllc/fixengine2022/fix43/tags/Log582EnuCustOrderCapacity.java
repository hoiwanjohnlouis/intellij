...
public class Log582EnuCustOrderCapacity extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log582EnuCustOrderCapacity(Enum582CustOrderCapacity dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log582EnuCustOrderCapacity(TESTA_ENU_CUST_ORDER_CAPACITY);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log582EnuCustOrderCapacity(TESTB_ENU_CUST_ORDER_CAPACITY);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
