 ...
 */
public class Log456EnuSecurityAltIDSource extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log456EnuSecurityAltIDSource(MyEnumSecurityIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log456EnuSecurityAltIDSource(TESTA_ENU_SECURITY_ALT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log456EnuSecurityAltIDSource(TESTB_ENU_SECURITY_ALT_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
