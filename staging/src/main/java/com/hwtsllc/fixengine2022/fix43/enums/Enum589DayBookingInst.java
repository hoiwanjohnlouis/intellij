 ...
 */
public enum Enum589DayBookingInst implements EnumAccessors, LogVerboseString {
    /*
     *  0-2 types
     */
    ...
    Enum589DayBookingInst(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
