...
public class Log563EnuMultiLegRptTypeReq extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log563EnuMultiLegRptTypeReq(Enum563MultiLegRptTypeReq dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log563EnuMultiLegRptTypeReq(TESTA_ENU_MULTI_LEG_RPT_TYPE_REQ);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log563EnuMultiLegRptTypeReq(TESTB_ENU_MULTI_LEG_RPT_TYPE_REQ);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
