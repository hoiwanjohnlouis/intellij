...
public class Log618LenEncodedLegIssuerLen extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log618LenEncodedLegIssuerLen(MyLengthType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log618LenEncodedLegIssuerLen(new MyLengthType(TESTA_LEN_ENCODED_LEG_ISSUER_LEN) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log618LenEncodedLegIssuerLen(new MyLengthType(TESTB_LEN_ENCODED_LEG_ISSUER_LEN) );
