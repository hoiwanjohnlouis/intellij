 ...
 */
public class Log452EnuPartyRole extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log452EnuPartyRole(MyEnumPartyRole dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log452EnuPartyRole(TESTA_ENU_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log452EnuPartyRole(TESTB_ENU_PARTY_ROLE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
