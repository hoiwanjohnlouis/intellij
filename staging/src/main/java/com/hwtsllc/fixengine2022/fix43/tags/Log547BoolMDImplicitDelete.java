...
public class Log547BoolMDImplicitDelete extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log547BoolMDImplicitDelete(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log547BoolMDImplicitDelete(TESTA_BOOL_MD_IMPLICIT_DELETE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log547BoolMDImplicitDelete(TESTB_BOOL_MD_IMPLICIT_DELETE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
