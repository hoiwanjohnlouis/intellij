 ...
 */
public enum Enum481MoneyLaunderingStatus implements EnumAccessors, LogVerboseString {
    /*
     * Y, N, 1, 2, and 3 types
     */
    ...
    Enum481MoneyLaunderingStatus(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
