...
public class Log495EnuTaxAdvantageType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log495EnuTaxAdvantageType(Enum495TaxAdvantageType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log495EnuTaxAdvantageType(TESTA_ENU_TAX_ADVANTAGE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log495EnuTaxAdvantageType(TESTB_ENU_TAX_ADVANTAGE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
