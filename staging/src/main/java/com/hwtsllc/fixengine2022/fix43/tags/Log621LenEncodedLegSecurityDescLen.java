...
public class Log621LenEncodedLegSecurityDescLen extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log621LenEncodedLegSecurityDescLen(MyLengthType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log621LenEncodedLegSecurityDescLen(new MyLengthType(TESTA_LEN_ENCODED_LEG_SECURITY_DESC_LEN) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log621LenEncodedLegSecurityDescLen(new MyLengthType(TESTB_LEN_ENCODED_LEG_SECURITY_DESC_LEN) );
