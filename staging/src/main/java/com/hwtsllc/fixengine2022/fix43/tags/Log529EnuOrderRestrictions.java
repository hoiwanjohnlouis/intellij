...
public class Log529EnuOrderRestrictions extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log529EnuOrderRestrictions(Enum529OrderRestrictions dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log529EnuOrderRestrictions(TESTA_ENU_ORDER_RESTRICTIONS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log529EnuOrderRestrictions(TESTB_ENU_ORDER_RESTRICTIONS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
