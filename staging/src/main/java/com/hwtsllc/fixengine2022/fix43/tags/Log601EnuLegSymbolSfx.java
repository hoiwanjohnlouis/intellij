 ...
 */
public class Log601EnuLegSymbolSfx extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log601EnuLegSymbolSfx(MyEnumSymbolSfx dataValue) {
    ...
    public static void main(String[] args) {
        Log601EnuLegSymbolSfx tagData;

        tagData = new Log601EnuLegSymbolSfx(TESTA_ENU_LEG_SYMBOL_SFX);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log601EnuLegSymbolSfx(TESTB_ENU_LEG_SYMBOL_SFX);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
