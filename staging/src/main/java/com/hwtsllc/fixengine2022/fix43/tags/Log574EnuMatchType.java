...
public class Log574EnuMatchType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log574EnuMatchType(Enum574MatchType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log574EnuMatchType(TESTA_ENU_MATCH_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log574EnuMatchType(TESTB_ENU_MATCH_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
