...
public class Log630SeqHopRefID extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log630SeqHopRefID(final MySeqNumType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log630SeqHopRefID(new MySeqNumType(TESTA_SEQ_HOP_REF_ID) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log630SeqHopRefID(new MySeqNumType(TESTB_SEQ_HOP_REF_ID) );
