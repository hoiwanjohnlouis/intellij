...
public class Log506EnuRegistStatus extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log506EnuRegistStatus(Enum506RegistStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log506EnuRegistStatus(TESTA_ENU_REGIST_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log506EnuRegistStatus(TESTB_ENU_REGIST_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
