...
public class Log559EnuSecurityListRequestType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log559EnuSecurityListRequestType(Enum559SecurityListRequestType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log559EnuSecurityListRequestType(TESTA_ENU_SECURITY_LIST_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log559EnuSecurityListRequestType(TESTB_ENU_SECURITY_LIST_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
