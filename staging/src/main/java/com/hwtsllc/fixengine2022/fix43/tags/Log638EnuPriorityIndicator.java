...
public class Log638EnuPriorityIndicator extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log638EnuPriorityIndicator(Enum638PriorityIndicator dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log638EnuPriorityIndicator(TESTA_ENU_PRIORITY_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log638EnuPriorityIndicator(TESTB_ENU_PRIORITY_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
