 ...
 */
public enum Enum517OwnershipType implements EnumAccessors, LogVerboseString {
    /*
     * J, T,and 2 types
     */
    ...
    Enum517OwnershipType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
