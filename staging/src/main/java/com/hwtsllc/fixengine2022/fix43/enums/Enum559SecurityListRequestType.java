 ...
 */
public enum Enum559SecurityListRequestType implements EnumAccessors, LogVerboseString {
    /*
     *  0-4 types
     */
    ...
    Enum559SecurityListRequestType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
