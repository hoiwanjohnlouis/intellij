 ...
 */
public class Log624EnuLegSide extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log624EnuLegSide(MyEnumSide dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log624EnuLegSide(TESTA_ENU_LEG_SIDE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log624EnuLegSide(TESTB_ENU_LEG_SIDE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
