...
public class Log492EnuPaymentMethod extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log492EnuPaymentMethod(Enum492PaymentMethod dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log492EnuPaymentMethod(TESTA_ENU_PAYMENT_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log492EnuPaymentMethod(TESTB_ENU_PAYMENT_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
