 ...
 *  <p>     13 - FINANCING
 */
public class Log462EnuUnderlyingProduct extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log462EnuUnderlyingProduct(MyEnumProduct dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log462EnuUnderlyingProduct(TESTA_ENU_UNDERLYING_PRODUCT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log462EnuUnderlyingProduct(TESTB_ENU_UNDERLYING_PRODUCT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
