...
public class Log567EnuTradSesStatusRejReason extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log567EnuTradSesStatusRejReason(Enum567TradSesStatusRejReason dataValue) {
    ...
    public static void main(String[] args) {
        Log567EnuTradSesStatusRejReason tagData;

        tagData = new Log567EnuTradSesStatusRejReason(TESTA_ENU_TRAD_SES_STATUS_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log567EnuTradSesStatusRejReason(TESTB_ENU_TRAD_SES_STATUS_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
