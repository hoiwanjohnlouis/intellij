...
public class Log626EnuAllocType extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log626EnuAllocType(Enum626AllocType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log626EnuAllocType(TESTA_ENU_ALLOC_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log626EnuAllocType(TESTB_ENU_ALLOC_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
