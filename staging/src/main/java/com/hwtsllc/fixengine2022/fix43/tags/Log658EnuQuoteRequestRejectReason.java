...
public class Log658EnuQuoteRequestRejectReason extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log658EnuQuoteRequestRejectReason(Enum658QuoteRequestRejectReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log658EnuQuoteRequestRejectReason(TESTA_ENU_QUOTE_REQUEST_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log658EnuQuoteRequestRejectReason(TESTB_ENU_QUOTE_REQUEST_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
