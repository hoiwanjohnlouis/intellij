...
public class Log589EnuDayBookingInst extends FIX43Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log589EnuDayBookingInst(Enum589DayBookingInst dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log589EnuDayBookingInst(TESTA_ENU_DAY_BOOKING_INST);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log589EnuDayBookingInst(TESTB_ENU_DAY_BOOKING_INST);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
