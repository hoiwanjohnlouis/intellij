 ...
 */
public enum Enum591PreallocMethod implements EnumAccessors, LogVerboseString {
    /*
     *  0-1 types
     */
    ...
    Enum591PreallocMethod(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
