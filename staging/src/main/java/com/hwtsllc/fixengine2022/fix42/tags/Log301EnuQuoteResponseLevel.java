 ...
 */
public class Log301EnuQuoteResponseLevel extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log301EnuQuoteResponseLevel(Enum301QuoteResponseLevel dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log301EnuQuoteResponseLevel(TESTA_ENU_QUOTE_RESPONSE_LEVEL);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log301EnuQuoteResponseLevel(TESTB_ENU_QUOTE_RESPONSE_LEVEL);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
