 ...
 */
public class Log339EnuTradSesMode extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log339EnuTradSesMode(Enum339TrdSesMode dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log339EnuTradSesMode(TESTA_ENU_TRAD_SES_MODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log339EnuTradSesMode(TESTB_ENU_TRAD_SES_MODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
