...
public class Tag298EnuQuoteCancelType extends FIX42Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public Tag298EnuQuoteCancelType(Enum298QuoteCancelType dataValue) {
