 ...
 */
public enum Enum434CxlRejResponseTo implements EnumAccessors, LogVerboseString {
    /**
     * 1-2 msg types
     */
    ...
    Enum434CxlRejResponseTo(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
