...
public class Log266BoolAggregatedBook extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log266BoolAggregatedBook(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log266BoolAggregatedBook(TESTA_BOOL_AGGREGATED_BOOK);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log266BoolAggregatedBook(TESTB_BOOL_AGGREGATED_BOOK);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
