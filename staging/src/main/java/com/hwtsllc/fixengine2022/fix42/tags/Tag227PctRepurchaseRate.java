...
public class Tag227PctRepurchaseRate extends FIX42Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public final static String TESTA_PCT_REPURCHASE_RATE = "BilboBaggins-Tag227PctRepurchaseRate";
    public final static String TESTB_PCT_REPURCHASE_RATE = "Gandalf-Tag227PctRepurchaseRate";
