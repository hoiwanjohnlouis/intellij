 ...
 */
public class Log429EnuListStatusType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log429EnuListStatusType(Enum429ListStatusType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log429EnuListStatusType(TESTA_ENU_LIST_STATUS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log429EnuListStatusType(TESTB_ENU_LIST_STATUS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
