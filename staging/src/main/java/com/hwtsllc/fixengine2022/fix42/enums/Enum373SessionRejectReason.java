...
public enum Enum373SessionRejectReason implements FixEnumAccessors, LogStringVerbose {
    /*
     * 0-17, 99 msg types
     */
    ...
    TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE( "2", "TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE", "2 - Tag not defined for this message type" ),
    ...
    INCORRECT_VALUE_FOR_THIS_TAG( "5", "INCORRECT_VALUE_FOR_THIS_TAG", "5 - Value is incorrect (out of range) for this tag" ),
    ...
    Enum373SessionRejectReason(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
