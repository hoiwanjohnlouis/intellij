 ...
 */
public class Log423EnuPriceType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    private final MyEnumPriceType dataValue;

    public final static MyEnumPriceType TESTA_ENU_PRICE_TYPE = MyEnumPriceType.VARIABLE_TRADE_PRICE;
    public final static MyEnumPriceType TESTB_ENU_PRICE_TYPE = MyEnumPriceType.TICKS_IN_ONE_TWENTY_EIGHTS;

    public Log423EnuPriceType(MyEnumPriceType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log423EnuPriceType(TESTA_ENU_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log423EnuPriceType(TESTB_ENU_PRICE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
