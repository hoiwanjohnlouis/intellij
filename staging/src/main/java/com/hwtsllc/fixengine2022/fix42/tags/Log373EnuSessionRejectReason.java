 ...
 */
public class Log373EnuSessionRejectReason extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log373EnuSessionRejectReason(Enum373SessionRejectReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log373EnuSessionRejectReason(TESTA_ENU_SESSION_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log373EnuSessionRejectReason(TESTB_ENU_SESSION_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
