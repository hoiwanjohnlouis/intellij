...
public enum Enum286OpenCLoseSettlFlag implements FixEnumAccessors, LogStringVerbose {
    /*
     * 0-5 msg types
     */
    ...
    Enum286OpenCLoseSettlFlag(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
