 ...
 */
public class Log409EnuLiquidityIndType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log409EnuLiquidityIndType(Enum409LiquidityIndType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log409EnuLiquidityIndType(TESTA_ENU_LIQUIDITY_IND_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log409EnuLiquidityIndType(TESTB_ENU_LIQUIDITY_IND_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
