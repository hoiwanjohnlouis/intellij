...
public class Log212LenXmlDataLen extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log212LenXmlDataLen(MyLengthType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log212LenXmlDataLen(new MyLengthType(TESTA_LEN_XML_DATA_LEN) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log212LenXmlDataLen(new MyLengthType(TESTB_LEN_XML_DATA_LEN) );
