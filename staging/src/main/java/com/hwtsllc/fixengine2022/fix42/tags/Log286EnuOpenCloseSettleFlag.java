 ...
 */
public class Log286EnuOpenCloseSettleFlag extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log286EnuOpenCloseSettleFlag(Enum286OpenCLoseSettlFlag dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log286EnuOpenCloseSettleFlag(TESTA_ENU_OPEN_CLOSE_SETTLE_FLAG);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log286EnuOpenCloseSettleFlag(TESTB_ENU_OPEN_CLOSE_SETTLE_FLAG);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
