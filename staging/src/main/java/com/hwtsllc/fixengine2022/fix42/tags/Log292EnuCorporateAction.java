 ...
 */
public class Log292EnuCorporateAction extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log292EnuCorporateAction(Enum292CorporateAction dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log292EnuCorporateAction(TESTA_ENU_CORPORATE_ACTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log292EnuCorporateAction(TESTB_ENU_CORPORATE_ACTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
