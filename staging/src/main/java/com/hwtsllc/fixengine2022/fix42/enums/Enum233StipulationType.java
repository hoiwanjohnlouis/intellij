...
public enum Enum233StipulationType implements EnumAccessors, LogStringVerbose {
    /**
     *  233 (same as 233, 688)
     *  LegStipulationType
    ...
    Enum233StipulationType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
