...
public class Tag370UtcOnBehalfOfSendingTime extends FIX42Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public final static String TESTA_UTC_ON_BEHALF_OF_SENDING_TIME = "BilboBaggins-Tag370UtcOnBehalfOfSendingTime";
    public final static String TESTB_UTC_ON_BEHALF_OF_SENDING_TIME = "Gandalf-Tag370UtcOnBehalfOfSendingTime";
