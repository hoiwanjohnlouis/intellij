 ...
 *      "AT - Burst Basket"
 */
public class Log277EnuTradeCondition extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log277EnuTradeCondition(Enum277TradeCondition dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log277EnuTradeCondition(TESTA_ENU_TRADE_CONDITION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log277EnuTradeCondition(TESTB_ENU_TRADE_CONDITION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
