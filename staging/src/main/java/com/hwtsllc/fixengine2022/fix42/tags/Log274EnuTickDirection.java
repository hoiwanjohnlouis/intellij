 ...
 *      "3 - Zero-Minus Tick"
 */
public class Log274EnuTickDirection extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log274EnuTickDirection(Enum274TickDirection dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log274EnuTickDirection(TESTA_ENU_TICK_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log274EnuTickDirection(TESTB_ENU_TICK_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
