...
public enum Enum372RefMsgType implements FixEnumAccessors, LogStringVerbose {
    /**
    ...
    Enum372RefMsgType(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
    ...
    public static void main(String[] args) {
         ...
         */
        for (Enum372RefMsgType oneEnum : Enum372RefMsgType.values()) {
