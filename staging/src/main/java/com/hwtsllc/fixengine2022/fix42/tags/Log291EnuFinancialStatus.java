 ...
 */
public class Log291EnuFinancialStatus extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log291EnuFinancialStatus(Enum291FinancialStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log291EnuFinancialStatus(TESTA_ENU_FINANCIAL_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log291EnuFinancialStatus(TESTB_ENU_FINANCIAL_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
