 ...
 */
public class Log394EnuBidType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log394EnuBidType(Enum394BidType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log394EnuBidType(TESTA_ENU_BID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log394EnuBidType(TESTB_ENU_BID_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
