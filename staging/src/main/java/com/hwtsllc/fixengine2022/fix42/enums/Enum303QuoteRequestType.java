 ...
 *  <p>    "2 - Automatic"
 */
public enum Enum303QuoteRequestType implements LogFIXString, LogVerboseString {
    /*
     * 1-2 msg types
     */
    ...
    Enum303QuoteRequestType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
