 ...
 */
public class Log303EnuQuoteRequestType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log303EnuQuoteRequestType(Enum303QuoteRequestType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log303EnuQuoteRequestType(TESTA_ENU_QUOTE_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log303EnuQuoteRequestType(TESTB_ENU_QUOTE_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
