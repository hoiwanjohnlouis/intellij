 ...
 */
public class Log378EnuExecRestatementReason extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log378EnuExecRestatementReason(Enum378ExecRestatementReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log378EnuExecRestatementReason(TESTA_ENU_EXEC_RESTATEMENT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log378EnuExecRestatementReason(TESTB_ENU_EXEC_RESTATEMENT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
