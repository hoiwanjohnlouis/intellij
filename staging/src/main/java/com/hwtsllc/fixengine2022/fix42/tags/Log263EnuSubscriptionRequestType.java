...
public class Log263EnuSubscriptionRequestType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log263EnuSubscriptionRequestType(Enum263SubscriptionRequestType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log263EnuSubscriptionRequestType(TESTA_ENU_SUBSCRIPTION_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log263EnuSubscriptionRequestType(TESTB_ENU_SUBSCRIPTION_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
