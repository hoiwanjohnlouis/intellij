 ...
 */
public enum Enum418BidTradeType implements EnumAccessors, LogVerboseString {
    /**
     * A, G, J, and R msg types
     */
    AGENCY( "A", "AGENCY", "A - Agency" ),
    ...
    Enum418BidTradeType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
