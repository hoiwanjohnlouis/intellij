...
public class Log445LenEncodedListStatusTextLen extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log445LenEncodedListStatusTextLen(MyLengthType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log445LenEncodedListStatusTextLen(new MyLengthType(TESTA_LEN_LIST_STATUS_ENCODED_TEXT_LEN) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log445LenEncodedListStatusTextLen(new MyLengthType(TESTB_LEN_LIST_STATUS_ENCODED_TEXT_LEN) );
