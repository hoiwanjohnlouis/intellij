 ...
 *  <p>    Treasury - Treasury
 */
public class Log221EnuBenchmarkCurveName extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log221EnuBenchmarkCurveName(MyEnumBenchmarkCurveName dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log221EnuBenchmarkCurveName(TESTA_ENU_BENCHMARK_CURVE_NAME);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log221EnuBenchmarkCurveName(TESTB_ENU_BENCHMARK_CURVE_NAME);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
