 ...
 */
public class Log399EnuBidDescriptorType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log399EnuBidDescriptorType(Enum399BidDescriptorType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log399EnuBidDescriptorType(TESTA_ENU_BID_DESCRIPTOR_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log399EnuBidDescriptorType(TESTB_ENU_BID_DESCRIPTOR_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
