 ...
 */
public class Log235EnuYieldType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log235EnuYieldType(Enum235YieldType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log235EnuYieldType(TESTA_ENU_YIELD_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log235EnuYieldType(TESTB_ENU_YIELD_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
