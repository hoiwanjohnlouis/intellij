 ...
 */
public class Log281EnuMDReqRejReason extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log281EnuMDReqRejReason(Enum281MDReqRejReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log281EnuMDReqRejReason(TESTA_ENU_MD_REQ_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log281EnuMDReqRejReason(TESTB_ENU_MD_REQ_REJ_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
