 ...
 */
public class Log338EnuTradSesMethod extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log338EnuTradSesMethod(Enum338TradSesMethod dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log338EnuTradSesMethod(TESTA_ENU_TRAD_SES_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log338EnuTradSesMethod(TESTB_ENU_TRAD_SES_METHOD);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
