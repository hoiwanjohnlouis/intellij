...
public enum Enum427GTBookingInst implements FixEnumAccessors, LogStringVerbose {
    /*
     * 0-2 msg types
     */
    ...
    Enum427GTBookingInst(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
