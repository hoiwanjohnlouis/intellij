 ...
 *      SEND( "S", "SEND", "S - Send" ),
 */
public class Log385EnuMsgDirection extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log385EnuMsgDirection(Enum385MsgDirection dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log385EnuMsgDirection(TESTA_ENU_MSG_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log385EnuMsgDirection(TESTB_ENU_MSG_DIRECTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
