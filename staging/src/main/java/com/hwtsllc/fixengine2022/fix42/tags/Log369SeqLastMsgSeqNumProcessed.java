...
public class Log369SeqLastMsgSeqNumProcessed extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log369SeqLastMsgSeqNumProcessed(final MySeqNumType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log369SeqLastMsgSeqNumProcessed(new MySeqNumType(TESTA_SEQ_LAST_MSG_SEQ_NUM_PROCESSED) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log369SeqLastMsgSeqNumProcessed(new MySeqNumType(TESTB_SEQ_LAST_MSG_SEQ_NUM_PROCESSED) );
