 ...
 */
public class Log433EnuListExecInstType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log433EnuListExecInstType(Enum433ListExecInstType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log433EnuListExecInstType(TESTA_ENU_LIST_EXEC_INST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log433EnuListExecInstType(TESTB_ENU_LIST_EXEC_INST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
