 ...
 */
public class Log321EnuSecurityRequestType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log321EnuSecurityRequestType(Enum321SecurityRequestType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log321EnuSecurityRequestType(TESTA_ENU_SECURITY_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log321EnuSecurityRequestType(TESTB_ENU_SECURITY_REQUEST_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
