 ...
 *      NEW( "N", "NEW", "N - New" ),
 */
public class Log374EnuBidRequestTransType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log374EnuBidRequestTransType(Enum374BidRequestTransType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log374EnuBidRequestTransType(TESTA_ENU_BID_REQUEST_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log374EnuBidRequestTransType(TESTB_ENU_BID_REQUEST_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
