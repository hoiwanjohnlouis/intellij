...
public class Tag325EnuUnsolicitedIndicator extends FIX42Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public static void main(String[] args) {
        Tag325EnuUnsolicitedIndicator tagData;

        tagData = new Tag325EnuUnsolicitedIndicator(TESTA_ENU_UNSOLICITED_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag325EnuUnsolicitedIndicator(TESTB_ENU_UNSOLICITED_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());
    }
