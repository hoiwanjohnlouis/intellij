 ...
 */
public class Log297EnuQuoteAckStatus extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public final static Enum297QuoteStatus TESTB_ENU_QUOTE_ACK_STATUS = Enum297QuoteStatus.CANCELED_DUE_TO_CROSS_MARKET;

    public Log297EnuQuoteAckStatus(Enum297QuoteStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log297EnuQuoteAckStatus(TESTA_ENU_QUOTE_ACK_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log297EnuQuoteAckStatus(TESTB_ENU_QUOTE_ACK_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
