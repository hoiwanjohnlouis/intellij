 ...
 */
public class Log380EnuBusinessRejectReason extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log380EnuBusinessRejectReason(Enum380BusinessRejectReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log380EnuBusinessRejectReason(TESTA_ENU_BUSINESS_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log380EnuBusinessRejectReason(TESTB_ENU_BUSINESS_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
