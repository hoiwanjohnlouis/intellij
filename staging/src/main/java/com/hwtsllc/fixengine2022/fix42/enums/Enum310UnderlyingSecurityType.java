...
public enum Enum310UnderlyingSecurityType implements FixEnumAccessors, LogStringVerbose {
    /**
     *  Information is the same as TAG 167
     */
    ...
    Enum310UnderlyingSecurityType(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
