 ...
 */
// @Deprecated
public class Log315EnuUnderlyingPutOrCall extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log315EnuUnderlyingPutOrCall(MyEnumPutOrCall dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log315EnuUnderlyingPutOrCall(TESTA_ENU_UNDERLYING_PUT_OR_CALL);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log315EnuUnderlyingPutOrCall(TESTB_ENU_UNDERLYING_PUT_OR_CALL);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
