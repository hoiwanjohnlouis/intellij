 ...
 */
public class Log312EnuUnderlyingSymbolSfx extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log312EnuUnderlyingSymbolSfx(MyEnumSymbolSfx dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log312EnuUnderlyingSymbolSfx(TESTA_ENU_UNDERLYING_SYMBOL_SFX);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log312EnuUnderlyingSymbolSfx(TESTB_ENU_UNDERLYING_SYMBOL_SFX);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
