 ...
 */
public class Log269EnuMDEntryType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log269EnuMDEntryType(Enum269MDEntryType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log269EnuMDEntryType(TESTA_ENU_MD_ENTRY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log269EnuMDEntryType(TESTB_ENU_MD_ENTRY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
