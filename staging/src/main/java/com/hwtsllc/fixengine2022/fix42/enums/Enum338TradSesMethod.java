 ...
 */
public enum Enum338TradSesMethod implements EnumAccessors, LogVerboseString {
    /**
     * 1-3 msg types
     */
    ELECTRONIC( "1", "ELECTRONIC", "1 - Electronic" ),
    ...
    Enum338TradSesMethod(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
