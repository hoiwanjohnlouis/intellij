...
public enum Enum263SubscriptionRequestType implements FixEnumAccessors, LogStringVerbose {
    /*
     * 0-2 msg types
     */
    SNAPSHOT( "0", "SNAPSHOT",
    ...
    Enum263SubscriptionRequestType(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
