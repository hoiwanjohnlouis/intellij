 ...
 */
public class Log323EnuSecurityResponseType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log323EnuSecurityResponseType(Enum323SecurityResponseType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log323EnuSecurityResponseType(TESTA_ENU_SECURITY_RESPONSE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log323EnuSecurityResponseType(TESTB_ENU_SECURITY_RESPONSE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
