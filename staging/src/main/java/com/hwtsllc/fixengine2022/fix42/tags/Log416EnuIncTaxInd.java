 ...
 */
public class Log416EnuIncTaxInd extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log416EnuIncTaxInd(Enum416IncTaxInd dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log416EnuIncTaxInd(TESTA_ENU_INC_TAX_IND);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log416EnuIncTaxInd(TESTB_ENU_INC_TAX_IND);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
