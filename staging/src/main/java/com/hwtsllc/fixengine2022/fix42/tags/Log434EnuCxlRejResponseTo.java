 ...
 */
public class Log434EnuCxlRejResponseTo extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log434EnuCxlRejResponseTo(Enum434CxlRejResponseTo dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log434EnuCxlRejResponseTo(TESTA_ENU_CXL_REJ_RESPONSE_TO);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log434EnuCxlRejResponseTo(TESTB_ENU_CXL_REJ_RESPONSE_TO);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
