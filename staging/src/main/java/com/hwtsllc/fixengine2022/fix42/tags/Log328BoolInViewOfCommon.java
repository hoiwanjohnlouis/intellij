...
public class Log328BoolInViewOfCommon extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log328BoolInViewOfCommon(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log328BoolInViewOfCommon(TESTA_BOOL_IN_VIEW_OF_COMMON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log328BoolInViewOfCommon(TESTB_BOOL_IN_VIEW_OF_COMMON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
