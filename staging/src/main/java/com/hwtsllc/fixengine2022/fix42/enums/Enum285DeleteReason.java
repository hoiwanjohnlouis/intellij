...
public enum Enum285DeleteReason implements FixEnumAccessors, LogStringVerbose {
    /*
     * 0-1 msg types
     */
    ...
    Enum285DeleteReason(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
