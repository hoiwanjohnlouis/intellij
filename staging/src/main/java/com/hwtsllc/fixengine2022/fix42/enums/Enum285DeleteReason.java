 ...
 */
public enum Enum285DeleteReason implements LogFIXString, LogVerboseString {
    /*
     * 0-1 msg types
     */
    ...
    Enum285DeleteReason(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
