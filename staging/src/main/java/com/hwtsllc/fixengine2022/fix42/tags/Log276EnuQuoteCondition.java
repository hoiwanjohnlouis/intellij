 ...
 *      "2 - Restricted"
 */
public class Log276EnuQuoteCondition extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log276EnuQuoteCondition(Enum276QuoteCondition dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log276EnuQuoteCondition(TESTA_ENU_QUOTE_CONDITION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log276EnuQuoteCondition(TESTB_ENU_QUOTE_CONDITION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
