...
public enum Enum279MDUpdateAction implements FixEnumAccessors, LogStringVerbose {
    /*
     * 0-4 msg types
     */
    NEW( "0", "NEW", "0 - New" ),
    ...
    Enum279MDUpdateAction(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
