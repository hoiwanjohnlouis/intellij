 ...
 */
public class Log310EnuUnderlyingSecurityType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log310EnuUnderlyingSecurityType(MyEnumSecurityType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log310EnuUnderlyingSecurityType(TESTA_ENU_UNDERLYING_SECURITY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log310EnuUnderlyingSecurityType(TESTB_ENU_UNDERLYING_SECURITY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
