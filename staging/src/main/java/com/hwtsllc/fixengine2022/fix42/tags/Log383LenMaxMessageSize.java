...
public class Log383LenMaxMessageSize extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log383LenMaxMessageSize(MyLengthType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log383LenMaxMessageSize(new MyLengthType(TESTA_LEN_MAX_MESSAGE_SIZE) );
        System.out.println("initial values A");
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log383LenMaxMessageSize(new MyLengthType(TESTB_LEN_MAX_MESSAGE_SIZE) );
