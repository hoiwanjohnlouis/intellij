 ...
 */
public class Log300EnuQuoteRejectReason extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log300EnuQuoteRejectReason(Enum300QuoteRejectReason dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log300EnuQuoteRejectReason(TESTA_ENU_QUOTE_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log300EnuQuoteRejectReason(TESTB_ENU_QUOTE_REJECT_REASON);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
