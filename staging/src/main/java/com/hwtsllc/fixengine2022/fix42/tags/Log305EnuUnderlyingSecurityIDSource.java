 ...
 */
public class Log305EnuUnderlyingSecurityIDSource extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log305EnuUnderlyingSecurityIDSource(MyEnumSecurityIDSource dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log305EnuUnderlyingSecurityIDSource(TESTA_ENU_UNDERLYING_SECURITY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log305EnuUnderlyingSecurityIDSource(TESTB_ENU_UNDERLYING_SECURITY_ID_SOURCE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
