 ...
 *      "9 - 6MOLIBOR"
 */
public class Log219EnuBenchmark extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log219EnuBenchmark(Enum219Benchmark dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log219EnuBenchmark(TESTA_ENU_BENCHMARK);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log219EnuBenchmark(TESTB_ENU_BENCHMARK);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
