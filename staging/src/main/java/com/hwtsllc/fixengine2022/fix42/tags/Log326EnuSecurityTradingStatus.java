 ...
 */
public class Log326EnuSecurityTradingStatus extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log326EnuSecurityTradingStatus(Enum326SecurityTradingStatus dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log326EnuSecurityTradingStatus(TESTA_ENU_SECURITY_TRADING_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log326EnuSecurityTradingStatus(TESTB_ENU_SECURITY_TRADING_STATUS);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
