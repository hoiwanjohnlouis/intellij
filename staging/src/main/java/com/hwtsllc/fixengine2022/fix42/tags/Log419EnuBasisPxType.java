 ...
 */
public class Log419EnuBasisPxType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log419EnuBasisPxType(Enum419BasisPxType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log419EnuBasisPxType(TESTA_ENU_BASIS_PX_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log419EnuBasisPxType(TESTB_ENU_BASIS_PX_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
