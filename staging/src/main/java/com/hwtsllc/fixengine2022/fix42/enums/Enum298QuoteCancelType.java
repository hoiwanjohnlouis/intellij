...
public enum Enum298QuoteCancelType implements FixEnumAccessors, LogStringVerbose {
    /*
     * 1-5 msg types
     */
    ...
    Enum298QuoteCancelType(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
