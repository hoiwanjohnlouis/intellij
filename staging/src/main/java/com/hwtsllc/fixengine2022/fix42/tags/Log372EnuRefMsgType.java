 ...
 */
public class Log372EnuRefMsgType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log372EnuRefMsgType(MyEnumMsgType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log372EnuRefMsgType(TESTA_ENU_REF_MSG_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log372EnuRefMsgType(TESTB_ENU_REF_MSG_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
