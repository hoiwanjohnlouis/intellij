...
public class Log325BoolUnsolicitedIndicator extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log325BoolUnsolicitedIndicator(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log325BoolUnsolicitedIndicator(TESTA_BOOL_UNSOLICITED_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log325BoolUnsolicitedIndicator(TESTB_BOOL_UNSOLICITED_INDICATOR);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
