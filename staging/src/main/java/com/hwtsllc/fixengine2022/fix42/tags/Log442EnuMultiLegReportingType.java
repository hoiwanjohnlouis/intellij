 ...
 */
public class Log442EnuMultiLegReportingType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log442EnuMultiLegReportingType(Enum442MultiLegReportingType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log442EnuMultiLegReportingType(TESTA_ENU_MULTI_LEG_REPORTING_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log442EnuMultiLegReportingType(TESTB_ENU_MULTI_LEG_REPORTING_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
