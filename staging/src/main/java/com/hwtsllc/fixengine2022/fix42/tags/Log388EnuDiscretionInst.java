 ...
 */
public class Log388EnuDiscretionInst extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log388EnuDiscretionInst(Enum388DiscretionInst dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log388EnuDiscretionInst(TESTA_ENU_DISCRETION_INST);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log388EnuDiscretionInst(TESTB_ENU_DISCRETION_INST);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
