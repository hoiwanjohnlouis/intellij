...
public enum Enum368QuoteEntryRejectReason implements FixEnumAccessors, LogStringVerbose {
    /*
     * 1-9, 99 msg types
     */
    ...
    Enum368QuoteEntryRejectReason(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
