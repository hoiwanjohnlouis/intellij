 ...
 */
public enum Enum301QuoteResponseLevel implements EnumAccessors, LogVerboseString {
    /**
     * 0-2 msg types
     */
    NO_ACKNOWLEDGEMENT( "0", "NO_ACKNOWLEDGEMENT", "0 - No Acknowledgement (default)" ),
    ...
    Enum301QuoteResponseLevel(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
