 ...
 */
public class Log279EnuMDUpdateAction extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log279EnuMDUpdateAction(Enum279MDUpdateAction dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log279EnuMDUpdateAction(TESTA_ENU_MD_UPDATE_ACTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log279EnuMDUpdateAction(TESTB_ENU_MD_UPDATE_ACTION);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
