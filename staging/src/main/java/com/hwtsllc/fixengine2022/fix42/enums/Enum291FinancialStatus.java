...
public enum Enum291FinancialStatus implements FixEnumAccessors, LogStringVerbose {
    /*
     * 1-3 msg types
     */
    ...
    Enum291FinancialStatus(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
