 ...
 */
public class Log401EnuSideValueInd extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log401EnuSideValueInd(Enum401SideValueInd dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log401EnuSideValueInd(TESTA_ENU_SIDE_VALUE_IND);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log401EnuSideValueInd(TESTB_ENU_SIDE_VALUE_IND);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
