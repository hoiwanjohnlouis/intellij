 ...
 */
public class Log265EnuMDUpdateType extends FIX42Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log265EnuMDUpdateType(Enum265MDUpdateType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log265EnuMDUpdateType(TESTA_ENU_MD_UPDATE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log265EnuMDUpdateType(TESTB_ENU_MD_UPDATE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
