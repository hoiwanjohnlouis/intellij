 ...
 */
public class Log211FloPegOffsetValue extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log211FloPegOffsetValue(MyFloatType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log211FloPegOffsetValue(new MyFloatType(TESTA_FLO_PEG_DIFFERENCE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log211FloPegOffsetValue(new MyFloatType(TESTB_FLO_PEG_DIFFERENCE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
