 ...
 *  <p>    1 - Uncovered
 */
public class Log203EnuCoveredOrUncovered extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log203EnuCoveredOrUncovered(MyEnumCoveredOrUncovered dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log203EnuCoveredOrUncovered(TESTA_ENU_MISC_FEE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log203EnuCoveredOrUncovered(TESTB_ENU_MISC_FEE_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
