 ...
 *  <p>    3 - Hold In Custody
 */
public enum Enum172SettlDeliveryType implements LogFIXString, LogVerboseString {
    VERSUS( "0",
            "VERSUS",
    ...
    Enum172SettlDeliveryType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
