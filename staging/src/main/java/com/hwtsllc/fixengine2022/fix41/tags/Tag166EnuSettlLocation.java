 ...
 */
// @Deprecated
public class Tag166EnuSettlLocation extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag166EnuSettlLocation(TESTA_ENU_SETTL_LOCATION);
