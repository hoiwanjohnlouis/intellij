...
public class Tag208EnuNotifyBrokerOfCredit extends FIX41Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag208EnuNotifyBrokerOfCredit(TESTA_ENU_NOTIFY_BROKER_OF_CREDIT);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag208EnuNotifyBrokerOfCredit(TESTB_ENU_NOTIFY_BROKER_OF_CREDIT);
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());
    }
