 ...
 */
public class Log152QtyCashOrderQty extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    private final MyQtyType dataValue;

    public final static int TESTA_QTY_CASH_ORDER_QTY = 100; // fake data
    public final static int TESTB_QTY_CASH_ORDER_QTY = 300;

    public Log152QtyCashOrderQty(MyQtyType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log152QtyCashOrderQty(new MyQtyType(TESTA_QTY_CASH_ORDER_QTY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log152QtyCashOrderQty(new MyQtyType(TESTB_QTY_CASH_ORDER_QTY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
