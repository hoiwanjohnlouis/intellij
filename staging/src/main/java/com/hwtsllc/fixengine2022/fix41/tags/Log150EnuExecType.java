 ...
 */
public class Log150EnuExecType extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log150EnuExecType(Enum150ExecType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log150EnuExecType(TESTA_ENU_EXEC_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log150EnuExecType(TESTB_ENU_EXEC_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
