 ...
 */
public class Log149StrURLLink extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log149StrURLLink(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log149StrURLLink(new MyStringType(TESTA_STR_URL_LINK) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log149StrURLLink(new MyStringType(TESTB_STR_URL_LINK) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
