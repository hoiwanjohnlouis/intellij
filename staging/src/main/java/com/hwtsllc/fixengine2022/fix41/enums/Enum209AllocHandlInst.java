 ...
 */
public enum Enum209AllocHandlInst implements LogFIXString, LogVerboseString {
    ...
    Enum209AllocHandlInst(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
