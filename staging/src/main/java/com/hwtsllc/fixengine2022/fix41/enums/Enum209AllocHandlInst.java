...
public enum Enum209AllocHandlInst implements FixEnumAccessors, LogStringVerbose {
    ...
    Enum209AllocHandlInst(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
