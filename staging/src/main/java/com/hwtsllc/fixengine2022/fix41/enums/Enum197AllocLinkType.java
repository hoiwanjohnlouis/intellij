...
public enum Enum197AllocLinkType implements FixEnumAccessors, LogStringVerbose {
    ...
    Enum197AllocLinkType(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
