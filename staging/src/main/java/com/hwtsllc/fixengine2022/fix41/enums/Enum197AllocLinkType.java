 ...
 *  <p>    1 - FX Swap
 */
public enum Enum197AllocLinkType implements EnumAccessors, LogVerboseString {
    ...
    Enum197AllocLinkType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
