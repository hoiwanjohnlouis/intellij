 ...
 */
public class Log158PctAccruedInterestRate extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log158PctAccruedInterestRate(MyPercentageType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log158PctAccruedInterestRate(new MyPercentageType(TESTA_PCT_ACCRUED_INTEREST_RATE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log158PctAccruedInterestRate(new MyPercentageType(TESTB_PCT_ACCRUED_INTEREST_RATE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
