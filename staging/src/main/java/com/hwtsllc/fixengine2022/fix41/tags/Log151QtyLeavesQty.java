 ...
 */
public class Log151QtyLeavesQty extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    private final MyQtyType dataValue;

    public final static int TESTA_QTY_LEAVES_QTY = 200; // fake data
    public final static int TESTB_QTY_LEAVES_QTY = 400;

    public Log151QtyLeavesQty(MyQtyType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log151QtyLeavesQty(new MyQtyType(TESTA_QTY_LEAVES_QTY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log151QtyLeavesQty(new MyQtyType(TESTB_QTY_LEAVES_QTY) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
