 ...
 *  <p>    5 - Request reject
 */
public class Log160EnuSettlInstMode extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log160EnuSettlInstMode(Enum160SettlInstMode dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log160EnuSettlInstMode(TESTA_ENU_SETTL_INST_MODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log160EnuSettlInstMode(TESTB_ENU_SETTL_INST_MODE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
