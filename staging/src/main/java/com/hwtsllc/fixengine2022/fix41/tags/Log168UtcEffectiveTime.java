 ...
 *  also known as "GMT")
 */
public class Log168UtcEffectiveTime extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log168UtcEffectiveTime(MyUTCTimestampType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log168UtcEffectiveTime(new MyUTCTimestampType(TESTA_UTC_EFFECTIVE_TIME) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log168UtcEffectiveTime(new MyUTCTimestampType(TESTB_UTC_EFFECTIVE_TIME) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
