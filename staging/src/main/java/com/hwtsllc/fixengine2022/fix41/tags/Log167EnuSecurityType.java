 ...
 */
public class Log167EnuSecurityType extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log167EnuSecurityType(MyEnumSecurityType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log167EnuSecurityType(TESTA_ENU_SECURITY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log167EnuSecurityType(TESTB_ENU_SECURITY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
