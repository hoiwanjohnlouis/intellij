...
public enum Enum160SettlInstMode implements FixEnumAccessors, LogStringVerbose {
    DEFAULT( "0", "DEFAULT",
            "0 - Default (Replaced)" ),
    ...
    Enum160SettlInstMode(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
