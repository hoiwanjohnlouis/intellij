 ...
 *  <p>    T - Restate
 */
public class Log163EnuSettlInstTransType extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log163EnuSettlInstTransType(Enum163SettlInstTransType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log163EnuSettlInstTransType(TESTA_ENU_SETTL_INST_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log163EnuSettlInstTransType(TESTB_ENU_SETTL_INST_TRANS_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
