 ...
 */
public class Log209EnuAllocHandlInst extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log209EnuAllocHandlInst(Enum209AllocHandlInst dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log209EnuAllocHandlInst(TESTA_ENU_ALLOC_HANDL_INST);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log209EnuAllocHandlInst(TESTB_ENU_ALLOC_HANDL_INST);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
