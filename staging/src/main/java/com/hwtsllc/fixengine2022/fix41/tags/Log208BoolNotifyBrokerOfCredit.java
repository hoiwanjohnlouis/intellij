 ...
 */
public class Log208BoolNotifyBrokerOfCredit extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log208BoolNotifyBrokerOfCredit(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log208BoolNotifyBrokerOfCredit(TESTA_BOOL_NOTIFY_BROKER_OF_CREDIT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log208BoolNotifyBrokerOfCredit(TESTB_BOOL_NOTIFY_BROKER_OF_CREDIT);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
