 ...
 */
public class Log200StrMaturityMonthYear extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    private final MyStringType dataValue;

    public final static String TESTA_STR_MATURITY_MONTH_YEAR = "Frodo-Log200StrMaturityMonthYear";
    public final static String TESTB_STR_MATURITY_MONTH_YEAR = "Gandalf-Log200StrMaturityMonthYear";

    public Log200StrMaturityMonthYear(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log200StrMaturityMonthYear(new MyStringType(TESTA_STR_MATURITY_MONTH_YEAR) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log200StrMaturityMonthYear(new MyStringType(TESTB_STR_MATURITY_MONTH_YEAR) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
