 ...
 */
// @Deprecated
public class Log201EnuPutOrCall extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log201EnuPutOrCall(MyEnumPutOrCall dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log201EnuPutOrCall(TESTA_ENU_PUT_OR_CALL);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log201EnuPutOrCall(TESTB_ENU_PUT_OR_CALL);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
