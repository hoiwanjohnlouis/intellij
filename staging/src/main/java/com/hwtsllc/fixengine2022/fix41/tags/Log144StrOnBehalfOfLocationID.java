 ...
 */
public class Log144StrOnBehalfOfLocationID extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log144StrOnBehalfOfLocationID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log144StrOnBehalfOfLocationID(new MyStringType(TESTA_STR_ON_BEHALF_OF_LOCATION_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log144StrOnBehalfOfLocationID(new MyStringType(TESTB_STR_ON_BEHALF_OF_LOCATION_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
