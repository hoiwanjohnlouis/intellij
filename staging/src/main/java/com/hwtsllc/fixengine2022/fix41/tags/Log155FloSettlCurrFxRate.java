 ...
 */
public class Log155FloSettlCurrFxRate extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log155FloSettlCurrFxRate(MyFloatType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log155FloSettlCurrFxRate(new MyFloatType(TESTA_FLO_SETTL_CURR_FX_RATE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log155FloSettlCurrFxRate(new MyFloatType(TESTB_FLO_SETTL_CURR_FX_RATE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
