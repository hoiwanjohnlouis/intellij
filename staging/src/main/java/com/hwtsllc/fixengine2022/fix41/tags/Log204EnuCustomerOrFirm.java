 ...
 */
// @Deprecated
public class Log204EnuCustomerOrFirm extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log204EnuCustomerOrFirm(Enum204CustomerOrFirm dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log204EnuCustomerOrFirm(TESTA_ENU_CUSTOMER_OR_FIRM);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log204EnuCustomerOrFirm(TESTB_ENU_CUSTOMER_OR_FIRM);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
