 ...
 *  <p>    3 - Hold In Custody
 */
public class Log172EnuSettlDeliveryType extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log172EnuSettlDeliveryType(Enum172SettlDeliveryType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log172EnuSettlDeliveryType(TESTA_ENU_SETTL_DELIVERY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log172EnuSettlDeliveryType(TESTB_ENU_SETTL_DELIVERY_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
