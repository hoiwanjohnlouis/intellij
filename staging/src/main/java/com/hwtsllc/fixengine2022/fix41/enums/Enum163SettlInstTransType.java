...
public enum Enum163SettlInstTransType implements FixEnumAccessors, LogStringVerbose {
    NEW( "N", "NEW", "N - New" ),
    ...
    Enum163SettlInstTransType(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
