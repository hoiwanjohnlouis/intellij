 ...
 */
public class Log141BoolResetSeqNumFlag extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log141BoolResetSeqNumFlag(MyBooleanType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log141BoolResetSeqNumFlag(TESTA_BOOL_RESET_SEQ_NUM_FLAG);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log141BoolResetSeqNumFlag(TESTB_BOOL_RESET_SEQ_NUM_FLAG);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
