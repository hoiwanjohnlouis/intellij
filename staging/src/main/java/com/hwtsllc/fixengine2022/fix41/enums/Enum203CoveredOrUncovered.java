...
public enum Enum203CoveredOrUncovered implements FixEnumAccessors, LogStringVerbose {
    ...
    Enum203CoveredOrUncovered(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
