 ...
 *  <p>    D - Divide
 */
public class Log156EnuSettlCurrFXRateCalc extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log156EnuSettlCurrFXRateCalc(MyEnumFXRateCalc dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log156EnuSettlCurrFXRateCalc(TESTA_ENU_SETTL_CURR_FX_RATE_CALC);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log156EnuSettlCurrFXRateCalc(TESTB_ENU_SETTL_CURR_FX_RATE_CALC);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
