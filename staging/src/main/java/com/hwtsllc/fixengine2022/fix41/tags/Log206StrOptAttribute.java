 ...
 */
public class Log206StrOptAttribute extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    private final MyStringType dataValue;

    public final static String TESTA_STR_OPT_ATTRIBUTE = "Frodo-Log206StrOptAttribute";
    public final static String TESTB_STR_OPT_ATTRIBUTE = "Gandalf-Log206StrOptAttribute";

    public Log206StrOptAttribute(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log206StrOptAttribute(new MyStringType(TESTA_STR_OPT_ATTRIBUTE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log206StrOptAttribute(new MyStringType(TESTB_STR_OPT_ATTRIBUTE) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
