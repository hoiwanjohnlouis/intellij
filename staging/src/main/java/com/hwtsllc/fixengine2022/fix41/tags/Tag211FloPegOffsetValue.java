...
public class Tag211FloPegOffsetValue extends FIX41Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public final static String TESTA_FLO_PEG_DIFFERENCE = "Frodo-Tag211FloPegOffsetValue";
    public final static String TESTB_FLO_PEG_DIFFERENCE = "Gandalf-Tag211FloPegOffsetValue";
