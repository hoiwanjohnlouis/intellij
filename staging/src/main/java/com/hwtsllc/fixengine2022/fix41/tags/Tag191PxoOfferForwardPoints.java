...
public class Tag191PxoOfferForwardPoints extends FIX41Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public final static String TESTA_PXO_OFFER_FORWARD_POINTS = "BilboBaggins-Tag191PxoOfferForwardPoints";
    public final static String TESTB_PXO_OFFER_FORWARD_POINTS = "Gandalf-Tag191PxoOfferForwardPoints";
