 ...
 */
public class Log145StrDeliverToLocationID extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log145StrDeliverToLocationID(MyStringType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log145StrDeliverToLocationID(new MyStringType(TESTA_STR_DELIVER_TO_LOCATION_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log145StrDeliverToLocationID(new MyStringType(TESTB_STR_DELIVER_TO_LOCATION_ID) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
