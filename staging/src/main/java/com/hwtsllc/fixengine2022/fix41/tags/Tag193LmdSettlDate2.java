...
public class Tag193LmdSettlDate2 extends FIX41Abstract implements FixTagValuePairString, LogStringVerbose {
    ...
    public Tag193LmdSettlDate2(MyExchangeType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag193LmdSettlDate2(new MyExchangeType(TESTA_LMD_SETTL_DATE_2) );
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());

        tagData = new Tag193LmdSettlDate2(new MyExchangeType(TESTB_LMD_SETTL_DATE_2) );
        System.out.println(tagData);
        System.out.println(tagData.toLogStringVerbose());
        System.out.println(tagData.toFixTagValuePairString());
    }
