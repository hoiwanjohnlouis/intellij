 ...
 *  <p>    1 - FX Swap
 */
public class Log197EnuAllocLinkType extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log197EnuAllocLinkType(Enum197AllocLinkType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log197EnuAllocLinkType(TESTA_ENU_ALLOC_LINK_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log197EnuAllocLinkType(TESTB_ENU_ALLOC_LINK_TYPE);
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
