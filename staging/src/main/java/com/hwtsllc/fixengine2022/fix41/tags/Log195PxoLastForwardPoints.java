 ...
 */
public class Log195PxoLastForwardPoints extends FIX41Abstract implements LogValuePairString, LogVerboseString {
    ...
    public Log195PxoLastForwardPoints(MyPriceOffsetType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        tagData = new Log195PxoLastForwardPoints(new MyPriceOffsetType(TESTA_PXO_LAST_FORWARD_POINTS) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());

        tagData = new Log195PxoLastForwardPoints(new MyPriceOffsetType(TESTB_PXO_LAST_FORWARD_POINTS) );
        System.out.println(tagData);
        System.out.println(tagData.toVerboseString());
        System.out.println(tagData.toValuePairString());
    }
