...
public enum Enum156SettlCurrFxRateCalc implements FixEnumAccessors, LogStringVerbose {
    ...
    Enum156SettlCurrFxRateCalc(final String action, final String name, final String description) {
        this.action = action;
        this.name = name;
