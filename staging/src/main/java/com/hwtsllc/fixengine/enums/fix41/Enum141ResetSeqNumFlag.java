 ...
 */
public enum Enum141ResetSeqNumFlag implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - No"),
    YES ("Y", "YES", "Y - Yes, reset sequence numbers"),
    ;
    ...
    Enum141ResetSeqNumFlag(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
