 ...
 */
public enum Enum1091PreTradeAnonymity implements LogFIXString, LogVerboseString {
    ...
    Enum1091PreTradeAnonymity(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
