 ...
 */
public enum Enum719ContraryInstructionIndicator implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - Instruction for Abandonment"),
    YES ("Y", "YES", "Y - Contrary Instruction for Exercise"),
    ;
    ...
    Enum719ContraryInstructionIndicator(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
