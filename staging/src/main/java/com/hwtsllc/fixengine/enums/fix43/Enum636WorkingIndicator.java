 ...
 */
public enum Enum636WorkingIndicator implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - Order has been accepted but not yet in a working state"),
    YES ("Y", "YES", "Y - Order is currently being worked"),
    ;
    ...
    Enum636WorkingIndicator(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
