 ...
 */
public enum Enum1109TriggerPriceDirection implements LogFIXString, LogVerboseString {
    ...
    Enum1109TriggerPriceDirection(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
