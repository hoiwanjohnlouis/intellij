 ...
 */
public class Tag1118EnuRootPartyIDSource extends FIX50Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    private final MyEnumPartyIDSource dataValue;

    public final static MyEnumPartyIDSource TESTA_ENU_ROOT_PARTY_ID_SOURCE
            = MyEnumPartyIDSource.KOREAN_INVESTOR_ID;
    public final static MyEnumPartyIDSource TESTB_ENU_ROOT_PARTY_ID_SOURCE
            = MyEnumPartyIDSource.BANK_IDENTIFICATION_CODE;

    public Tag1118EnuRootPartyIDSource(MyEnumPartyIDSource dataValue) {
        setFixType(FIX50.FIX1118_ENU_ROOT_PARTY_ID_SOURCE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag1118EnuRootPartyIDSource(TESTA_ENU_ROOT_PARTY_ID_SOURCE);
        System.out.println(tagData.toVerboseString());

        tagData = new Tag1118EnuRootPartyIDSource(TESTB_ENU_ROOT_PARTY_ID_SOURCE);
        System.out.println(tagData.toVerboseString());
    }
}
