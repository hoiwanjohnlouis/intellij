 ...
 */
public class Tag1119EnuRootPartyRole extends FIX50Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    private final MyEnumPartyRole dataValue;

    public final static MyEnumPartyRole TESTA_ENU_ROOT_PARTY_ROLE
            = MyEnumPartyRole.THIRD_PARTY_ALLOCATION_FIRM;
    public final static MyEnumPartyRole TESTB_ENU_ROOT_PARTY_ROLE
            = MyEnumPartyRole.HOME_CA;

    public Tag1119EnuRootPartyRole(MyEnumPartyRole dataValue) {
        setFixType(FIX50.FIX1119_ENU_ROOT_PARTY_ROLE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag1119EnuRootPartyRole(TESTA_ENU_ROOT_PARTY_ROLE);
