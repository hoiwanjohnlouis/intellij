 ...
 */
public class Tag783EnuSettlPartyIDSource extends FIX44Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public static void main(String[] args) {
        ...
        for ( MyEnumPartyIDSource oneEnum : MyEnumPartyIDSource.values()) {
            System.out.println( new Tag783EnuSettlPartyIDSource(oneEnum).toVerboseString() );
        }
    }
}
