 ...
 */
public class Tag1050EnuInstrumentPartyIDSource extends FIX50Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    private final MyEnumPartyIDSource dataValue;

    public final static MyEnumPartyIDSource TESTA_ENU_INSTRUMENT_PARTY_ID_SOURCE
            = MyEnumPartyIDSource.KOREAN_INVESTOR_ID;
    public final static MyEnumPartyIDSource TESTB_ENU_INSTRUMENT_PARTY_ID_SOURCE
            = MyEnumPartyIDSource.BANK_IDENTIFICATION_CODE;

    public Tag1050EnuInstrumentPartyIDSource(MyEnumPartyIDSource dataValue) {
        setFixType(FIX50.FIX1050_ENU_INSTRUMENT_PARTY_ID_SOURCE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag1050EnuInstrumentPartyIDSource(TESTA_ENU_INSTRUMENT_PARTY_ID_SOURCE);
