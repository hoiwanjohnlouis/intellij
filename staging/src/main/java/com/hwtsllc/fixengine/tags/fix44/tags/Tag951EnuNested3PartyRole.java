 ...
 */
public class Tag951EnuNested3PartyRole extends FIX44Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public static void main(String[] args) {
        ...
        for ( MyEnumPartyRole oneEnum : MyEnumPartyRole.values()) {
            System.out.println( new Tag951EnuNested3PartyRole(oneEnum).toVerboseString() );
        }
    }
}
