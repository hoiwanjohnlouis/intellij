 ...
 */
public enum Enum1070MDQuoteType implements LogFIXString, LogVerboseString {
    ...
    Enum1070MDQuoteType(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
