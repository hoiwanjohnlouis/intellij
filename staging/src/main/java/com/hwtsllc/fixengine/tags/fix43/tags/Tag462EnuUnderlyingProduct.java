 ...
 *  <p>     13 - FINANCING
 */
public class Tag462EnuUnderlyingProduct extends FIX43Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public static void main(String[] args) {
        ...
        for ( MyEnumProduct oneEnum : MyEnumProduct.values()) {
            System.out.println( new Tag462EnuUnderlyingProduct(oneEnum).toVerboseString() );
        }
    }
}
