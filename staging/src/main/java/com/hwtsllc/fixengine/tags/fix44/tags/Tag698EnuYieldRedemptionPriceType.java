 ...
 */
public class Tag698EnuYieldRedemptionPriceType extends FIX44Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public Tag698EnuYieldRedemptionPriceType(MyEnumPriceType dataValue) {
    ...
    public static void main(String[] args) {
        ...
        for ( MyEnumPriceType oneEnum : MyEnumPriceType.values()) {
            System.out.println( new Tag698EnuYieldRedemptionPriceType(oneEnum).toVerboseString() );
        }
    }
}
