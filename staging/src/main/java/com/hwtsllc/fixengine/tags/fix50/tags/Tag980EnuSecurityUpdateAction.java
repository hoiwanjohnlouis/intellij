...
import com.hwtsllc.fixengine.tags.fix50.enums.ENum980SecurityUpdateAction;
 ...
 *  <p>    M - Modify
 */
public class Tag980EnuSecurityUpdateAction extends FIX50Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public final static ENum980SecurityUpdateAction TESTA_ENU_SECURITY_UPDATE_ACTION
            = ENum980SecurityUpdateAction.ADD;
    public final static ENum980SecurityUpdateAction TESTB_ENU_SECURITY_UPDATE_ACTION
            = ENum980SecurityUpdateAction.DELETE;

    public Tag980EnuSecurityUpdateAction(ENum980SecurityUpdateAction dataValue) {
        setFixType(FIX50.FIX980_ENU_SECURITY_UPDATE_ACTION);
