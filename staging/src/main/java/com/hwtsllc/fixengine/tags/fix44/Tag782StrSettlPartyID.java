...
public class Tag782StrSettlPartyID extends FIX44Abstract implements LogValuePairString, LogVerboseString {
    ...
    public final static String TESTA_STR_SETTL_PARTY_ID
            = "PattiLuPone-Tag782StrSettlPartyID";
    public final static String TESTB_STR_SETTL_PARTY_ID
            = "KristinChenoweth-Tag782StrSettlPartyID";
