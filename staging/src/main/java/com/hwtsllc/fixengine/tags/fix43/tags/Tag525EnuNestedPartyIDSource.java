 ...
 */
public class Tag525EnuNestedPartyIDSource extends FIX43Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public Tag525EnuNestedPartyIDSource(MyEnumPartyIDSource dataValue) {
