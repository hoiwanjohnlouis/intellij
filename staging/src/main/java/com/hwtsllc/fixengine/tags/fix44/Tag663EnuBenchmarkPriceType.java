...
import com.hwtsllc.fixengine.datatypes.MyEnumPriceType;
 ...
 */
public class Tag663EnuBenchmarkPriceType extends FIX44Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    private final MyEnumPriceType dataValue;

    public final static MyEnumPriceType TESTA_ENU_BENCHMARK_PRICE_TYPE
            = MyEnumPriceType.FIXED_TRADE_PRICE;
    public final static MyEnumPriceType TESTB_ENU_BENCHMARK_PRICE_TYPE
            = MyEnumPriceType.PERCENTAGE;

    public Tag663EnuBenchmarkPriceType(MyEnumPriceType dataValue) {
        setFixType(FIX44.FIX663_ENU_BENCHMARK_PRICE_TYPE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag663EnuBenchmarkPriceType(TESTA_ENU_BENCHMARK_PRICE_TYPE);
        System.out.println(tagData.toVerboseString());

        tagData = new Tag663EnuBenchmarkPriceType(TESTB_ENU_BENCHMARK_PRICE_TYPE);
        System.out.println(tagData.toVerboseString());

        // loop around the ENUM and process
        for ( MyEnumPriceType oneEnum : MyEnumPriceType.values()) {
            System.out.println( new Tag663EnuBenchmarkPriceType(oneEnum).toVerboseString() );
        }
    }
}
