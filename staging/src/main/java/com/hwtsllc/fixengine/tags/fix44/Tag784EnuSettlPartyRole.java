 ...
 */
public class Tag784EnuSettlPartyRole extends FIX44Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public Tag784EnuSettlPartyRole(MyEnumPartyRole dataValue) {
