 ...
 */
public class Tag538EnuNestedPartyRole extends FIX43Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public Tag538EnuNestedPartyRole(MyEnumPartyRole dataValue) {
