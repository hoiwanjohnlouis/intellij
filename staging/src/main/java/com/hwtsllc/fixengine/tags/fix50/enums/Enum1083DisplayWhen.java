 ...
 */
public enum Enum1083DisplayWhen implements LogFIXString, LogVerboseString {
    ...
    Enum1083DisplayWhen(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
