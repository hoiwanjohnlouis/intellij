 ...
 */
public class Tag1051EnuInstrumentPartyRole extends FIX50Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    private final MyEnumPartyRole dataValue;

    public final static MyEnumPartyRole TESTA_ENU_INSTRUMENT_PARTY_ROLE
            = MyEnumPartyRole.INTERESTED_PARTY;
    public final static MyEnumPartyRole TESTB_ENU_INSTRUMENT_PARTY_ROLE
            = MyEnumPartyRole.ALLOCATION_ENTITY;

    public Tag1051EnuInstrumentPartyRole(MyEnumPartyRole dataValue) {
        setFixType(FIX50.FIX1051_ENU_INSTRUMENT_PARTY_ROLE);
    ...
    public static void main(String[] args) {
        ...
        tagData = new Tag1051EnuInstrumentPartyRole(TESTA_ENU_INSTRUMENT_PARTY_ROLE);
