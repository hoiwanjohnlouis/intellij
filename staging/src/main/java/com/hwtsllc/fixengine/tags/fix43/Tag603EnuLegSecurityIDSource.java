 ...
 */
public class Tag603EnuLegSecurityIDSource extends FIX43Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public Tag603EnuLegSecurityIDSource(MyEnumSecurityIDSource dataValue) {
