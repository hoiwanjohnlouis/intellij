 ...
 */
public enum FIX41 implements LogFIXString, LogVerboseString {
    ...
    FIX193_LMD_SETTL_DATE_2(193, "SETTL_DATE_2", "SettlDate2"),
    ...
    FIX200_MMY_MATURITY_MONTH_YEAR(200, "MATURITY_MONTH_YEAR", "MaturityMonthYear"),
