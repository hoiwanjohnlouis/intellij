 ...
 */
public enum MyEnumDiscretionOrPegScope implements LogFIXString, LogVerboseString {
    ...
    MyEnumDiscretionOrPegScope( final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
