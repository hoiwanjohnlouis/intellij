 ...
 *  <p>    Y - Legal Confirm
 */
public enum Enum650LegalConfirm implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - Does not constitute a Legal Confirm"),
    YES ("Y", "YES", "Y - Legal Confirm"),
    ;
    ...
    Enum650LegalConfirm(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
