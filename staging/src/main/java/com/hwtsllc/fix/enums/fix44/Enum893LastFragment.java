 ...
 *  <p>    Y - Last Fragment
 */
public enum Enum893LastFragment implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - Not Last Fragment"),
    YES ("Y", "YES", "Y - Last Fragment"),
    ;
    ...
    Enum893LastFragment(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
