 ...
 */
public enum Enum720PriorSpreadIndicator implements LogFIXString, LogVerboseString {
    NO ("N", "NO", "N - No Rollover"),
    YES ("Y", "YES", "Y - Rollover Prior Day's Spread"),
    ;
    ...
    Enum720PriorSpreadIndicator(final String id, final String name, final String description) {
        this.id = id;
        this.name = name;
