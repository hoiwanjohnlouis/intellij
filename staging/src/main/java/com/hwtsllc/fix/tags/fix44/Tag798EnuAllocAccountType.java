...
import com.hwtsllc.fix.datatypes.MyEnumAccountType;
 ...
 */
public class Tag798EnuAllocAccountType extends FIX44Abstract implements LogValuePairString, LogVerboseString, LogDataString {
    ...
    public static void main(String[] args) {
        ...
        for ( MyEnumAccountType oneEnum : MyEnumAccountType.values()) {
            System.out.println( new Tag798EnuAllocAccountType(oneEnum).toVerboseString() );
        }
    }
}
