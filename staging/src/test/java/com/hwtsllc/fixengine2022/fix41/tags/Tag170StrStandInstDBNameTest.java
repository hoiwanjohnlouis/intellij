...
class Tag170StrStandInstDBNameTest {
    ...
    String [] TestArray = {
            Tag170StrStandInstDBName.TESTA_STR_STAND_INST_DB_NAME,
            Tag170StrStandInstDBName.TESTB_STR_STAND_INST_DB_NAME
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "StandInstDbName", tagData.toFIXDescriptionString());
