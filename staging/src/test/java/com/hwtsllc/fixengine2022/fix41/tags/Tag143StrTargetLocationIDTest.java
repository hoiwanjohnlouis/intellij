...
class Tag143StrTargetLocationIDTest {
    ...
    void FIX0143Test() {
        ...
        assertEquals( "143", fixData.toFIXIDString());
        assertEquals( "TARGET_LOCATION_ID", fixData.toFIXNameString());
        assertEquals( "TargetLocationID", fixData.toFIXDescriptionString());
