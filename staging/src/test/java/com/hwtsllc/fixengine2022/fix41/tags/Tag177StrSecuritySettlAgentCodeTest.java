...
import com.hwtsllc.fixengine2022.fix40.tags.Tag177StrSecuritySettlAgentCode;
...
class Tag177StrSecuritySettlAgentCodeTest {
    ...
    void FIX0177Test() {
        ...
        assertEquals( "177", fixData.toFIXIDString());
        assertEquals( "SECURITY_SETTL_AGENT_CODE", fixData.toFIXNameString());
        assertEquals( "SecuritySettlAgentCode (replaced)", fixData.toFIXDescriptionString());
    ...
    void PrintFIXTagTest() {
        ...
        tagData = new Tag177StrSecuritySettlAgentCode(
                new MyStringType(Tag177StrSecuritySettlAgentCode.TESTB_STR_QUOTE_REQ_ID));
    ...
    void TagGetDataValueTest() {
        ...
        tagData = new Tag177StrSecuritySettlAgentCode(
                new MyStringType(Tag177StrSecuritySettlAgentCode.TESTB_STR_QUOTE_REQ_ID));
        assertEquals( Tag177StrSecuritySettlAgentCode.TESTB_STR_QUOTE_REQ_ID, tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());
    }
    @Test
    void TagToValuePairStringTest() {
        ...
        tagData = new Tag177StrSecuritySettlAgentCode(
                new MyStringType(Tag177StrSecuritySettlAgentCode.TESTB_STR_QUOTE_REQ_ID));
        assertEquals( tagData.toFIXIDString() + "=" + Tag177StrSecuritySettlAgentCode.TESTB_STR_QUOTE_REQ_ID,
    ...
    void TagToStringTest() {
        ...
        tagData = new Tag177StrSecuritySettlAgentCode(
                new MyStringType(Tag177StrSecuritySettlAgentCode.TESTB_STR_QUOTE_REQ_ID));
        assertEquals( Tag177StrSecuritySettlAgentCode.TESTB_STR_QUOTE_REQ_ID,
                tagData.toString());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE,
                tagData.toString());
    }
    ...
    void TagToVerboseStringTest() {
        ...
        tagData = new Tag177StrSecuritySettlAgentCode(
                new MyStringType(Tag177StrSecuritySettlAgentCode.TESTA_STR_QUOTE_REQ_ID));
        assertEquals( "Tag177StrSecuritySettlAgentCode\n" +
                        "\tEnumName[" + tagData.toEnumNameString() + "]\n" +
                        "\tFIXID[" + tagData.toFIXIDString() + "]\n" +
                        "\tFIXName[" + tagData.toFIXNameString() + "]\n" +
                        "\tFIXDescription[" + tagData.toFIXDescriptionString() + "]\n" +
                        "\tDataValue[" + Tag177StrSecuritySettlAgentCode.TESTA_STR_QUOTE_REQ_ID + "]\n" +
                        "\tValuePair[" + tagData.toFIXIDString() + "=" +
                                            Tag177StrSecuritySettlAgentCode.TESTA_STR_QUOTE_REQ_ID + "]",
