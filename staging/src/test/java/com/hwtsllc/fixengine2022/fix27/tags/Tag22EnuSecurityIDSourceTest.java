...
class Tag22EnuSecurityIDSourceTest {
    ...
    void FIX0022Test() {
        ...
        assertEquals( "SECURITY_ID_SOURCE", fixData.toFIXNameString());
        assertEquals( "22", fixData.toFIXIDString());
        assertEquals( "SecurityIDSource", fixData.toFIXDescriptionString());
