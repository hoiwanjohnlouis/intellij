...
class Tag72StRefAllocIDTest {

    @Test
    void FIX0072Test() {
        FIX27 fixData = FIX27.FIX72_ST_REF_ALLOC_ID;
    ...
    void Tag0072Test() {
        ...
        tagData = new Tag72StRefAllocID(new MyStringType(Tag72StRefAllocID.TESTA_ST_REF_ALLOC_ID) );
