...
class Tag79StrAllocAccountTest {
    ...
    private void verifyFIXData( final Tag79StrAllocAccount tagData ) {
    ...
    private void verifyDataValue( final Tag79StrAllocAccount tagData, final String oneElement ) {
    ...
    private void verifyValuePairString( final Tag79StrAllocAccount tagData, final String oneElement ) {
    ...
    private void verifyToString( final Tag79StrAllocAccount tagData, final String oneElement ) {
    ...
    private void verifyVerboseString( final Tag79StrAllocAccount tagData, final String oneElement ) {
