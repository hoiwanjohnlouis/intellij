...
class Tag79StAllocAccountTest {

    @Test
    void FIX0079Test() {
        FIX27 fixData = FIX27.FIX79_ST_ALLOC_ACCOUNT;
    ...
    void Tag0079Test() {
        ...
        tagData = new Tag79StAllocAccount(new MyStringType(Tag79StAllocAccount.TESTA_ST_ALLOC_ACCOUNT) );
