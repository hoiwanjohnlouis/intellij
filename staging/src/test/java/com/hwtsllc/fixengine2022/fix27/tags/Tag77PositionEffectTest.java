...
class Tag77PositionEffectTest {
    ...
    @Test
    void FIX0077Test() {
        FIXType fixData = FIXType.FIX77_POSITION_EFFECT;
    ...
    @Test
    void Tag0077Test() {
        Tag77PositionEffect tagData;

        /*
         * O, F, C, and R PositionEffect types
         */
        tagData = new Tag77PositionEffect(Enum77PositionEffect.OPEN);
        assertEquals( "O", tagData.getDataValue());
        assertNotEquals( FIXType.JUNK_DATA_VALUE, tagData.getDataValue());
        tagData = new Tag77PositionEffect(Enum77PositionEffect.FIFO);
        assertEquals( "F", tagData.getDataValue());
        assertNotEquals( FIXType.JUNK_DATA_VALUE, tagData.getDataValue());
        tagData = new Tag77PositionEffect(Enum77PositionEffect.CLOSE);
        assertEquals( "C", tagData.getDataValue());
        assertNotEquals( FIXType.JUNK_DATA_VALUE, tagData.getDataValue());
        tagData = new Tag77PositionEffect(Enum77PositionEffect.ROLLED);
