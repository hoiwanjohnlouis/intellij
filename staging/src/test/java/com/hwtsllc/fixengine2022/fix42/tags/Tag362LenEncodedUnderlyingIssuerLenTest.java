...
class Tag362LenEncodedUnderlyingIssuerLenTest {
    ...
    void FIX0362Test() {
        ...
        assertEquals( "362", fixData.toEnumIDString());
        assertEquals( "ENCODED_UNDERLYING_ISSUER_LEN", fixData.toEnumNameString());
        assertEquals( "EncodedUnderlyingIssuerLen", fixData.toEnumDescriptionString());
