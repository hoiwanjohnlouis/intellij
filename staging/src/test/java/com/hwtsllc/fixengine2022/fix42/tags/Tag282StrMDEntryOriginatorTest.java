...
class Tag282StrMDEntryOriginatorTest {
    ...
    void FIX0282Test() {
        ...
        assertEquals( "282", fixData.toEnumIDString());
        assertEquals( "MD_ENTRY_ORIGINATOR", fixData.toEnumNameString());
        assertEquals( "MDEntryOriginator", fixData.toEnumDescriptionString());
