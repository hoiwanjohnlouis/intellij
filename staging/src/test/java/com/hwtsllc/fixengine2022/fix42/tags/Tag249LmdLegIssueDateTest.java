...
class Tag249LmdLegIssueDateTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag249LmdLegIssueDate( new MyLocalMktDateType( oneElement ));
            assertEquals( "FIX249_LMD_LEG_ISSUE_DATE", tagData.toFIXLabelString());
            assertEquals( "249", tagData.toFIXIDString());
            assertEquals( "LEG_ISSUE_DATE", tagData.toFIXNameString());
            assertEquals( "LegIssueDate", tagData.toFIXDescriptionString());
