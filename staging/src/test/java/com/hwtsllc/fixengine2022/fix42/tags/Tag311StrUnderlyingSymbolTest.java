...
class Tag311StrUnderlyingSymbolTest {
    ...
    void FIX0311Test() {
        ...
        assertEquals( "311", fixData.toFIXIDString());
        assertEquals( "UNDERLYING_SYMBOL", fixData.toFIXNameString());
        assertEquals( "UnderlyingSymbol", fixData.toFIXDescriptionString());
