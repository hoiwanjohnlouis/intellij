...
class Tag222StrBenchmarkCurvePointTest {
    ...
    void FIX0222Test() {
        ...
        assertEquals( "222", fixData.toEnumIDString());
        assertEquals( "BENCHMARK_CURVE_POINT", fixData.toEnumNameString());
        assertEquals( "BenchmarkCurvePoint", fixData.toEnumDescriptionString());
