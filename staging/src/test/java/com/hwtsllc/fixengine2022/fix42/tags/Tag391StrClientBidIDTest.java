...
class Tag391StrClientBidIDTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag391StrClientBidID( new MyStringType( oneElement ));
            assertEquals( "FIX391_STR_CLIENT_BID_ID", tagData.toFIXLabelString());
            assertEquals( "391", tagData.toFIXIDString());
            assertEquals( "CLIENT_BID_ID", tagData.toFIXNameString());
            assertEquals( "ClientBidID", tagData.toFIXDescriptionString());
