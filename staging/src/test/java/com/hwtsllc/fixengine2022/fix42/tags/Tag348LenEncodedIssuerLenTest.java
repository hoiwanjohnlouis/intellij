...
class Tag348LenEncodedIssuerLenTest {
    ...
    void FIX0348Test() {
        ...
        assertEquals( "348", fixData.toFIXIDString());
        assertEquals( "ENCODED_ISSUER_LEN", fixData.toFIXNameString());
        assertEquals( "EncodedIssuerLen", fixData.toFIXDescriptionString());
