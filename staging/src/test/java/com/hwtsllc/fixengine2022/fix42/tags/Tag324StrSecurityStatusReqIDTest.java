...
class Tag324StrSecurityStatusReqIDTest {
    ...
    void FIX0324Test() {
        ...
        assertEquals( "324", fixData.toFIXIDString());
        assertEquals( "SECURITY_STATUS_REQ_ID", fixData.toFIXNameString());
        assertEquals( "SecurityStatusReqID", fixData.toFIXDescriptionString());
