...
class Tag245PctUnderlyingRepurchaseRateTest {
    ...
    void FIX0245Test() {
        ...
        assertEquals( "245", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_REPURCHASE_RATE", fixData.toEnumNameString());
        assertEquals( "UnderlyingRepurchaseRate (Deprecated)", fixData.toEnumDescriptionString());
