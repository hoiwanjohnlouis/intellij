...
class Tag440StrClearingAccountTest {
    ...
    void FIX0440Test() {
        ...
        assertEquals( "440", fixData.toFIXIDString());
        assertEquals( "CLEARING_ACCOUNT", fixData.toFIXNameString());
        assertEquals( "ClearingAccount", fixData.toFIXDescriptionString());
