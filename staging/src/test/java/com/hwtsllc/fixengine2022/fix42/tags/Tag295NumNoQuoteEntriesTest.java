...
class Tag295NumNoQuoteEntriesTest {
    ...
    void FIX0295Test() {
        ...
        assertEquals( "295", fixData.toEnumIDString());
        assertEquals( "NO_QUOTE_ENTRIES", fixData.toEnumNameString());
        assertEquals( "NoQuoteEntries", fixData.toEnumDescriptionString());
