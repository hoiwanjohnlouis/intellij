...
class Tag408AmtValueOfFuturesTest {
    ...
    void FIX0408Test() {
        ...
        assertEquals( "408", fixData.toEnumIDString());
        assertEquals( "VALUE_OF_FUTURES", fixData.toEnumNameString());
        assertEquals( "ValueOfFutures", fixData.toEnumDescriptionString());
