...
class Tag308ExcUnderlyingSecurityExchangeTest {
    ...
    void FIX0308Test() {
        ...
        assertEquals( "308", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_SECURITY_EXCHANGE", fixData.toEnumNameString());
        assertEquals( "UnderlyingSecurityExchange", fixData.toEnumDescriptionString());
