...
class Tag354LenEncodedTextLenTest {
    ...
    void FIX0354Test() {
        ...
        assertEquals( "354", fixData.toEnumIDString());
        assertEquals( "ENCODED_TEXT_LEN", fixData.toEnumNameString());
        assertEquals( "EncodedTextLen", fixData.toEnumDescriptionString());
