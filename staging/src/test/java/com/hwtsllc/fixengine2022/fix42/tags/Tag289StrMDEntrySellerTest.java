...
class Tag289StrMDEntrySellerTest {
    ...
    void FIX0289Test() {
        ...
        assertEquals( "289", fixData.toEnumIDString());
        assertEquals( "MD_ENTRY_SELLER", fixData.toEnumNameString());
        assertEquals( "MDEntrySeller", fixData.toEnumDescriptionString());
