...
class Tag305EnuUnderlyingSecurityIDSourceTest {
    ...
    void FIX0305Test() {
        ...
        assertEquals( "305", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_SECURITY_ID_SOURCE", fixData.toEnumNameString());
        assertEquals( "UnderlyingSecurityIDSource", fixData.toEnumDescriptionString());
