...
class Tag405PctEFPTrackingErrorTest {
    ...
    void FIX0405Test() {
        ...
        assertEquals( "405", fixData.toFIXIDString());
        assertEquals( "EFP_TRACKING_ERROR", fixData.toFIXNameString());
        assertEquals( "EFPTrackingError", fixData.toFIXDescriptionString());
