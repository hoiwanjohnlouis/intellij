...
class Tag357DatEncodedSubjectTest {
    ...
    void FIX0357Test() {
        ...
        assertEquals( "357", fixData.toEnumIDString());
        assertEquals( "ENCODED_SUBJECT", fixData.toEnumNameString());
        assertEquals( "EncodedSubject", fixData.toEnumDescriptionString());
