...
class Tag260PrcBasisFeaturePriceTest {
    ...
    void FIX0260Test() {
        ...
        assertEquals( "260", fixData.toFIXIDString());
        assertEquals( "BASIS_FEATURE_PRICE", fixData.toFIXNameString());
        assertEquals( "BasisFeaturePrice", fixData.toFIXDescriptionString());
