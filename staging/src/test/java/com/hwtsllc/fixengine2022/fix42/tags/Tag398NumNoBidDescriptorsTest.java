...
class Tag398NumNoBidDescriptorsTest {
    ...
    void FIX0398Test() {
        ...
        assertEquals( "398", fixData.toEnumIDString());
        assertEquals( "NO_BID_DESCRIPTORS", fixData.toEnumNameString());
        assertEquals( "NoBidDescriptors", fixData.toEnumDescriptionString());
