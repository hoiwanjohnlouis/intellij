 ...
 */
class Bool325UnsolicitedIndicatorTest {
    @Test
    void Enum0325Test() {
        Bool325UnsolicitedIndicator enumType;

        enumType = Bool325UnsolicitedIndicator.NO;
        ...
        enumType = Bool325UnsolicitedIndicator.YES;
