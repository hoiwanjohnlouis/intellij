...
class Tag214StrSettlInstRefIDTest {
    ...
    void FIX0214Test() {
        ...
        assertEquals( "214", fixData.toEnumIDString());
        assertEquals( "SETTL_INST_REF_ID", fixData.toEnumNameString());
        assertEquals( "SettlInstRefID", fixData.toEnumDescriptionString());
