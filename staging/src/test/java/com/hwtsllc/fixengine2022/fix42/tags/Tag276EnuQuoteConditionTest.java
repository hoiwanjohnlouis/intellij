...
class Tag276EnuQuoteConditionTest {
    ...
    void Tag0276Test() {
         ...
         * 0-2
         */
        tagData = new Log276EnuQuoteCondition(Enum276QuoteCondition.RESERVED_SAM);
        assertEquals( Enum276QuoteCondition.RESERVED_SAM.getID(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Log276EnuQuoteCondition(Enum276QuoteCondition.NO_ACTIVE_SAM);
        assertEquals( Enum276QuoteCondition.NO_ACTIVE_SAM.getID(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Log276EnuQuoteCondition(Enum276QuoteCondition.RESTRICTED);
