...
class Tag361DatEncodedAllocTextTest {
    ...
    void FIX0361Test() {
        ...
        assertEquals( "361", fixData.toFIXIDString());
        assertEquals( "ENCODED_ALLOC_TEXT", fixData.toFIXNameString());
        assertEquals( "EncodedAllocText", fixData.toFIXDescriptionString());
