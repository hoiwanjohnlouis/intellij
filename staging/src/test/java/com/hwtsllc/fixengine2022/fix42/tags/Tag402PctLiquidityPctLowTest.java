...
class Tag402PctLiquidityPctLowTest {
    ...
    void FIX0402Test() {
        ...
        assertEquals( "402", fixData.toFIXIDString());
        assertEquals( "LIQUIDITY_PCT_LOW", fixData.toFIXNameString());
        assertEquals( "LiquidityPctLow", fixData.toFIXDescriptionString());
