...
class Tag231FloContractMultiplierTest {
    ...
    void FIX0231Test() {
        ...
        assertEquals( "231", fixData.toFIXIDString());
        assertEquals( "CONTRACT_MULTIPLIER", fixData.toFIXNameString());
        assertEquals( "ContractMultiplier", fixData.toFIXDescriptionString());
