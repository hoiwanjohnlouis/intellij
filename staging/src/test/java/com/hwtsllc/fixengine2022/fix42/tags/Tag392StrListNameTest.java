...
class Tag392StrListNameTest {
    @Test
    void FIX0392Test() {
        FIX42 fixData = FIX42.FIX392_STR_LIST_NAME;
        assertEquals( "392", fixData.toEnumIDString());
        assertEquals( "LIST_NAME", fixData.toEnumNameString());
        assertEquals( "ListName", fixData.toEnumDescriptionString());
