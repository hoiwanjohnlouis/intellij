...
class Tag343UtcTradSesPreCloseTimeTest {
    ...
    void FIX0343Test() {
        ...
        assertEquals( "343", fixData.toEnumIDString());
        assertEquals( "TRAD_SES_PRE_CLOSE_TIME", fixData.toEnumNameString());
        assertEquals( "TradSesPreCloseTime", fixData.toEnumDescriptionString());
