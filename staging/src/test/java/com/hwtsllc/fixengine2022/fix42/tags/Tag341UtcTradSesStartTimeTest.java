...
class Tag341UtcTradSesStartTimeTest {
    ...
    void FIX0341Test() {
        ...
        assertEquals( "341", fixData.toEnumIDString());
        assertEquals( "TRAD_SES_START_TIME", fixData.toEnumNameString());
        assertEquals( "TradSesStartTime", fixData.toEnumDescriptionString());
