...
class Tag441IntLiquidityNumSecuritiesTest {
    ...
    private void verifyAll( final Tag441IntLiquidityNumSecurities tagData, final int oneElement ) {
    ...
    private void verifyFIXData( final Tag441IntLiquidityNumSecurities tagData ) {
    ...
    private void verifyDataValue( final Tag441IntLiquidityNumSecurities tagData, final int oneElement ) {
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_INT_DATA_VALUE, tagData.getDataValue() );
    }

    private void verifyValuePairString( final Tag441IntLiquidityNumSecurities tagData, final int oneElement ) {
        assertEquals( tagData.toEnumIDString() + "=" + oneElement, tagData.toValuePairString());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.toValuePairString());
    }

    private void verifyToString( final Tag441IntLiquidityNumSecurities tagData, final int oneElement ) {
        assertEquals( String.valueOf( oneElement ), tagData.toString() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.toString() );
    }

    private void verifyVerboseString( final Tag441IntLiquidityNumSecurities tagData ) {
