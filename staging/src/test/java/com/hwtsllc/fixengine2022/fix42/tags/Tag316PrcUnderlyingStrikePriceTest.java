...
class Tag316PrcUnderlyingStrikePriceTest {
    ...
    void FIX0316Test() {
        ...
        assertEquals( "316", fixData.toFIXIDString());
        assertEquals( "UNDERLYING_STRIKE_PRICE", fixData.toFIXNameString());
        assertEquals( "UnderlyingStrikePrice", fixData.toFIXDescriptionString());
