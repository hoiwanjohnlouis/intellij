...
class Tag254LmdLegRedemptionDateTest {
    ...
    void FIX0254Test() {
        ...
        assertEquals( "254", fixData.toFIXIDString());
        assertEquals( "LEG_REDEMPTION_DATE", fixData.toFIXNameString());
        assertEquals( "LegRedemptionDate (Deprecated)", fixData.toFIXDescriptionString());
