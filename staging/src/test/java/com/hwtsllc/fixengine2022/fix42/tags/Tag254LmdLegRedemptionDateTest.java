...
class Tag254LmdLegRedemptionDateTest {
    ...
    void FIX0254Test() {
        ...
        assertEquals( "254", fixData.toEnumIDString());
        assertEquals( "LEG_REDEMPTION_DATE", fixData.toEnumNameString());
        assertEquals( "LegRedemptionDate (Deprecated)", fixData.toEnumDescriptionString());
