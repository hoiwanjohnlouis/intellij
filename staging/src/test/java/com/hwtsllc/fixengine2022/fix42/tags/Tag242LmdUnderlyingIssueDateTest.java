...
class Tag242LmdUnderlyingIssueDateTest {
    ...
    void FIX0242Test() {
        ...
        assertEquals( "242", fixData.toFIXIDString());
        assertEquals( "UNDERLYING_ISSUE_DATE", fixData.toFIXNameString());
        assertEquals( "UnderlyingIssueDate", fixData.toFIXDescriptionString());
