...
class Tag415IntProgPeriodIntervalTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "415", tagData.toFIXIDString());
            assertEquals( "PROG_PERIOD_INTERVAL", tagData.toFIXNameString());
            assertEquals( "ProgPeriodInterval", tagData.toFIXDescriptionString());
