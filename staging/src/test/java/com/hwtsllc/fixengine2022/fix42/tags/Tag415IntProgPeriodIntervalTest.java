...
class Tag415IntProgPeriodIntervalTest {
    ...
    private void verifyAll( final Tag415IntProgPeriodInterval tagData, final int oneElement ) {
    ...
    private void verifyFIXData( final Tag415IntProgPeriodInterval tagData ) {
    ...
    private void verifyDataValue( final Tag415IntProgPeriodInterval tagData, final int oneElement ) {
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_INT_DATA_VALUE, tagData.getDataValue() );
    }

    private void verifyValuePairString( final Tag415IntProgPeriodInterval tagData, final int oneElement ) {
        assertEquals( tagData.toEnumIDString() + "=" + oneElement, tagData.toValuePairString());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.toValuePairString());
    }

    private void verifyToString( final Tag415IntProgPeriodInterval tagData, final int oneElement ) {
        assertEquals( String.valueOf( oneElement ), tagData.toString() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.toString() );
    }

    private void verifyVerboseString( final Tag415IntProgPeriodInterval tagData ) {
