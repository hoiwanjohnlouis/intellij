...
class Tag379StrBusinessRejectRefIDTest {
    ...
    void FIX0379Test() {
        ...
        assertEquals( "379", fixData.toFIXIDString());
        assertEquals( "BUSINESS_REJECT_REF_ID", fixData.toFIXNameString());
        assertEquals( "BusinessRejectRefID", fixData.toFIXDescriptionString());
