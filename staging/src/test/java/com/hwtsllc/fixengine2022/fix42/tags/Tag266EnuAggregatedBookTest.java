...
class Tag266EnuAggregatedBookTest {
    ...
    void FIX0266Test() {
        ...
        assertEquals( "266", fixData.toEnumIDString());
        assertEquals( "AGGREGATED_BOOK", fixData.toEnumNameString());
        assertEquals( "AggregatedBook", fixData.toEnumDescriptionString());
