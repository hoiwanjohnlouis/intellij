...
class Tag322StrSecurityResponseIDTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag322StrSecurityResponseID( new MyStringType( oneElement ));
            assertEquals( "FIX322_STR_SECURITY_RESPONSE_ID", tagData.toFIXLabelString());
            assertEquals( "322", tagData.toFIXIDString());
            assertEquals( "SECURITY_RESPONSE_ID", tagData.toFIXNameString());
            assertEquals( "SecurityResponseID", tagData.toFIXDescriptionString());
