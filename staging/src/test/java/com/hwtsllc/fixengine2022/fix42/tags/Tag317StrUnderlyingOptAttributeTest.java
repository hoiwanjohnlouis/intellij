...
class Tag317StrUnderlyingOptAttributeTest {
    ...
    void FIX0317Test() {
        ...
        assertEquals( "317", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_OPT_ATTRIBUTE", fixData.toEnumNameString());
        assertEquals( "UnderlyingOptAttribute", fixData.toEnumDescriptionString());
