...
class Tag435PctUnderlyingCouponRateTest {
    ...
    void FIX0435Test() {
        ...
        assertEquals( "435", fixData.toFIXIDString());
        assertEquals( "UNDERLYING_COUPON_RATE", fixData.toFIXNameString());
        assertEquals( "UnderlyingCouponRate", fixData.toFIXDescriptionString());
