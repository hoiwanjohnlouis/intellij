...
class Tag403PctLiquidityPctHighTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag403PctLiquidityPctHigh( new MyPercentageType( oneElement ));
            assertEquals( "FIX403_PCT_LIQUIDITY_PCT_HIGH", tagData.toFIXLabelString());
            assertEquals( "403", tagData.toFIXIDString());
            assertEquals( "LIQUIDITY_PCT_HIGH", tagData.toFIXNameString());
            assertEquals( "LiquidityPctHigh", tagData.toFIXDescriptionString());
