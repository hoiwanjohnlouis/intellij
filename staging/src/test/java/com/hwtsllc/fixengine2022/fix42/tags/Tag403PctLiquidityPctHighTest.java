...
class Tag403PctLiquidityPctHighTest {
    ...
    void FIX0403Test() {
        ...
        assertEquals( "403", fixData.toEnumIDString());
        assertEquals( "LIQUIDITY_PCT_HIGH", fixData.toEnumNameString());
        assertEquals( "LiquidityPctHigh", fixData.toEnumDescriptionString());
