...
class Tag267NumNoMDEntryTypesTest {
    ...
    void FIX0267Test() {
        ...
        assertEquals( "267", fixData.toEnumIDString());
        assertEquals( "NO_MD_ENTRY_TYPES", fixData.toEnumNameString());
        assertEquals( "NoMDEntryTypes", fixData.toEnumDescriptionString());
