...
class Tag226IntRepurchaseTermTest {
    ...
    void FIX0226Test() {
        ...
        assertEquals( "226", fixData.toEnumIDString());
        assertEquals( "REPURCHASE_TERM", fixData.toEnumNameString());
        assertEquals( "RepurchaseTerm (Deprecated)", fixData.toEnumDescriptionString());
