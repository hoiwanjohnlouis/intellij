...
class Tag226IntRepurchaseTermTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "226", tagData.toFIXIDString());
            assertEquals( "REPURCHASE_TERM", tagData.toFIXNameString());
            assertEquals( "RepurchaseTerm (Deprecated)", tagData.toFIXDescriptionString());
