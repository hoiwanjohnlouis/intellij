...
class Tag353DatEncodedListExecInstTest {
    ...
    void FIX0353Test() {
        ...
        assertEquals( "353", fixData.toFIXIDString());
        assertEquals( "ENCODED_LIST_EXEC_INST", fixData.toFIXNameString());
        assertEquals( "EncodedListExecInst", fixData.toFIXDescriptionString());
