...
class Tag353DatEncodedListExecInstTest {
    @Test
    void FIX0353Test() {
        FIX42 fixData = FIX42.FIX353_DAT_ENCODED_LIST_EXEC_INST;
        assertEquals( "353", fixData.toEnumIDString());
        assertEquals( "ENCODED_LIST_EXEC_INST", fixData.toEnumNameString());
        assertEquals( "EncodedListExecInst", fixData.toEnumDescriptionString());
