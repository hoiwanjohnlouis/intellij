...
class Tag257StrLegCreditRatingTest {
    ...
    void FIX0257Test() {
        ...
        assertEquals( "257", fixData.toEnumIDString());
        assertEquals( "LEG_CREDIT_RATING", fixData.toEnumNameString());
        assertEquals( "LegCreditRating", fixData.toEnumDescriptionString());
