...
class Tag233EnuStipulationTypeTest {
    ...
    void FIX0233Test() {
        ...
        assertEquals( "233", fixData.toEnumIDString());
        assertEquals( "STIPULATION_TYPE", fixData.toEnumNameString());
        assertEquals( "StipulationType", fixData.toEnumDescriptionString());
    ...
    void Tag0233Test() {
        ...
        assertEquals( MyEnumStipulationType.ALTERNATIVE_MINIMUM_TAX.toEnumIDString(), tagData.getDataValue());
