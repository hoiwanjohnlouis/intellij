...
class Tag363DatEncodedUnderlyingIssuerTest {
    ...
    void FIX0363Test() {
        ...
        assertEquals( "363", fixData.toEnumIDString());
        assertEquals( "ENCODED_UNDERLYING_ISSUER", fixData.toEnumNameString());
        assertEquals( "EncodedUnderlyingIssuer", fixData.toEnumDescriptionString());
