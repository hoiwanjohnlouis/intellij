...
class Tag363DatEncodedUnderlyingIssuerTest {
    ...
    private void verifyAll( final Tag363DatEncodedUnderlyingIssuer tagData, final String oneElement ) {
    ...
    private void verifyFIXData( final Tag363DatEncodedUnderlyingIssuer tagData ) {
        assertEquals( "FIX363_DAT_ENCODED_UNDERLYING_ISSUER", tagData.toEnumLabelString());
        assertEquals( "363", tagData.toEnumIDString());
    ...
    private void verifyDataValue( final Tag363DatEncodedUnderlyingIssuer tagData, final String oneElement ) {
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_DAT_DATA_VALUE, tagData.getDataValue() );
    }

    private void verifyValuePairString( final Tag363DatEncodedUnderlyingIssuer tagData, final String oneElement ) {
        assertEquals( tagData.toEnumIDString() + "=" + oneElement, tagData.toValuePairString() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.toValuePairString());
    }

    private void verifyToString( final Tag363DatEncodedUnderlyingIssuer tagData, final String oneElement ) {
        assertEquals( oneElement, tagData.toString() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.toString());
    }

    private void verifyVerboseString( final Tag363DatEncodedUnderlyingIssuer tagData ) {
