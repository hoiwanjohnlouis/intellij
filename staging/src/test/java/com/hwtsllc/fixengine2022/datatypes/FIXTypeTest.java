...
public class FIXTypeTest {
    ...
    @Test
    void FIX0032Test() {
        FIXType fix32LastQty = FIXType.LAST_SHARES;
    }
    @Test
    void FIX0033Test() {
    ...
    @Test
    void FIX0045Test() {
        FIXType fix45RefSeqNum = FIXType.REF_SEQ_NUM;
    }
    @Test
    void FIX0046Test() {
    ...
    @Test
    void FIX0052Test() {
        FIXType fix52SendingTime = FIXType.SENDING_TIME;
    }
    @Test
    void FIX0053Test() {
    ...
    @Test
    void FIX0054Test() {
        FIXType fix54Side = FIXType.SIDE;
    }
    @Test
    void FIX0055Test() {
        FIXType fix55Symbol = FIXType.SYMBOL;
    }
    @Test
    void FIX0056Test() {
        FIXType fix56TargetCompID = FIXType.TARGET_COMP_ID;
    }
    @Test
    void FIX0057Test() {
        FIXType fix57TargetSubID = FIXType.TARGET_SUB_ID;
    }
    @Test
    void FIX0058Test() {
    ...
    @Test
    void FIX0066Test() {
        FIXType fix66ListID = FIXType.LIST_ID;
    }
    @Test
    void FIX0067Test() {
    ...
    @Test
    void FIX0068Test() {
        FIXType fix68TotNoOrders = FIXType.TOT_NO_ORDERS;
    }
    @Test
    void FIX0069Test() {
        FIXType fix69ListExecInst = FIXType.LIST_EXEC_INST;
    }
    @Test
    void FIX0070Test() {
    ...
    @Test
    void FIX0079Test() {
        FIXType fix79AllocAccount = FIXType.ALLOC_ACCOUNT;
    }
    @Test
    void FIX0080Test() {
    ...
    @Test
    void FIX0081Test() {
        FIXType fix81ProcessCode = FIXType.PROCESS_CODE;
    }
    @Test
    void FIX0082Test() {
        FIXType fix82NoRpts = FIXType.NO_RPTS;
    }
    @Test
    void FIX0083Test() {
        FIXType fix83RptSeq = FIXType.RPT_SEQ;
    }
    @Test
    void FIX0084Test() {
    ...
    @Test
    void FIX0085Test() {
        FIXType fix85NoDlvyInst = FIXType.NO_DLVY_INST;
    }
    @Test
    void FIX0086Test() {
    ...
    @Test
    void FIX0090Test() {
        FIXType fix90SecureDataLen = FIXType.SECURE_DATA_LEN;
    }
    @Test
    void FIX0091Test() {
    ...
    @Test
    void FIX0095Test() {
        FIXType fix95RawDataLength = FIXType.RAW_DATA_LENGTH;
    }
    @Test
    void FIX0096Test() {
    ...
    @Test
    void FIX0098Test() {
        FIXType fix98EncryptMethod = FIXType.ENCRYPT_METHOD;
    }
    @Test
    void FIX0099Test() {
        FIXType fix99StopPx = FIXType.STOP_PX;
    }
    @Test
    void FIX0100Test() {
