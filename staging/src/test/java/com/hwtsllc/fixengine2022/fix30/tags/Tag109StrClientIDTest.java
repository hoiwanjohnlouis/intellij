...
class Tag109StrClientIDTest {
    ...
    private void verifyFIXData( final Tag109StrClientID tagData ) {
        assertEquals( "FIX109_STR_CLIENT_ID", tagData.toEnumLabelString());
    ...
    private void verifyDataValue( final Tag109StrClientID tagData, final String oneElement ) {
    ...
    private void verifyValuePairString( final Tag109StrClientID tagData, final String oneElement ) {
    ...
    private void verifyToString( final Tag109StrClientID tagData, final String oneElement ) {
    ...
    private void verifyVerboseString( final Tag109StrClientID tagData ) {
