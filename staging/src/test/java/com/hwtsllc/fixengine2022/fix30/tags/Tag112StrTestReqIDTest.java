...
class Tag112StrTestReqIDTest {
    ...
    private void verifyFIXData( final Tag112StrTestReqID tagData ) {
        assertEquals( "FIX112_STR_TEST_REQ_ID", tagData.toEnumLabelString());
    ...
    private void verifyDataValue( final Tag112StrTestReqID tagData, final String oneElement ) {
    ...
    private void verifyValuePairString( final Tag112StrTestReqID tagData, final String oneElement ) {
    ...
    private void verifyToString( final Tag112StrTestReqID tagData, final String oneElement ) {
    ...
    private void verifyVerboseString( final Tag112StrTestReqID tagData ) {
