...
class Enum104IOIQualifierTest {
    ...
    void Enum0104Test() {
        ...
        assertNotEquals( FIX30.JUNK_ID, enumType.getID());
        assertNotEquals( FIX30.JUNK_NAME, enumType.getName());
        assertNotEquals( FIX30.JUNK_DESCRIPTION, enumType.getDescription());
