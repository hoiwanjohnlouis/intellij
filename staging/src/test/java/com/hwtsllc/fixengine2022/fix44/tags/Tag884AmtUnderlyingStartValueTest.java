...
class Tag884AmtUnderlyingStartValueTest {
    ...
    void FIX0884Test() {
        ...
        assertEquals( "884", fixData.toFIXIDString());
        assertEquals( "UNDERLYING_START_VALUE", fixData.toFIXNameString());
        assertEquals( "UnderlyingStartValue", fixData.toFIXDescriptionString());
    ...
    void Tag0884Test() {
        ...
        assertEquals( "884", tagData.toFIXIDString());
        assertEquals( "UNDERLYING_START_VALUE", tagData.toFIXNameString());
        assertEquals( "UnderlyingStartValue", tagData.toFIXDescriptionString());
