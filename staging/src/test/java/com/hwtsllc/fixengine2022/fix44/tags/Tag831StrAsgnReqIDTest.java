 ...
 */
class Tag831StrAsgnReqIDTest {
    Tag831StrAsgnReqID tagData;
    String [] TestArray = {
            Tag831StrAsgnReqID.TESTA_STR_ASGN_REQ_ID,
            Tag831StrAsgnReqID.TESTB_STR_ASGN_REQ_ID
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag831StrAsgnReqID( new MyStringType( oneElement ));
            assertEquals( "FIX831_STR_ASGN_REQ_ID", tagData.toEnumLabelString());
