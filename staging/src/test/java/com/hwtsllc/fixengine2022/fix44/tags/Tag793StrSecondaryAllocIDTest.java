...
class Tag793StrSecondaryAllocIDTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "793", fixData.toEnumIDString());
        assertEquals( "SECONDARY_ALLOC_ID", fixData.toEnumNameString());
        assertEquals( "SecondaryAllocID", fixData.toEnumDescriptionString());
