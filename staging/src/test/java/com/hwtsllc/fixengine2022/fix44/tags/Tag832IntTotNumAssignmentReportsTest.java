...
class Tag832IntTotNumAssignmentReportsTest {
    ...
    int [] TestArray = {
            Tag832IntTotNumAssignmentReports.TESTA_INT_TOT_NUM_ASSIGNMENT_REPORTS,
            Tag832IntTotNumAssignmentReports.TESTB_INT_TOT_NUM_ASSIGNMENT_REPORTS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag832IntTotNumAssignmentReports( new MyIntType( oneElement ));
            assertEquals( "FIX832_INT_TOT_NUM_ASSIGNMENT_REPORTS", tagData.toEnumLabelString());
