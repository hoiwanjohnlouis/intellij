...
class Tag679PrcLegBenchmarkPriceTest {
    ...
    double [] TestArray = {
            Tag679PrcLegBenchmarkPrice.TESTA_PRC_LEG_BENCHMARK_PRICE,
            Tag679PrcLegBenchmarkPrice.TESTB_PRC_LEG_BENCHMARK_PRICE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag679PrcLegBenchmarkPrice( new MyPriceType( oneElement ));
            assertEquals( "FIX679_PRC_LEG_BENCHMARK_PRICE", tagData.toEnumLabelString());
