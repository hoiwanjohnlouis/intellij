...
class Tag795StrAllocReportRefIDTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "795", fixData.toEnumIDString());
        assertEquals( "ALLOC_REPORT_REF_ID", fixData.toEnumNameString());
        assertEquals( "AllocReportRefID", fixData.toEnumDescriptionString());
