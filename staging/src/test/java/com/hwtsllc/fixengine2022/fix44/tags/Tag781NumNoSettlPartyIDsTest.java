...
class Tag781NumNoSettlPartyIDsTest {
    ...
    int [] TestArray = {
            Tag781NumNoSettlPartyIDs.TESTA_NUM_NO_SETTL_PARTY_IDS,
            Tag781NumNoSettlPartyIDs.TESTB_NUM_NO_SETTL_PARTY_IDS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag781NumNoSettlPartyIDs( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX781_NUM_NO_SETTL_PARTY_IDS", tagData.toEnumLabelString());
