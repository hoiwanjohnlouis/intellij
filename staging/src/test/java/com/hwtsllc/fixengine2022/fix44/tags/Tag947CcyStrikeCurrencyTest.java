...
class Tag947CcyStrikeCurrencyTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "947", fixData.toEnumIDString());
        assertEquals( "STRIKE_CURRENCY", fixData.toEnumNameString());
        assertEquals( "StrikeCurrency", fixData.toEnumDescriptionString());
