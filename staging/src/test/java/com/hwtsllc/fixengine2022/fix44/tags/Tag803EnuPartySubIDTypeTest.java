...
class Tag803EnuPartySubIDTypeTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "803", fixData.toEnumIDString());
        assertEquals( "PARTY_SUB_ID_TYPE", fixData.toEnumNameString());
        assertEquals( "PartySubIDType", fixData.toEnumDescriptionString());
