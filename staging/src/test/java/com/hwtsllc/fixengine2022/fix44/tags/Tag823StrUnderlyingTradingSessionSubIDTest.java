...
class Tag823StrUnderlyingTradingSessionSubIDTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "823", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_TRADING_SESSION_SUB_ID", fixData.toEnumNameString());
        assertEquals( "UnderlyingTradingSessionSubID", fixData.toEnumDescriptionString());
