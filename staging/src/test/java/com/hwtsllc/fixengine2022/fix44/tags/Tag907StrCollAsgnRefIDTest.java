...
class Tag907StrCollAsgnRefIDTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "907", fixData.toEnumIDString());
        assertEquals( "COLL_ASGN_REF_ID", fixData.toEnumNameString());
        assertEquals( "CollAsgnRefID", fixData.toEnumDescriptionString());
