...
class Tag727IntTotalNumPosReportsTest {
    ...
    int [] TestArray = {
            Tag727IntTotalNumPosReports.TESTA_INT_TOTAL_NUM_POS_REPORTS,
            Tag727IntTotalNumPosReports.TESTB_INT_TOTAL_NUM_POS_REPORTS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag727IntTotalNumPosReports( new MyIntType( oneElement ));
            assertEquals( "FIX727_INT_TOTAL_NUM_POS_REPORTS", tagData.toEnumLabelString());
