...
class Tag886AmtUnderlyingEndValueTest {
    ...
    double [] TestArray = {
            Tag886AmtUnderlyingEndValue.TESTA_AMT_UNDERLYING_END_VALUE,
            Tag886AmtUnderlyingEndValue.TESTB_AMT_UNDERLYING_END_VALUE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag886AmtUnderlyingEndValue( new MyAmtType( oneElement ));
            assertEquals( "FIX886_AMT_UNDERLYING_END_VALUE", tagData.toEnumLabelString());
