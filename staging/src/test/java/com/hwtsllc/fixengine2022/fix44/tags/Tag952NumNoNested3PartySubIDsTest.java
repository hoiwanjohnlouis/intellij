...
class Tag952NumNoNested3PartySubIDsTest {
    ...
    void FIX0952Test() {
        ...
        assertEquals( "952", fixData.toFIXIDString());
        assertEquals( "NO_NESTED_3_PARTY_SUB_IDS", fixData.toFIXNameString());
        assertEquals( "NoNested3PartySubIDs", fixData.toFIXDescriptionString());
