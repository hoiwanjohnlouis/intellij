...
class Tag920AmtEndAccruedInterestAmtTest {
    ...
    double [] TestArray = {
            Tag920AmtEndAccruedInterestAmt.TESTA_AMT_END_ACCRUED_INTEREST_AMT,
            Tag920AmtEndAccruedInterestAmt.TESTB_AMT_END_ACCRUED_INTEREST_AMT
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag920AmtEndAccruedInterestAmt( new MyAmtType( oneElement ));
            assertEquals( "FIX920_AMT_END_ACCRUED_INTEREST_AMT", tagData.toEnumLabelString());
