...
class Tag845PrcDiscretionPriceTest {
    ...
    double [] TestArray = {
            Tag845PrcDiscretionPrice.TESTA_PRC_DISCRETION_PRICE,
            Tag845PrcDiscretionPrice.TESTB_PRC_DISCRETION_PRICE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag845PrcDiscretionPrice( new MyPriceType( oneElement ));
            assertEquals( "FIX845_PRC_DISCRETION_PRICE", tagData.toEnumLabelString());
