...
class Tag671StrLegAllocAccountTest {
    ...
    String [] TestArray = {
            Tag671StrLegAllocAccount.TESTA_STR_LEG_ALLOC_ACCOUNT,
            Tag671StrLegAllocAccount.TESTB_STR_LEG_ALLOC_ACCOUNT
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag671StrLegAllocAccount( new MyStringType( oneElement ));
            assertEquals( "FIX671_STR_LEG_ALLOC_ACCOUNT", tagData.toEnumLabelString());
