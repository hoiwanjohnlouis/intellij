...
class Tag941CcyUnderlyingStrikeCurrencyTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "941", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_STRIKE_CURRENCY", fixData.toEnumNameString());
        assertEquals( "UnderlyingStrikeCurrency", fixData.toEnumDescriptionString());
    ...
    void Tag0941Test() {
        ...
        assertEquals( "941", tagData.toEnumIDString());
        assertEquals( "UNDERLYING_STRIKE_CURRENCY", tagData.toEnumNameString());
        assertEquals( "UnderlyingStrikeCurrency", tagData.toEnumDescriptionString());
