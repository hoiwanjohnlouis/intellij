...
class Tag683NumNoLegStipulationsTest {
    ...
    int [] TestArray = {
            Tag683NumNoLegStipulations.TESTA_NUM_NO_LEG_STIPULATIONS,
            Tag683NumNoLegStipulations.TESTB_NUM_NO_LEG_STIPULATIONS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag683NumNoLegStipulations( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX683_NUM_NO_LEG_STIPULATIONS", tagData.toEnumLabelString());
