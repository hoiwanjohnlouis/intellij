...
class Tag807EnuNested2PartySubIDTypeTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "807", fixData.toEnumIDString());
        assertEquals( "NESTED_2_PARTY_SUB_ID_TYPE", fixData.toEnumNameString());
        assertEquals( "Nested2PartySubIDType", fixData.toEnumDescriptionString());
    ...
    void Tag0807Test() {
        ...
        tagData = new Tag807EnuNested2PartySubIDType( oneElement );
        assertEquals( oneElement.toEnumIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());
        assertEquals( "807", tagData.toEnumIDString());
