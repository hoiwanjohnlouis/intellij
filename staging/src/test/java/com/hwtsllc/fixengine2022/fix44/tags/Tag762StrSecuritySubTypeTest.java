...
class Tag762StrSecuritySubTypeTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "762", fixData.toEnumIDString());
        assertEquals( "SECURITY_SUB_TYPE", fixData.toEnumNameString());
        assertEquals( "SecuritySubType", fixData.toEnumDescriptionString());
