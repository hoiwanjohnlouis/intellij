 ...
 */
class Tag951EnuNested3PartyRoleTest {
    @Test
    void FIXTest() {
        FIX44 fixData = FIX44.FIX951_ENU_NESTED_3_PARTY_ROLE;
        assertEquals( "951", fixData.toEnumIDString());
        assertEquals( "NESTED_3_PARTY_ROLE", fixData.toEnumNameString());
        assertEquals( "Nested3PartyRole", fixData.toEnumDescriptionString());
    ...
    void PrintFIXTagTest() {
        ...
        for ( MyEnumPartyRole oneEnum : MyEnumPartyRole.values()) {
            tagData = new Tag951EnuNested3PartyRole(oneEnum);
    ...
    void TagToVerboseStringTest() {
        ...
        for (MyEnumPartyRole oneEnum : MyEnumPartyRole.values()) {
            tagData = new Tag951EnuNested3PartyRole(oneEnum);
            assertEquals( "Tag951EnuNested3PartyRole\n" +
