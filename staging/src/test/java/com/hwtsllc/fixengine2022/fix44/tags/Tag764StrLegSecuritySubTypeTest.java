...
class Tag764StrLegSecuritySubTypeTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "764", fixData.toEnumIDString());
        assertEquals( "LEG_SECURITY_SUB_TYPE", fixData.toEnumNameString());
        assertEquals( "LegSecuritySubType", fixData.toEnumDescriptionString());
