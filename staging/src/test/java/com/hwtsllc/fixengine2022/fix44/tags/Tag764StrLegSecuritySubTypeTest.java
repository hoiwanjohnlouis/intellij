...
class Tag764StrLegSecuritySubTypeTest {
    ...
    String [] TestArray = {
            Tag764StrLegSecuritySubType.TESTA_STR_LEG_SECURITY_SUB_TYPE,
            Tag764StrLegSecuritySubType.TESTB_STR_LEG_SECURITY_SUB_TYPE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag764StrLegSecuritySubType( new MyStringType( oneElement ));
            assertEquals( "FIX764_STR_LEG_SECURITY_SUB_TYPE", tagData.toEnumLabelString());
            assertEquals( "764", tagData.toEnumIDString());
