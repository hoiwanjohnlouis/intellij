...
class Tag934StrLastNetworkResponseIDTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "934", fixData.toEnumIDString());
        assertEquals( "LAST_NETWORK_RESPONSE_ID", fixData.toEnumNameString());
        assertEquals( "LastNetworkResponseID", fixData.toEnumDescriptionString());
