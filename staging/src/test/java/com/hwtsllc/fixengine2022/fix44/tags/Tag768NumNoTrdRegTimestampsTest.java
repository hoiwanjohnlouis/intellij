...
class Tag768NumNoTrdRegTimestampsTest {
    ...
    int [] TestArray = {
            Tag768NumNoTrdRegTimestamps.TESTA_NUM_NO_TRD_REG_TIMESTAMPS,
            Tag768NumNoTrdRegTimestamps.TESTB_NUM_NO_TRD_REG_TIMESTAMPS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag768NumNoTrdRegTimestamps( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX768_NUM_NO_TRD_REG_TIMESTAMPS", tagData.toEnumLabelString());
