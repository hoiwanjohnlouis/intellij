...
class Tag901AmtCashOutstandingTest {
    ...
    double [] TestArray = {
            Tag901AmtCashOutstanding.TESTA_AMT_CASH_OUTSTANDING,
            Tag901AmtCashOutstanding.TESTB_AMT_CASH_OUTSTANDING
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag901AmtCashOutstanding( new MyAmtType( oneElement ));
            assertEquals( "FIX901_AMT_CASH_OUTSTANDING", tagData.toEnumLabelString());
