...
class Tag791StrSettlInstReqIDTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "791", fixData.toEnumIDString());
        assertEquals( "SETTL_INST_REQ_ID", fixData.toEnumNameString());
        assertEquals( "SettlInstReqID", fixData.toEnumDescriptionString());
