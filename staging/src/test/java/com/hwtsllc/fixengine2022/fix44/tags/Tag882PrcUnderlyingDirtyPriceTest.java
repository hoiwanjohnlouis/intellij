...
class Tag882PrcUnderlyingDirtyPriceTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "882", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_DIRTY_PRICE", fixData.toEnumNameString());
        assertEquals( "UnderlyingDirtyPrice", fixData.toEnumDescriptionString());
