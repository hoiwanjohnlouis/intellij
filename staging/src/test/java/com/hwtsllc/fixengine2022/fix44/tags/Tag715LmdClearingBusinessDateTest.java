...
class Tag715LmdClearingBusinessDateTest {
    ...
    String [] TestArray = {
            Tag715LmdClearingBusinessDate.TESTA_LMD_CLEARING_BUSINESS_DATE,
            Tag715LmdClearingBusinessDate.TESTB_LMD_CLEARING_BUSINESS_DATE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag715LmdClearingBusinessDate( new MyLocalMktDateType( oneElement ));
            assertEquals( "FIX715_LMD_CLEARING_BUSINESS_DATE", tagData.toEnumLabelString());
