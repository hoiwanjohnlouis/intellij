...
class Tag858AmtSharedCommissionTest {
    ...
    void FIX0858Test() {
        ...
        assertEquals( "858", fixData.toEnumIDString());
        assertEquals( "SHARED_COMMISSION", fixData.toEnumNameString());
        assertEquals( "SharedCommission", fixData.toEnumDescriptionString());
