...
class Tag701LmdYieldCalcDateTest {
    ...
    void FIX0701Test() {
        ...
        assertEquals( "701", fixData.toEnumIDString());
        assertEquals( "YIELD_CALC_DATE", fixData.toEnumNameString());
        assertEquals( "YieldCalcDate", fixData.toEnumDescriptionString());
