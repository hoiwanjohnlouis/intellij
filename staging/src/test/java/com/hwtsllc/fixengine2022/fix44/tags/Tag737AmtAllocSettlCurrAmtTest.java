...
class Tag737AmtAllocSettlCurrAmtTest {
    ...
    double [] TestArray = {
            Tag737AmtAllocSettlCurrAmt.TESTA_AMT_ALLOC_SETTL_CURR_AMT,
            Tag737AmtAllocSettlCurrAmt.TESTB_AMT_ALLOC_SETTL_CURR_AMT
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag737AmtAllocSettlCurrAmt( new MyAmtType( oneElement ));
            assertEquals( "FIX737_AMT_ALLOC_SETTL_CURR_AMT", tagData.toEnumLabelString());
