...
class Tag874LmdInterestAccrualDateTest {
    ...
    void FIX0874Test() {
        ...
        assertEquals( "874", fixData.toEnumIDString());
        assertEquals( "INTEREST_ACCRUAL_DATE", fixData.toEnumNameString());
        assertEquals( "InterestAccrualDate", fixData.toEnumDescriptionString());
