...
class Tag802NumNoPartySubIDsTest {
    ...
    int [] TestArray = {
            Tag802NumNoPartySubIDs.TESTA_NUM_NO_PARTY_SUB_IDS,
            Tag802NumNoPartySubIDs.TESTB_NUM_NO_PARTY_SUB_IDS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag802NumNoPartySubIDs( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX802_NUM_NO_PARTY_SUB_IDS", tagData.toEnumLabelString());
