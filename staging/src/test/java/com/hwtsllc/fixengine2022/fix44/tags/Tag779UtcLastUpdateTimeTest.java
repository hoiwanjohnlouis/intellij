...
class Tag779UtcLastUpdateTimeTest {
    ...
    String [] TestArray = {
            Tag779UtcLastUpdateTime.TESTA_UTC_LAST_UPDATE_TIME,
            Tag779UtcLastUpdateTime.TESTB_UTC_LAST_UPDATE_TIME
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag779UtcLastUpdateTime( new MyUTCTimestampType( oneElement ));
            assertEquals( "FIX779_UTC_LAST_UPDATE_TIME", tagData.toEnumLabelString());
