...
class Tag779UtcLastUpdateTimeTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "779", fixData.toEnumIDString());
        assertEquals( "LAST_UPDATE_TIME", fixData.toEnumNameString());
        assertEquals( "LastUpdateTime", fixData.toEnumDescriptionString());
    ...
    void Tag0779Test() {
        ...
        oneElement = Tag779UtcLastUpdateTime.TESTA_UTC_LAST_UPDATE_TIME;
        tagData = new Tag779UtcLastUpdateTime( new MyUTCTimestampType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_UTC_DATA_VALUE, tagData.getDataValue());
        assertEquals( "779", tagData.toEnumIDString());
