...
class Tag814EnuApplQueueResolutionTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "814", fixData.toEnumIDString());
        assertEquals( "APPL_QUEUE_RESOLUTION", fixData.toEnumNameString());
        assertEquals( "ApplQueueResolution", fixData.toEnumDescriptionString());
    ...
    void Tag0814Test() {
        ...
        tagData = new Tag814EnuApplQueueResolution( oneElement );
