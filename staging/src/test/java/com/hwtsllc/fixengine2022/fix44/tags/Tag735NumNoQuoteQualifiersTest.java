...
class Tag735NumNoQuoteQualifiersTest {
    ...
    int [] TestArray = {
            Tag735NumNoQuoteQualifiers.TESTA_NUM_NO_QUOTE_QUALIFIERS,
            Tag735NumNoQuoteQualifiers.TESTB_NUM_NO_QUOTE_QUALIFIERS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag735NumNoQuoteQualifiers( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX735_NUM_NO_QUOTE_QUALIFIERS", tagData.toEnumLabelString());
