...
class Tag759EnuNested2PartyRoleTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "759", fixData.toEnumIDString());
        assertEquals( "NESTED_2_PARTY_ROLE", fixData.toEnumNameString());
        assertEquals( "Nested2PartyRole", fixData.toEnumDescriptionString());
    ...
    void Tag0759Test() {
        ...
        tagData = new Tag759EnuNested2PartyRole( oneElement );
