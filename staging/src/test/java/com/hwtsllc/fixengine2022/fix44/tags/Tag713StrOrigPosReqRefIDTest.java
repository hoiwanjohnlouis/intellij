 ...
 */
class Tag713StrOrigPosReqRefIDTest {
    @Test
    void FIXTest() {
        FIX44 fixData = FIX44.FIX713_STR_ORIG_POS_REQ_REF_ID;
        assertEquals( "713", fixData.toEnumIDString());
        assertEquals( "ORIG_POS_REQ_REF_ID", fixData.toEnumNameString());
        assertEquals( "OrigPosReqRefID", fixData.toEnumDescriptionString());
    ...
    void Tag0713Test() {
        ...
        oneElement = Tag713StrOrigPosReqRefID.TESTA_STR_ORIG_POS_REQ_REF_ID;
