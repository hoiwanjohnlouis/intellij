...
class Tag772StrConfirmRefIDTest {
    ...
    String [] TestArray = {
            Tag772StrConfirmRefID.TESTA_STR_CONFIRM_REF_ID,
            Tag772StrConfirmRefID.TESTB_STR_CONFIRM_REF_ID
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag772StrConfirmRefID( new MyStringType( oneElement ));
            assertEquals( "FIX772_STR_CONFIRM_REF_ID", tagData.toEnumLabelString());
