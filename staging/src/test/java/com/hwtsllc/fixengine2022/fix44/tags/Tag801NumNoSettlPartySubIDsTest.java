...
class Tag801NumNoSettlPartySubIDsTest {
    ...
    int [] TestArray = {
            Tag801NumNoSettlPartySubIDs.TESTA_NUM_NO_SETTL_PARTY_SUB_IDS,
            Tag801NumNoSettlPartySubIDs.TESTB_NUM_NO_SETTL_PARTY_SUB_IDS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag801NumNoSettlPartySubIDs( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX801_NUM_NO_SETTL_PARTY_SUB_IDS", tagData.toEnumLabelString());
