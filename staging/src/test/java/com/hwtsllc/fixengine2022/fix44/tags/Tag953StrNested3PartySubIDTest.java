...
class Tag953StrNested3PartySubIDTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "953", fixData.toEnumIDString());
        assertEquals( "NESTED_3_PARTY_SUB_ID", fixData.toEnumNameString());
        assertEquals( "Nested3PartySubID", fixData.toEnumDescriptionString());
