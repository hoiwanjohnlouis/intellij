...
class Tag673QtyLegAllocQtyTest {
    ...
    int [] TestArray = {
            Tag673QtyLegAllocQty.TESTA_QTY_LEG_ALLOC_QTY,
            Tag673QtyLegAllocQty.TESTB_QTY_LEG_ALLOC_QTY
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag673QtyLegAllocQty( new MyQtyType( oneElement ));
            assertEquals( "FIX673_QTY_LEG_ALLOC_QTY", tagData.toEnumLabelString());
