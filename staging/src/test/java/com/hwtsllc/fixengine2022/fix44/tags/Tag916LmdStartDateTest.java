...
class Tag916LmdStartDateTest {
    ...
    void FIX0916Test() {
        ...
        assertEquals( "916", fixData.toFIXIDString());
        assertEquals( "START_DATE", fixData.toFIXNameString());
        assertEquals( "StartDate", fixData.toFIXDescriptionString());
    ...
    void Tag0916Test() {
        ...
        assertEquals( "916", tagData.toFIXIDString());
        assertEquals( "START_DATE", tagData.toFIXNameString());
        assertEquals( "StartDate", tagData.toFIXDescriptionString());
