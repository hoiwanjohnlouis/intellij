...
class Tag821StrOrderInputDeviceTest {
    ...
    String [] TestArray = {
            Tag821StrOrderInputDevice.TESTA_STR_ORDER_INPUT_DEVICE,
            Tag821StrOrderInputDevice.TESTB_STR_ORDER_INPUT_DEVICE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag821StrOrderInputDevice( new MyStringType( oneElement ));
            assertEquals( "FIX821_STR_ORDER_INPUT_DEVICE", tagData.toEnumLabelString());
