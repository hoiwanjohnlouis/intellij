...
class Tag667MmyContractSettlMonthTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "667", fixData.toFIXIDString());
        assertEquals( "CONTRACT_SETTL_MONTH", fixData.toFIXNameString());
        assertEquals( "ContractSettlMonth", fixData.toFIXDescriptionString());
