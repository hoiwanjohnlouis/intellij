...
class Tag848StrTargetStrategyParametersTest {
    ...
    String [] TestArray = {
            Tag848StrTargetStrategyParameters.TESTA_STR_TARGET_STRATEGY_PARAMETERS,
            Tag848StrTargetStrategyParameters.TESTB_STR_TARGET_STRATEGY_PARAMETERS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag848StrTargetStrategyParameters( new MyStringType( oneElement ));
            assertEquals( "FIX848_STR_TARGET_STRATEGY_PARAMETERS", tagData.toEnumLabelString());
            assertEquals( "848", tagData.toEnumIDString());
