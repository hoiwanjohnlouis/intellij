...
class Tag848StrTargetStrategyParametersTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "848", fixData.toEnumIDString());
        assertEquals( "TARGET_STRATEGY_PARAMETERS", fixData.toEnumNameString());
        assertEquals( "TargetStrategyParameters", fixData.toEnumDescriptionString());
