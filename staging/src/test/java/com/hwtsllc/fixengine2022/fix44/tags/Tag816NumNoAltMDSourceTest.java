...
class Tag816NumNoAltMDSourceTest {
    ...
    int [] TestArray = {
            Tag816NumNoAltMDSource.TESTA_NUM_NO_ALT_MD_SOURCE,
            Tag816NumNoAltMDSource.TESTB_NUM_NO_ALT_MD_SOURCE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag816NumNoAltMDSource( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX816_NUM_NO_ALT_MD_SOURCE", tagData.toEnumLabelString());
