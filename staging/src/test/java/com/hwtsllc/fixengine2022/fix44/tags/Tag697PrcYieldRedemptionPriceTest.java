...
class Tag697PrcYieldRedemptionPriceTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "697", fixData.toEnumIDString());
        assertEquals( "YIELD_REDEMPTION_PRICE", fixData.toEnumNameString());
        assertEquals( "YieldRedemptionPrice", fixData.toEnumDescriptionString());
