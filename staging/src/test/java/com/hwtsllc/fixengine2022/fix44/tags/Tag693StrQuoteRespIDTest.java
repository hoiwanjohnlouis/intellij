...
class Tag693StrQuoteRespIDTest {
    ...
    String [] TestArray = {
            Tag693StrQuoteRespID.TESTA_STR_QUOTE_RESP_ID,
            Tag693StrQuoteRespID.TESTB_STR_QUOTE_RESP_ID
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag693StrQuoteRespID( new MyStringType( oneElement ));
            assertEquals( "FIX693_STR_QUOTE_RESP_ID", tagData.toEnumLabelString());
