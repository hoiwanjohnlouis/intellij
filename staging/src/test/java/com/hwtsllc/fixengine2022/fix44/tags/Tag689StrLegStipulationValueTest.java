...
class Tag689StrLegStipulationValueTest {
    ...
    String [] TestArray = {
            Tag689StrLegStipulationValue.TESTA_STR_LEG_STIPULATION_VALUE,
            Tag689StrLegStipulationValue.TESTB_STR_LEG_STIPULATION_VALUE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag689StrLegStipulationValue( new MyStringType( oneElement ));
            assertEquals( "FIX689_STR_LEG_STIPULATION_VALUE", tagData.toEnumLabelString());
