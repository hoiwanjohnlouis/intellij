...
class Tag784EnuSettlPartyRoleTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "784", fixData.toEnumIDString());
        assertEquals( "SETTL_PARTY_ROLE", fixData.toEnumNameString());
        assertEquals( "SettlPartyRole", fixData.toEnumDescriptionString());
