...
class Tag784EnuSettlPartyRoleTest {
    ...
    void FIX0784Test() {
        ...
        assertEquals( "784", fixData.getID());
        assertEquals( "SETTL_PARTY_ROLE", fixData.getName());
        assertEquals( "SettlPartyRole", fixData.getDescription());
    ...
    @Test
    void Tag0784Test() {
        Log784EnuSettlPartyRole tagData;
