...
class Tag930StrRefCompIDTest {
    Tag930StrRefCompID tagData;
    String [] TestArray = {
            Tag930StrRefCompID.TESTA_STR_REF_COMP_ID,
            Tag930StrRefCompID.TESTB_STR_REF_COMP_ID
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag930StrRefCompID( new MyStringType( oneElement ));
            assertEquals( "FIX930_STR_REF_COMP_ID", tagData.toEnumLabelString());
