...
class Tag813IntApplQueueDepthTest {
    ...
    int [] TestArray = {
            Tag813IntApplQueueDepth.TESTA_INT_APPL_QUEUE_DEPTH,
            Tag813IntApplQueueDepth.TESTB_INT_APPL_QUEUE_DEPTH
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag813IntApplQueueDepth( new MyIntType( oneElement ));
            assertEquals( "FIX813_INT_APPL_QUEUE_DEPTH", tagData.toEnumLabelString());
