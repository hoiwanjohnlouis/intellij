...
class Tag830StrTransferReasonTest {
    ...
    String [] TestArray = {
            Tag830StrTransferReason.TESTA_STR_TRANSFER_REASON,
            Tag830StrTransferReason.TESTB_STR_TRANSFER_REASON
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag830StrTransferReason( new MyStringType( oneElement ));
            assertEquals( "FIX830_STR_TRANSFER_REASON", tagData.toEnumLabelString());
