...
class Tag785StrSettlPartySubIDTest {
    ...
    void FIXTest() {
        ...
        assertEquals( "785", fixData.toEnumIDString());
        assertEquals( "SETTL_PARTY_SUB_ID", fixData.toEnumNameString());
        assertEquals( "SettlPartySubID", fixData.toEnumDescriptionString());
