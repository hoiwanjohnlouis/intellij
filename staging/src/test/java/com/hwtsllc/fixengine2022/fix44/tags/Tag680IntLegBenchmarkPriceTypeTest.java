...
class Tag680IntLegBenchmarkPriceTypeTest {
    ...
    int [] TestArray = {
            Tag680IntLegBenchmarkPriceType.TESTA_INT_LEG_BENCHMARK_PRICE_TYPE,
            Tag680IntLegBenchmarkPriceType.TESTB_INT_LEG_BENCHMARK_PRICE_TYPE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag680IntLegBenchmarkPriceType( new MyIntType( oneElement ));
            assertEquals( "FIX680_INT_LEG_BENCHMARK_PRICE_TYPE", tagData.toEnumLabelString());
