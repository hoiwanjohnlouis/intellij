...
class Tag448StrPartyIDTest {
    ...
    void FIX0448Test() {
        ...
        assertEquals( "448", fixData.toEnumIDString());
        assertEquals( "PARTY_ID", fixData.toEnumNameString());
        assertEquals( "PartyID", fixData.toEnumDescriptionString());
    ...
    void Tag0448Test() {
        ...
        oneElement = Tag448StrPartyID.TESTA_STR_PARTY_ID;
        tagData = new Tag448StrPartyID( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );

        oneElement = Tag448StrPartyID.TESTB_STR_PARTY_ID;
        tagData = new Tag448StrPartyID( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );
    }
