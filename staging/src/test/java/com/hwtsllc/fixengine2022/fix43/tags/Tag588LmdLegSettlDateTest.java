...
import com.hwtsllc.fixengine2022.fix42.tags.Tag588LmdLegSettlDate;
...
class Tag588LmdLegSettlDateTest {
    ...
    void PrintFIXTagTest() {
        ...
        oneElement = Tag588LmdLegSettlDate.TESTA_LMD_COUPON_PAYMENT_DATE;
        tagData = new Tag588LmdLegSettlDate( new MyLocalMktDateType( oneElement ) );
        System.out.println( tagData.toVerboseString() );

        oneElement = Tag588LmdLegSettlDate.TESTB_LMD_COUPON_PAYMENT_DATE;
        tagData = new Tag588LmdLegSettlDate( new MyLocalMktDateType( oneElement ) );
        System.out.println( tagData.toVerboseString() );
    }
    @Test
