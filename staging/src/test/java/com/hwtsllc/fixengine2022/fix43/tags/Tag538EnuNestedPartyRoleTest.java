...
class Tag538EnuNestedPartyRoleTest {
    ...
    void FIX0538Test() {
        ...
        assertEquals( "538", fixData.toEnumIDString());
        assertEquals( "NESTED_PARTY_ROLE", fixData.toEnumNameString());
        assertEquals( "NestedPartyRole", fixData.toEnumDescriptionString());
