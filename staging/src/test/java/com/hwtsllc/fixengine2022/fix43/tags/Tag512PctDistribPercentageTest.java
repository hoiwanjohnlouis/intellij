...
class Tag512PctDistribPercentageTest {
    ...
    double [] TestArray = {
            Tag512PctDistribPercentage.TESTA_PCT_DISTRIB_PERCENTAGE,
            Tag512PctDistribPercentage.TESTB_PCT_DISTRIB_PERCENTAGE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag512PctDistribPercentage( new MyPercentageType( oneElement ));
            assertEquals( "FIX512_PCT_DISTRIB_PERCENTAGE", tagData.toEnumLabelString());
            assertEquals( "512", tagData.toEnumIDString());
