...
class Tag525EnuNestedPartyIDSourceTest {
    ...
    void FIX0525Test() {
        ...
        assertEquals( "525", fixData.toFIXIDString());
        assertEquals( "NESTED_PARTY_ID_SOURCE", fixData.toFIXNameString());
        assertEquals( "NestedPartyIDSource", fixData.toFIXDescriptionString());
