...
import com.hwtsllc.fixengine2022.fix42.tags.Tag510NumNoDistribInsts;
...
class Tag510NumNoDistribInstsTest {
    ...
    void PrintFIXTagTest() {
        ...
        oneElement = Tag510NumNoDistribInsts.TESTA_NUM_NO_ROUTING_IDS;
        tagData = new Tag510NumNoDistribInsts( new MyNumInGroupType( oneElement ) );
        System.out.println( tagData.toVerboseString() );

        oneElement = Tag510NumNoDistribInsts.TESTB_NUM_NO_ROUTING_IDS;
        tagData = new Tag510NumNoDistribInsts( new MyNumInGroupType( oneElement ) );
        System.out.println( tagData.toVerboseString() );
    }
    @Test
