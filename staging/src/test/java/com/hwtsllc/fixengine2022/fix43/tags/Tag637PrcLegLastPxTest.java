...
import com.hwtsllc.fixengine2022.fix42.tags.Tag637PrcLegLastPx;
...
class Tag637PrcLegLastPxTest {
    ...
    void PrintFIXTagTest() {
        ...
        oneElement = Tag637PrcLegLastPx.TESTA_PRC_BASIS_FEATURE_PRICE;
        tagData = new Tag637PrcLegLastPx( new MyPriceType( oneElement ) );
        System.out.println( tagData.toVerboseString() );

        oneElement = Tag637PrcLegLastPx.TESTB_PRC_BASIS_FEATURE_PRICE;
        tagData = new Tag637PrcLegLastPx( new MyPriceType( oneElement ) );
        System.out.println( tagData.toVerboseString() );
    }
    @Test
