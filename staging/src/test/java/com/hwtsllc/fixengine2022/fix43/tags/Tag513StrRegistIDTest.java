...
class Tag513StrRegistIDTest {
    ...
    void FIX0513Test() {
        ...
        assertEquals( "513", fixData.toEnumIDString());
        assertEquals( "REGIST_ID", fixData.toEnumNameString());
        assertEquals( "RegistID", fixData.toEnumDescriptionString());
    ...
    void Tag0513Test() {
        ...
        oneElement = Tag513StrRegistID.TESTA_STR_REGIST_ID;
        tagData = new Tag513StrRegistID( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );

        oneElement = Tag513StrRegistID.TESTB_STR_REGIST_ID;
        tagData = new Tag513StrRegistID( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );
    }
