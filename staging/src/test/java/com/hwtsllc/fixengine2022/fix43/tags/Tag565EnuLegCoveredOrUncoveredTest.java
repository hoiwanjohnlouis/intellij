...
class Tag565EnuLegCoveredOrUncoveredTest {
    ...
    void FIX0565Test() {
        ...
        assertEquals( "565", fixData.toEnumIDString());
        assertEquals( "LEG_COVERED_OR_UNCOVERED", fixData.toEnumNameString());
        assertEquals( "LegCoveredOrUncovered", fixData.toEnumDescriptionString());
