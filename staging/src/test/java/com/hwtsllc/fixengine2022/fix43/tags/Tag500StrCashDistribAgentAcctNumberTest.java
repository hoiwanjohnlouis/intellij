...
class Tag500StrCashDistribAgentAcctNumberTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag500StrCashDistribAgentAcctNumber( new MyStringType( oneElement ));
            assertEquals( "FIX500_STR_CASH_DISTRIB_AGENT_ACCT_NUMBER", tagData.toFIXLabelString());
            assertEquals( "500", tagData.toFIXIDString());
            assertEquals( "CASH_DISTRIB_AGENT_ACCT_NUMBER", tagData.toFIXNameString());
            assertEquals( "CashDistribAgentAcctNumber", tagData.toFIXDescriptionString());
