...
class Tag593StrUnderlyingStateOrProvinceOfIssueTest {
    ...
    void FIX0593Test() {
        ...
        assertEquals( "593", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_STATE_OR_PROVINCE_OF_ISSUE", fixData.toEnumNameString());
        assertEquals( "UnderlyingStateOrProvinceOfIssue", fixData.toEnumDescriptionString());
    ...
    void Tag0593Test() {
        ...
        oneElement = Tag593StrUnderlyingStateOrProvinceOfIssue.TESTA_STR_UNDERLYING_STATE_OR_PROVINCE_OF_ISSUE;
        tagData = new Tag593StrUnderlyingStateOrProvinceOfIssue( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );

        oneElement = Tag593StrUnderlyingStateOrProvinceOfIssue.TESTB_STR_UNDERLYING_STATE_OR_PROVINCE_OF_ISSUE;
        tagData = new Tag593StrUnderlyingStateOrProvinceOfIssue( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );
    }
