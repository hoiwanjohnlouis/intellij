...
class Enum531MassCancelResponseTest {
    ...
    void Enum0531Test() {
        ...
        assertEquals("CANCEL_REQUEST_REJECTED", enumType.toFIXNameString());
        assertEquals("0 - Cancel Request Rejected - See MassCancelRejectReason (532)", enumType.toFIXDescriptionString());
