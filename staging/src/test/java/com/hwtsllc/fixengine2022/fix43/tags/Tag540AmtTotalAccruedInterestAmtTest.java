...
class Tag540AmtTotalAccruedInterestAmtTest {
    ...
    void FIX0540Test() {
        ...
        assertEquals( "540", fixData.toEnumIDString());
        assertEquals( "TOTAL_ACCRUED_INTEREST_AMT", fixData.toEnumNameString());
        assertEquals( "TotalAccruedInterestAmt (Deprecated)", fixData.toEnumDescriptionString());
