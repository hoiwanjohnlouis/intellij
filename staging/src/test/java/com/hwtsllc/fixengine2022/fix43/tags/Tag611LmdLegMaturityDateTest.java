...
class Tag611LmdLegMaturityDateTest {
    ...
    void FIX0611Test() {
        ...
        assertEquals( "611", fixData.toEnumIDString());
        assertEquals( "LEG_MATURITY_DATE", fixData.toEnumNameString());
        assertEquals( "LegMaturityDate", fixData.toEnumDescriptionString());
    ...
    void Tag0611Test() {
        ...
        oneElement = Tag611LmdLegMaturityDate.TESTA_LMD_LEG_MATURITY_DATE;
        tagData = new Tag611LmdLegMaturityDate( new MyLocalMktDateType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_LMD_DATA_VALUE, tagData.getDataValue() );

        oneElement = Tag611LmdLegMaturityDate.TESTB_LMD_LEG_MATURITY_DATE;
        tagData = new Tag611LmdLegMaturityDate( new MyLocalMktDateType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_LMD_DATA_VALUE, tagData.getDataValue() );
    }
