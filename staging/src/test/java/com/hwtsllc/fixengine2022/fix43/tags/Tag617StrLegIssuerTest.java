...
class Tag617StrLegIssuerTest {
    ...
    void FIX0617Test() {
        ...
        assertEquals( "617", fixData.toEnumIDString());
        assertEquals( "LEG_ISSUER", fixData.toEnumNameString());
        assertEquals( "LegIssuer", fixData.toEnumDescriptionString());
    ...
    void Tag0617Test() {
        ...
        oneElement = Tag617StrLegIssuer.TESTA_STR_LEG_ISSUER;
        tagData = new Tag617StrLegIssuer( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );

        oneElement = Tag617StrLegIssuer.TESTB_STR_LEG_ISSUER;
        tagData = new Tag617StrLegIssuer( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );
    }
