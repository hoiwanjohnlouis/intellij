...
class Tag503LmdCardStartDateTest {
    ...
    void FIX0503Test() {
        ...
        assertEquals( "503", fixData.toEnumIDString());
        assertEquals( "CARD_START_DATE", fixData.toEnumNameString());
        assertEquals( "CardStartDate", fixData.toEnumDescriptionString());
