...
class Tag598StrLegLocaleOfIssueTest {
    ...
    void FIX0598Test() {
        ...
        assertEquals( "598", fixData.toEnumIDString());
        assertEquals( "LEG_LOCALE_OF_ISSUE", fixData.toEnumNameString());
        assertEquals( "LegLocaleOfIssue", fixData.toEnumDescriptionString());
