...
class Tag558NumNoSecurityTypesTest {
    ...
    void FIX0558Test() {
        ...
        assertEquals( "558", fixData.toEnumIDString());
        assertEquals( "NO_SECURITY_TYPES", fixData.toEnumNameString());
        assertEquals( "NoSecurityTypes", fixData.toEnumDescriptionString());
