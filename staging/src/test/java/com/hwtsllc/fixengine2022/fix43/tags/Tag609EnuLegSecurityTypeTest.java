...
class Tag609EnuLegSecurityTypeTest {
    ...
    void FIX0609Test() {
        ...
        assertEquals( "609", fixData.toEnumIDString());
        assertEquals( "LEG_SECURITY_TYPE", fixData.toEnumNameString());
        assertEquals( "LegSecurityType", fixData.toEnumDescriptionString());
