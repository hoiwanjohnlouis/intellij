...
class Tag613StrLegOptAttributeTest {
    ...
    void FIX0613Test() {
        ...
        assertEquals( "613", fixData.toEnumIDString());
        assertEquals( "LEG_OPT_ATTRIBUTE", fixData.toEnumNameString());
        assertEquals( "LegOptAttribute", fixData.toEnumDescriptionString());
