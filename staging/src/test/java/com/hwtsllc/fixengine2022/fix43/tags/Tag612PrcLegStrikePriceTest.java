...
import com.hwtsllc.fixengine2022.fix42.tags.Tag612PrcLegStrikePrice;
...
class Tag612PrcLegStrikePriceTest {
    ...
    void PrintFIXTagTest() {
        ...
        oneElement = Tag612PrcLegStrikePrice.TESTA_PRC_BASIS_FEATURE_PRICE;
        tagData = new Tag612PrcLegStrikePrice( new MyPriceType( oneElement ) );
        System.out.println( tagData.toVerboseString() );

        oneElement = Tag612PrcLegStrikePrice.TESTB_PRC_BASIS_FEATURE_PRICE;
        tagData = new Tag612PrcLegStrikePrice( new MyPriceType( oneElement ) );
        System.out.println( tagData.toVerboseString() );
    }
    @Test
