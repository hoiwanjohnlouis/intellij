...
class Tag539NumNoNestedPartyIDsTest {
    ...
    void FIX0539Test() {
        ...
        assertEquals( "539", fixData.toFIXIDString());
        assertEquals( "NO_NESTED_PARTY_IDS", fixData.toFIXNameString());
        assertEquals( "NoNestedPartyIDs", fixData.toFIXDescriptionString());
