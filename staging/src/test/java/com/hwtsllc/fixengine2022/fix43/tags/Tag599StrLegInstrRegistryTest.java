...
class Tag599StrLegInstrRegistryTest {
    ...
    void FIX0599Test() {
        ...
        assertEquals( "599", fixData.toEnumIDString());
        assertEquals( "LEG_INSTR_REGISTRY", fixData.toEnumNameString());
        assertEquals( "LegInstrRegistry", fixData.toEnumDescriptionString());
    ...
    void Tag0599Test() {
        ...
        oneElement = Tag599StrLegInstrRegistry.TESTA_STR_LEG_INSTR_REGISTRY;
        tagData = new Tag599StrLegInstrRegistry( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );

        oneElement = Tag599StrLegInstrRegistry.TESTB_STR_LEG_INSTR_REGISTRY;
        tagData = new Tag599StrLegInstrRegistry( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );
    }
