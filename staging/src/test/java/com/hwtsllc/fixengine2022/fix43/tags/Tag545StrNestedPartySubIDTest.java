...
class Tag545StrNestedPartySubIDTest {
    ...
    void FIX0545Test() {
        ...
        assertEquals( "545", fixData.toEnumIDString());
        assertEquals( "NESTED_PARTY_SUB_ID", fixData.toEnumNameString());
        assertEquals( "NestedPartySubID", fixData.toEnumDescriptionString());
