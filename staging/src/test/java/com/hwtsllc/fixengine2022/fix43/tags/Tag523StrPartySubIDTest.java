...
class Tag523StrPartySubIDTest {
    ...
    String [] TestArray = {
            Tag523StrPartySubID.TESTA_STR_PARTY_SUB_ID,
            Tag523StrPartySubID.TESTB_STR_PARTY_SUB_ID
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag523StrPartySubID( new MyStringType( oneElement ));
            assertEquals( "FIX523_STR_PARTY_SUB_ID", tagData.toEnumLabelString());
            assertEquals( "523", tagData.toEnumIDString());
            assertEquals( "PARTY_SUB_ID", tagData.toEnumNameString());
            assertEquals( "PartySubID", tagData.toEnumDescriptionString());
