...
class Enum459UnderlyingSecurityAltIDSourceTest {
    /**
     *  459 (same as 22, 305, 456, 459, 603, 606, 761, 1096, 1105)
    ...
    @Test
    void Enum0459Test() {
        Enum459UnderlyingSecurityAltIDSource enumType;

        /*
         * 1-9
         */
        enumType = Enum459UnderlyingSecurityAltIDSource.CUSIP;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.SEDOL;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.QUIK;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.ISIN;
        assertEquals("4", enumType.getID());
        assertEquals("ISIN", enumType.getName());
        assertEquals("4 - ISIN - The International Securities Identification Number",
                enumType.getDescription());
        assertNotEquals( FIX43.JUNK_ENUM_NAME, enumType.getEnumName());
        assertNotEquals( FIX43.JUNK_ID, enumType.getID());
        assertNotEquals( FIX43.JUNK_NAME, enumType.getName());
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.RIC;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.ISO_CURRENCY_CODE;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.ISO_COUNTRY_CODE;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.EXCHANGE_SYMBOL;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.CTA;
         ...
         * A-L
         */
        enumType = Enum459UnderlyingSecurityAltIDSource.BLOOMBERG;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.WERTPAPIER;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.DUTCH;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.VALOREN;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.SICOVAM;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.BELGIAN;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.COMMON;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.CLEARING_HOUSE_OR_ORGANIZATION;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.ISDA_PRODUCT_SPECIFICATION;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.OPTION_PRICE_REPORTING_AUTHORITY;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.ISDA_PRODUCT_URL;
        ...
        enumType = Enum459UnderlyingSecurityAltIDSource.LETTER_OF_CREDIT;
