...
class Tag511StrRegistEmailTest {
    ...
    void FIX0511Test() {
        ...
        assertEquals( "511", fixData.toEnumIDString());
        assertEquals( "REGIST_EMAIL", fixData.toEnumNameString());
        assertEquals( "RegistEmail", fixData.toEnumDescriptionString());
    ...
    void Tag0511Test() {
        ...
        oneElement = Tag511StrRegistEmail.TESTA_STR_REGIST_EMAIL;
        tagData = new Tag511StrRegistEmail( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );

        oneElement = Tag511StrRegistEmail.TESTB_STR_REGIST_EMAIL;
        tagData = new Tag511StrRegistEmail( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );
    }
