...
class Tag577EnuClearingInstructionTest {
    ...
    void Tag0577Test() {
        ...
        assertEquals( Enum577ClearingInstruction.PROCESS_NORMALLY.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.EXCLUDE_ALL_NETTING );
        assertEquals( Enum577ClearingInstruction.EXCLUDE_ALL_NETTING.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.BILATERAL_NETTING_ONLY );
        assertEquals( Enum577ClearingInstruction.BILATERAL_NETTING_ONLY.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.EX_CLEARING );
        assertEquals( Enum577ClearingInstruction.EX_CLEARING.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.SPECIAL_TRADE );
        assertEquals( Enum577ClearingInstruction.SPECIAL_TRADE.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());


        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.MULTILATERAL_NETTING );
        assertEquals( Enum577ClearingInstruction.MULTILATERAL_NETTING.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.CLEAR_AGAINST_CENTRAL_COUNTERPARTY );
        assertEquals( Enum577ClearingInstruction.CLEAR_AGAINST_CENTRAL_COUNTERPARTY.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.EXCLUDE_FROM_CENTRAL_COUNTERPARTY );
        assertEquals( Enum577ClearingInstruction.EXCLUDE_FROM_CENTRAL_COUNTERPARTY.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.MANUAL );
        assertEquals( Enum577ClearingInstruction.MANUAL.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.AUTOMATIC_POSTING );
        assertEquals( Enum577ClearingInstruction.AUTOMATIC_POSTING.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());


        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.AUTOMATIC_GIVE_UP );
        assertEquals( Enum577ClearingInstruction.AUTOMATIC_GIVE_UP.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.QUALIFIED_SERVICE_REPRESENTATIVE );
        assertEquals( Enum577ClearingInstruction.QUALIFIED_SERVICE_REPRESENTATIVE.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.CUSTOMER_TRADE );
        assertEquals( Enum577ClearingInstruction.CUSTOMER_TRADE.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag577EnuClearingInstruction( Enum577ClearingInstruction.SELF_CLEARING );
        assertEquals( Enum577ClearingInstruction.SELF_CLEARING.toFIXIDString(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());
    }
    @Test
