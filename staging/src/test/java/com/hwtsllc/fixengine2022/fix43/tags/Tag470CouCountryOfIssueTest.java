...
class Tag470CouCountryOfIssueTest {
    ...
    void FIX0470Test() {
        ...
        assertEquals( "470", fixData.toEnumIDString());
        assertEquals( "COUNTRY_OF_ISSUE", fixData.toEnumNameString());
        assertEquals( "CountryOfIssue", fixData.toEnumDescriptionString());
