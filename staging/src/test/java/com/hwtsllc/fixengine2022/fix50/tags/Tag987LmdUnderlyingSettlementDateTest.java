...
class Tag987LmdUnderlyingSettlementDateTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "987", tagData.toFIXIDString());
            assertEquals( "UNDERLYING_SETTLEMENT_DATE", tagData.toFIXNameString());
            assertEquals( "UnderlyingSettlementDate", tagData.toFIXDescriptionString());
