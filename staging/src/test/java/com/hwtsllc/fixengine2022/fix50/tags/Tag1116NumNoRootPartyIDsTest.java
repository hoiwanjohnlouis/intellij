...
class Tag1116NumNoRootPartyIDsTest {
    ...
    void FIX1116Test() {
        ...
        assertEquals( "1116", fixData.toFIXIDString());
        assertEquals( "NO_ROOT_PARTY_IDS", fixData.toFIXNameString());
        assertEquals( "NoRootPartyIDs", fixData.toFIXDescriptionString());
