...
class Tag1090IntMaxPriceLevelsTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag1090IntMaxPriceLevels( new MyIntType( oneElement ));
            assertEquals( "FIX1090_INT_MAX_PRICE_LEVELS", tagData.toFIXLabelString());
            assertEquals( "1090", tagData.toFIXIDString());
            assertEquals( "MAX_PRICE_LEVELS", tagData.toFIXNameString());
            assertEquals( "MaxPriceLevels", tagData.toFIXDescriptionString());
