...
class Tag999EnuLegUnitOfMeasureTest {
    ...
    void FIX0999Test() {
        ...
        assertEquals( "999", fixData.toFIXIDString());
        assertEquals( "LEG_UNIT_OF_MEASURE", fixData.toFIXNameString());
        assertEquals( "LegUnitOfMeasure", fixData.toFIXDescriptionString());
