...
class Tag1045FloUnderlyingFXRateTest {
    ...
    void FIX1045Test() {
        ...
        assertEquals( "1045", fixData.toEnumIDString());
        assertEquals( "UNDERLYING_FX_RATE", fixData.toEnumNameString());
        assertEquals( "UnderlyingFXRate", fixData.toEnumDescriptionString());
