...
class Tag1061EnuUndlyInstrumentPartyRoleTest {
    ...
    void FIX1061Test() {
        ...
        assertEquals( "1061", fixData.toEnumIDString());
        assertEquals( "UNDLY_INSTRUMENT_PARTY_ROLE", fixData.toEnumNameString());
        assertEquals( "UndlyInstrumentPartyRole", fixData.toEnumDescriptionString());
