...
class Tag996EnuUnitOfMeasureTest {
    ...
    void FIX0996Test() {
        ...
        assertEquals( "996", fixData.toEnumIDString());
        assertEquals( "UNIT_OF_MEASURE", fixData.toEnumNameString());
        assertEquals( "UnitOfMeasure", fixData.toEnumDescriptionString());
