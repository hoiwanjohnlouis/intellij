...
class Tag1013IntSideTrdRegTimestampTypeTest {
    @Test
    void FIX1013Test() {
        FIX50 fixData = FIX50.FIX1013_INT_SIDE_TRD_REG_TIMESTAMP_TYPE;
        assertEquals( "1013", fixData.toEnumIDString());
        assertEquals( "SIDE_TRD_REG_TIMESTAMP_TYPE", fixData.toEnumNameString());
        assertEquals( "SideTrdRegTimestampType", fixData.toEnumDescriptionString());
