...
class Tag1131StrRefCstmApplVerIDTest {
    ...
    String [] TestArray = {
            Tag1131StrRefCstmApplVerID.TESTA_STR_REF_CSTM_APPL_VER_ID,
            Tag1131StrRefCstmApplVerID.TESTB_STR_REF_CSTM_APPL_VER_ID
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag1131StrRefCstmApplVerID( new MyStringType( oneElement ));
            assertEquals( "FIX1131_STR_REF_CSTM_APPL_VER_ID", tagData.toEnumLabelString());
            assertEquals( "1131", tagData.toEnumIDString());
