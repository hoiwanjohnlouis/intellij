...
class Tag986AmtUnderlyingCollectAmountTest {
    ...
    double [] TestArray = {
            Tag986AmtUnderlyingCollectAmount.TESTA_AMT_UNDERLYING_COLLECT_AMOUNT,
            Tag986AmtUnderlyingCollectAmount.TESTB_AMT_UNDERLYING_COLLECT_AMOUNT
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag986AmtUnderlyingCollectAmount( new MyAmtType( oneElement ));
            assertEquals( "FIX986_AMT_UNDERLYING_COLLECT_AMOUNT", tagData.toEnumLabelString());
            assertEquals( "986", tagData.toEnumIDString());
