...
class Tag964IntSecurityReportIDTest {
    ...
    void FIX0964Test() {
        ...
        assertEquals( "964", fixData.toEnumIDString());
        assertEquals( "SECURITY_REPORT_ID", fixData.toEnumNameString());
        assertEquals( "SecurityReportID", fixData.toEnumDescriptionString());
