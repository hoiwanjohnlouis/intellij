 ...
 */
class Tag1079TzMaturityTimeTest {
    Tag1079TzMaturityTime tagData;
    String [] TestArray = {
            Tag1079TzMaturityTime.TESTA_TZ_MATURITY_TIME,
            Tag1079TzMaturityTime.TESTB_TZ_MATURITY_TIME
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag1079TzMaturityTime( new MyTZTimeOnlyType( oneElement ));
            assertEquals( "FIX1079_TZ_MATURITY_TIME", tagData.toEnumLabelString());
            assertEquals( "1079", tagData.toEnumIDString());
