...
class Tag1119EnuRootPartyRoleTest {
    @Test
    void FIX1119Test() {
        FIX50 fixData = FIX50.FIX1119_ENU_ROOT_PARTY_ROLE;
        assertEquals( "1119", fixData.toEnumIDString());
        assertEquals( "ROOT_PARTY_ROLE", fixData.toEnumNameString());
        assertEquals( "RootPartyRole", fixData.toEnumDescriptionString());
