...
class Tag984NumNoUnderlyingAmountsTest {
    ...
    void FIX0984Test() {
        ...
        assertEquals( "984", fixData.toEnumIDString());
        assertEquals( "NO_UNDERLYING_AMOUNTS", fixData.toEnumNameString());
        assertEquals( "NoUnderlyingAmounts", fixData.toEnumDescriptionString());
    ...
    void Tag0984Test() {
        ...
        oneElement = Tag984NumNoUnderlyingAmounts.TESTA_NUM_NO_UNDERLYING_AMOUNTS;
