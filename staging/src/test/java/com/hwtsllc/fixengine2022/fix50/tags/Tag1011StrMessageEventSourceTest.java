...
class Tag1011StrMessageEventSourceTest {
    ...
    void FIX1011Test() {
        ...
        assertEquals( "1011", fixData.toEnumIDString());
        assertEquals( "MESSAGE_EVENT_SOURCE", fixData.toEnumNameString());
        assertEquals( "MessageEventSource", fixData.toEnumDescriptionString());
    ...
    void Tag1011Test() {
        ...
        oneElement = Tag1011StrMessageEventSource.TESTA_STR_MESSAGE_EVENT_SOURCE;
        tagData = new Tag1011StrMessageEventSource( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );

        oneElement = Tag1011StrMessageEventSource.TESTB_STR_MESSAGE_EVENT_SOURCE;
        tagData = new Tag1011StrMessageEventSource( new MyStringType( oneElement ) );
        assertEquals( oneElement, tagData.getDataValue() );
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue() );
    }
