...
class Tag1054EnuInstrumentPartySubIDTypeTest {
    ...
    void FIX1054Test() {
        ...
        assertEquals( "1054", fixData.toFIXIDString());
        assertEquals( "INSTRUMENT_PARTY_SUB_ID_TYPE", fixData.toFIXNameString());
        assertEquals( "InstrumentPartySubIDType", fixData.toFIXDescriptionString());
