...
class Tag1043EnuCollApplTypeTest {
    ...
    void FIX1043Test() {
        ...
        assertEquals( "1043", fixData.getID());
        assertEquals( "COLL_APPL_TYPE", fixData.getName());
        assertEquals( "CollApplType", fixData.getDescription());
    ...
    void Tag1043Test() {
        ...
        assertEquals( Enum1043CollApplType.SPECIFIC_DEPOSIT.getID(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());

        tagData = new Tag1043EnuCollApplType( Enum1043CollApplType.GENERAL );
        assertEquals( Enum1043CollApplType.GENERAL.getID(), tagData.getDataValue());
        assertNotEquals( MyTestValues.JUNK_STR_DATA_VALUE, tagData.getDataValue());
    }
}