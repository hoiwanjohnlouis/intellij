...
class Tag1017FloLegOptionRatioTest {
    ...
    void FIX1017Test() {
        ...
        assertEquals( "1017", fixData.toEnumIDString());
        assertEquals( "LEG_OPTION_RATIO", fixData.toEnumNameString());
        assertEquals( "LegOptionRatio", fixData.toEnumDescriptionString());
