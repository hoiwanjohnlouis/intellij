...
class Tag993StrAllocCustomerCapacityTest {
    ...
    void FIX0993Test() {
        ...
        assertEquals( "993", fixData.toEnumIDString());
        assertEquals( "ALLOC_CUSTOMER_CAPACITY", fixData.toEnumNameString());
        assertEquals( "AllocCustomerCapacity", fixData.toEnumDescriptionString());
