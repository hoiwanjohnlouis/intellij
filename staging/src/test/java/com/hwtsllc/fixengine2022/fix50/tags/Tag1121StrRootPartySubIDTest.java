...
class Tag1121StrRootPartySubIDTest {
    ...
    void FIX1121Test() {
        ...
        assertEquals( "1121", fixData.toFIXIDString());
        assertEquals( "ROOT_PARTY_SUB_ID", fixData.toFIXNameString());
        assertEquals( "RootPartySubID", fixData.toFIXDescriptionString());
