...
class Tag1020QtyTradeVolumeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag1020QtyTradeVolume( new MyQtyType( oneElement ));
            assertEquals( "FIX1020_QTY_TRADE_VOLUME", tagData.toEnumLabelString());
            assertEquals( "1020", tagData.toEnumIDString());
            assertEquals( "TRADE_VOLUME", tagData.toEnumNameString());
            assertEquals( "TradeVolume", tagData.toEnumDescriptionString());
