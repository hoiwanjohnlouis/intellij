...
class Tag1096EnuPegSecurityIDSourceTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( MyEnumSecurityIDSource oneEnum : MyEnumSecurityIDSource.values()) {
            tagData = new Tag1096EnuPegSecurityIDSource(oneEnum);
            assertEquals( "FIX1096_ENU_PEG_SECURITY_ID_SOURCE", tagData.toEnumLabelString());
            assertEquals( "1096", tagData.toEnumIDString());
            assertEquals( "PEG_SECURITY_ID_SOURCE", tagData.toEnumNameString());
