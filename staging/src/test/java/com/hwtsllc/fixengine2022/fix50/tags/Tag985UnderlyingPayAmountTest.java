...
class Tag985UnderlyingPayAmountTest {
    ...
    void FIX0985Test() {
        ...
        assertEquals( "985", fixData.toFIXIDString());
        assertEquals( "UNDERLYING_PAY_AMOUNT", fixData.toFIXNameString());
        assertEquals( "UnderlyingPayAmount", fixData.toFIXDescriptionString());
