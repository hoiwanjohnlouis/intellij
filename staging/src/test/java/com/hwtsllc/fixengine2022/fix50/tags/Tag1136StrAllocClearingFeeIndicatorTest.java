...
class Tag1136StrAllocClearingFeeIndicatorTest {
    ...
    void FIX1136Test() {
        ...
        assertEquals( "1136", fixData.toEnumIDString());
        assertEquals( "ALLOC_CLEARING_FEE_INDICATOR", fixData.toEnumNameString());
        assertEquals( "AllocClearingFeeIndicator", fixData.toEnumDescriptionString());
