...
class Tag1122EnuRootPartySubIDTypeTest {
    ...
    void FIX1122Test() {
        ...
        assertEquals( "1122", fixData.toEnumIDString());
        assertEquals( "ROOT_PARTY_SUB_ID_TYPE", fixData.toEnumNameString());
        assertEquals( "RootPartySubIDType", fixData.toEnumDescriptionString());
    ...
    void PrintFIXTagTest() {
        ...
        for ( MyEnumPartySubIDType oneEnum : MyEnumPartySubIDType.values()) {
            tagData = new Tag1122EnuRootPartySubIDType(oneEnum);
    ...
    void TagToVerboseStringTest() {
        ...
        for (MyEnumPartySubIDType oneEnum : MyEnumPartySubIDType.values()) {
            tagData = new Tag1122EnuRootPartySubIDType(oneEnum);
            assertEquals( "Tag1122EnuRootPartySubIDType\n" +
