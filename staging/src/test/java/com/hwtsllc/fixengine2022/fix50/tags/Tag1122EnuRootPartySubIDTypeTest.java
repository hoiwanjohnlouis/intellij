...
class Tag1122EnuRootPartySubIDTypeTest {
    ...
    void FIX1122Test() {
        ...
        assertEquals( "1122", fixData.toFIXIDString());
        assertEquals( "ROOT_PARTY_SUB_ID_TYPE", fixData.toFIXNameString());
        assertEquals( "RootPartySubIDType", fixData.toFIXDescriptionString());
