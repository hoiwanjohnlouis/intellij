...
class Tag1129StrCstmApplVerIDTest {
    ...
    void FIX1129Test() {
        ...
        assertEquals( "1129", fixData.toEnumIDString());
        assertEquals( "CSTM_APPL_VER_ID", fixData.toEnumNameString());
        assertEquals( "CstmApplVerID", fixData.toEnumDescriptionString());
