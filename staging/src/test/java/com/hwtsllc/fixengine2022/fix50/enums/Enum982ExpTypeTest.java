...
class Enum982ExpTypeTest {
    ...
    void EnumTest() {
        ...
        assertEquals( "AUTO_EXERCISE", enumType.toEnumNameString() );
        ...
        assertEquals( "NON_AUTO_EXERCISE", enumType.toEnumNameString() );
        ...
        assertEquals( "FINAL_EXERCISED", enumType.toEnumNameString() );
        ...
        assertEquals( "CONTRARY_INTENTION", enumType.toEnumNameString() );
        ...
        assertEquals( "DIFFERENCE", enumType.toEnumNameString() );
