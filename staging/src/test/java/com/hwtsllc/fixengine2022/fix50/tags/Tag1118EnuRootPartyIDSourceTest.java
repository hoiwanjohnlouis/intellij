...
class Tag1118EnuRootPartyIDSourceTest {
    ...
    void FIX1118Test() {
        ...
        assertEquals( "1118", fixData.toFIXIDString());
        assertEquals( "ROOT_PARTY_ID_SOURCE", fixData.toFIXNameString());
        assertEquals( "RootPartyIDSource", fixData.toFIXDescriptionString());
