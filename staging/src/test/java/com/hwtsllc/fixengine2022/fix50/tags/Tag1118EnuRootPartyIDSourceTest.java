...
class Tag1118EnuRootPartyIDSourceTest {
    ...
    void FIX1118Test() {
        ...
        assertEquals( "1118", fixData.toEnumIDString());
        assertEquals( "ROOT_PARTY_ID_SOURCE", fixData.toEnumNameString());
        assertEquals( "RootPartyIDSource", fixData.toEnumDescriptionString());
