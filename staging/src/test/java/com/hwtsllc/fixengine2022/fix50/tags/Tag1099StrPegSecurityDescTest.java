...
class Tag1099StrPegSecurityDescTest {
    ...
    void FIX1099Test() {
        ...
        assertEquals( "1099", fixData.toEnumIDString());
        assertEquals( "PEG_SECURITY_DESC", fixData.toEnumNameString());
        assertEquals( "PegSecurityDesc", fixData.toEnumDescriptionString());
