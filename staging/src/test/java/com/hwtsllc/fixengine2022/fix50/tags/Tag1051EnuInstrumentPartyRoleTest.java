...
class Tag1051EnuInstrumentPartyRoleTest {
    ...
    void FIX1051Test() {
        ...
        assertEquals( "1051", fixData.toFIXIDString());
        assertEquals( "INSTRUMENT_PARTY_ROLE", fixData.toFIXNameString());
        assertEquals( "InstrumentPartyRole", fixData.toFIXDescriptionString());
