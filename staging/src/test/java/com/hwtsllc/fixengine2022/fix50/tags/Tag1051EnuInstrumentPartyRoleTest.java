...
class Tag1051EnuInstrumentPartyRoleTest {
    @Test
    void FIX1051Test() {
        FIX50 fixData = FIX50.FIX1051_ENU_INSTRUMENT_PARTY_ROLE;
        assertEquals( "1051", fixData.toEnumIDString());
        assertEquals( "INSTRUMENT_PARTY_ROLE", fixData.toEnumNameString());
        assertEquals( "InstrumentPartyRole", fixData.toEnumDescriptionString());
