...
class Tag259LmdBasisFeatureDateTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag259LmdBasisFeatureDate( new MyLocalMktDateType( oneElement ));
            assertEquals( "FIX259_LMD_BASIS_FEATURE_DATE", tagData.toFIXLabelString());
            assertEquals( "259", tagData.toFIXIDString());
            assertEquals( "BASIS_FEATURE_DATE", tagData.toFIXNameString());
            assertEquals( "BasisFeatureDate", tagData.toFIXDescriptionString());
