...
import com.hwtsllc.fix.datatypes.MyUTCTimeType;
...
class Tag273UtctMDEntryTimeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag273UtctMDEntryTime( new MyUTCTimeType( oneElement ));
            assertEquals( "FIX273_UTCT_MD_ENTRY_TIME", tagData.toFIXLabelString());
            assertEquals( "273", tagData.toFIXIDString());
            assertEquals( "MD_ENTRY_TIME", tagData.toFIXNameString());
            assertEquals( "MDEntryTime", tagData.toFIXDescriptionString());
