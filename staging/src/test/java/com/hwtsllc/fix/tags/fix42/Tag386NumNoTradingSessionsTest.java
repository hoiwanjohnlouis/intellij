...
class Tag386NumNoTradingSessionsTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag386NumNoTradingSessions( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX386_NUM_NO_TRADING_SESSIONS", tagData.toFIXLabelString());
            assertEquals( "386", tagData.toFIXIDString());
            assertEquals( "NO_TRADING_SESSIONS", tagData.toFIXNameString());
            assertEquals( "NoTradingSessions", tagData.toFIXDescriptionString());
