...
class Tag228FloFactorTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( float oneElement : TestArray ) {
            tagData = new Tag228FloFactor( new MyFloatType( oneElement ));
            assertEquals( "FIX228_FLO_FACTOR", tagData.toFIXLabelString());
            assertEquals( "228", tagData.toFIXIDString());
            assertEquals( "FACTOR", tagData.toFIXNameString());
            assertEquals( "Factor", tagData.toFIXDescriptionString());
