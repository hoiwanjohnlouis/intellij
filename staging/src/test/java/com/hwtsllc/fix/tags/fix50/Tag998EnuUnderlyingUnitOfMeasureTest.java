...
import com.hwtsllc.fix.datatypes.MyEnumUnitOfMeasure;
...
class Tag998EnuUnderlyingUnitOfMeasureTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( MyEnumUnitOfMeasure oneEnum : MyEnumUnitOfMeasure.values()) {
            ...
            assertEquals( "998", tagData.toFIXIDString());
            assertEquals( "UNDERLYING_UNIT_OF_MEASURE", tagData.toFIXNameString());
            assertEquals( "UnderlyingUnitOfMeasure", tagData.toFIXDescriptionString());
