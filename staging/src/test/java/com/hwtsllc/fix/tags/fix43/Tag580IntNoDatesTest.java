...
class Tag580IntNoDatesTest {
    ...
    int [] TestArray = {
            Tag580IntNoDates.TESTA_INT_NO_DATES,
            Tag580IntNoDates.TESTB_INT_NO_DATES
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "580", tagData.toFIXIDString());
            assertEquals( "NO_DATES", tagData.toFIXNameString());
            assertEquals( "NoDates", tagData.toFIXDescriptionString());
