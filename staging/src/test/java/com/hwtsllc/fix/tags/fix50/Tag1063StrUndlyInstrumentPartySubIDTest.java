...
class Tag1063StrUndlyInstrumentPartySubIDTest {
    ...
    String [] TestArray = {
            Tag1063StrUndlyInstrumentPartySubID.TESTA_STR_UNDLY_INSTRUMENT_PARTY_SUB_ID,
            Tag1063StrUndlyInstrumentPartySubID.TESTB_STR_UNDLY_INSTRUMENT_PARTY_SUB_ID
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "1063", tagData.toFIXIDString());
            assertEquals( "UNDLY_INSTRUMENT_PARTY_SUB_ID", tagData.toFIXNameString());
            assertEquals( "UndlyInstrumentPartySubID", tagData.toFIXDescriptionString());
