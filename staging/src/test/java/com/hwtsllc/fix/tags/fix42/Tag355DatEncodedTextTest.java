...
class Tag355DatEncodedTextTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag355DatEncodedText( new MyDataType( oneElement ));
            assertEquals( "FIX355_DAT_ENCODED_TEXT", tagData.toFIXLabelString());
            assertEquals( "355", tagData.toFIXIDString());
            assertEquals( "ENCODED_TEXT", tagData.toFIXNameString());
            assertEquals( "EncodedText", tagData.toFIXDescriptionString());
