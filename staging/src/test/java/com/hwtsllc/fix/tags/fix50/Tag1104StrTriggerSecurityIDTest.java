...
class Tag1104StrTriggerSecurityIDTest {
    ...
    String [] TestArray = {
            Tag1104StrTriggerSecurityID.TESTA_STR_TRIGGER_SECURITY_ID,
            Tag1104StrTriggerSecurityID.TESTB_STR_TRIGGER_SECURITY_ID
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "1104", tagData.toFIXIDString());
            assertEquals( "TRIGGER_SECURITY_ID", tagData.toFIXNameString());
            assertEquals( "TriggerSecurityID", tagData.toFIXDescriptionString());
