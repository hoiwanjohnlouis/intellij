...
class Tag207ExcSecurityExchangeTest {
    ...
    String [] TestArray = {
            ...
            Tag207ExcSecurityExchange.TESTB_EXC_SECURITY_EXCHANGE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag207ExcSecurityExchange( new MyExchangeType( oneElement ));
            assertEquals( "FIX207_EXC_SECURITY_EXCHANGE", tagData.toFIXLabelString());
            assertEquals( "207", tagData.toFIXIDString());
            assertEquals( "SECURITY_EXCHANGE", tagData.toFIXNameString());
            assertEquals( "SecurityExchange", tagData.toFIXDescriptionString());
