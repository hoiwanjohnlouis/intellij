...
class Tag490LmdCardExpDateTest {
    ...
    String [] TestArray = {
            Tag490LmdCardExpDate.TESTA_LMD_CARD_EXP_DATE,
            Tag490LmdCardExpDate.TESTB_LMD_CARD_EXP_DATE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "490", tagData.toFIXIDString());
            assertEquals( "CARD_EXP_DATE", tagData.toFIXNameString());
            assertEquals( "CardExpDate", tagData.toFIXDescriptionString());
