...
class Tag999EnuLegUnitOfMeasureTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( MyEnumUnitOfMeasure oneEnum : MyEnumUnitOfMeasure.values()) {
            ...
            assertEquals( "999", tagData.toFIXIDString());
            assertEquals( "LEG_UNIT_OF_MEASURE", tagData.toFIXNameString());
            assertEquals( "LegUnitOfMeasure", tagData.toFIXDescriptionString());
