...
class Tag479CcyCommCurrencyTest {
    ...
    String [] TestArray = {
            Tag479CcyCommCurrency.TESTA_CCY_COMM_CURRENCY,
            Tag479CcyCommCurrency.TESTB_CCY_COMM_CURRENCY
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "479", tagData.toFIXIDString());
            assertEquals( "COMM_CURRENCY", tagData.toFIXNameString());
            assertEquals( "CommCurrency", tagData.toFIXDescriptionString());
