...
class Tag354LenEncodedTextLenTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag354LenEncodedTextLen( new MyLengthType( oneElement ));
            assertEquals( "FIX354_LEN_ENCODED_TEXT_LEN", tagData.toFIXLabelString());
            assertEquals( "354", tagData.toFIXIDString());
            assertEquals( "ENCODED_TEXT_LEN", tagData.toFIXNameString());
            assertEquals( "EncodedTextLen", tagData.toFIXDescriptionString());
