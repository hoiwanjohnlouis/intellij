...
class Tag1113StrTriggerTradingSessionIDTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "1113", tagData.toFIXIDString());
            assertEquals( "TRIGGER_TRADING_SESSION_ID", tagData.toFIXNameString());
            assertEquals( "TriggerTradingSessionID", tagData.toFIXDescriptionString());
