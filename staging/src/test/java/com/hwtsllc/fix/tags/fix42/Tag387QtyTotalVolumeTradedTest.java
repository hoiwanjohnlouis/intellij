...
class Tag387QtyTotalVolumeTradedTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag387QtyTotalVolumeTraded( new MyQtyType( oneElement ));
            assertEquals( "FIX387_QTY_TOTAL_VOLUME_TRADED", tagData.toFIXLabelString());
            assertEquals( "387", tagData.toFIXIDString());
            assertEquals( "TOTAL_VOLUME_TRADED", tagData.toFIXNameString());
            assertEquals( "TotalVolumeTraded", tagData.toFIXDescriptionString());
