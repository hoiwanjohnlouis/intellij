...
class Tag508StrRegistRefIDTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag508StrRegistRefID( new MyStringType( oneElement ));
            assertEquals( "FIX508_STR_REGIST_REF_ID", tagData.toFIXLabelString());
            assertEquals( "508", tagData.toFIXIDString());
            assertEquals( "REGIST_REF_ID", tagData.toFIXNameString());
            assertEquals( "RegistRefID", tagData.toFIXDescriptionString());
