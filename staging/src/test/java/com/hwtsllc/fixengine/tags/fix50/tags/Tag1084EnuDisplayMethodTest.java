...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1084DisplayMethod;
...
class Tag1084EnuDisplayMethodTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1084DisplayMethod oneEnum : Enum1084DisplayMethod.values()) {
            ...
            assertEquals( "DISPLAY_METHOD", tagData.toFIXNameString());
            assertEquals( "DisplayMethod", tagData.toFIXDescriptionString());
