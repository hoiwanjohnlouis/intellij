...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum506RegistStatus;
...
class Tag506EnuRegistStatusTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum506RegistStatus oneEnum : Enum506RegistStatus.values()) {
            ...
            assertEquals( "REGIST_STATUS", tagData.toFIXNameString());
            assertEquals( "RegistStatus", tagData.toFIXDescriptionString());
