...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum528OrderCapacity;
...
class Tag528EnuOrderCapacityTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum528OrderCapacity oneEnum : Enum528OrderCapacity.values()) {
            ...
            assertEquals( "ORDER_CAPACITY", tagData.toFIXNameString());
            assertEquals( "OrderCapacity", tagData.toFIXDescriptionString());
