...
class Tag222StrBenchmarkCurvePointTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag222StrBenchmarkCurvePoint( new MyStringType( oneElement ));
            assertEquals( "FIX222_STR_BENCHMARK_CURVE_POINT", tagData.toFIXLabelString());
            assertEquals( "222", tagData.toFIXIDString());
            assertEquals( "BENCHMARK_CURVE_POINT", tagData.toFIXNameString());
            assertEquals( "BenchmarkCurvePoint", tagData.toFIXDescriptionString());
