...
class Tag634PctOfferYieldTest {
    ...
    double [] TestArray = {
            Tag634PctOfferYield.TESTA_PCT_OFFER_YIELD,
            Tag634PctOfferYield.TESTB_PCT_OFFER_YIELD
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            ...
            assertEquals( "634", tagData.toFIXIDString());
            assertEquals( "OFFER_YIELD", tagData.toFIXNameString());
            assertEquals( "OfferYield", tagData.toFIXDescriptionString());
