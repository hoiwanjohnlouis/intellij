...
class Tag267NumNoMDEntryTypesTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag267NumNoMDEntryTypes( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX267_NUM_NO_MD_ENTRY_TYPES", tagData.toFIXLabelString());
            assertEquals( "267", tagData.toFIXIDString());
            assertEquals( "NO_MD_ENTRY_TYPES", tagData.toFIXNameString());
            assertEquals( "NoMDEntryTypes", tagData.toFIXDescriptionString());
