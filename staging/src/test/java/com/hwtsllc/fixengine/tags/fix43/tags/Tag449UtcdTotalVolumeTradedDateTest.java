...
import com.hwtsllc.fixengine.datatypes.MyUTCDateType;
...
class Tag449UtcdTotalVolumeTradedDateTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "449", tagData.toFIXIDString());
            assertEquals( "TOTAL_VOLUME_TRADED_DATE", tagData.toFIXNameString());
            assertEquals( "TotalVolumeTradedDate (replaced)", tagData.toFIXDescriptionString());
