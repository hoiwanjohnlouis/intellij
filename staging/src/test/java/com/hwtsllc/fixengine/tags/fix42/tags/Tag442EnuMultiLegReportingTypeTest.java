...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum442MultiLegReportingType;
...
class Tag442EnuMultiLegReportingTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum442MultiLegReportingType oneEnum : Enum442MultiLegReportingType.values()) {
            ...
            assertEquals( "MULTI_LEG_REPORTING_TYPE", tagData.toFIXNameString());
            assertEquals( "MultiLegReportingType", tagData.toFIXDescriptionString());
