...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum544CashMargin;
...
class Tag544EnuCashMarginTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum544CashMargin oneEnum : Enum544CashMargin.values()) {
            ...
            assertEquals( "CASH_MARGIN", tagData.toFIXNameString());
            assertEquals( "CashMargin", tagData.toFIXDescriptionString());
