...
class Tag370UtcOnBehalfOfSendingTimeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "370", tagData.toFIXIDString());
            assertEquals( "ON_BEHALF_OF_SENDING_TIME", tagData.toFIXNameString());
            assertEquals( "OnBehalfOfSendingTime", tagData.toFIXDescriptionString());
