...
class Tag154AmtAllocNetMoneyTest {
    ...
    double [] TestArray = {
            Tag154AmtAllocNetMoney.TESTA_AMT_ALLOC_NET_MONEY,
            Tag154AmtAllocNetMoney.TESTB_AMT_ALLOC_NET_MONEY
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            ...
            assertEquals( "154", tagData.toFIXIDString());
            assertEquals( "ALLOC_NET_MONEY", tagData.toFIXNameString());
            assertEquals( "AllocNetMoney", tagData.toFIXDescriptionString());
