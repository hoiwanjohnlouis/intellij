...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum978LateIndicator;
...
class Tag978EnuBoolLateIndicatorTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum978LateIndicator oneEnum : Enum978LateIndicator.values() ) {
            ...
            assertEquals( "LATE_INDICATOR", tagData.toFIXNameString());
            assertEquals( "LateIndicator", tagData.toFIXDescriptionString());
