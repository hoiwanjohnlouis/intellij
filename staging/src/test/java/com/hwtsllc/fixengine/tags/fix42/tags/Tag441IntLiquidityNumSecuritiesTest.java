...
class Tag441IntLiquidityNumSecuritiesTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "441", tagData.toFIXIDString());
            assertEquals( "LIQUIDITY_NUM_SECURITIES", tagData.toFIXNameString());
            assertEquals( "LiquidityNumSecurities", tagData.toFIXDescriptionString());
