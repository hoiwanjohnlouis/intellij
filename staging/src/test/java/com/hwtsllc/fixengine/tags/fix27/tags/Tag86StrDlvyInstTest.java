...
class Tag86StrDlvyInstTest {
    ...
    String [] TestArray = {
            Tag86StrDlvyInst.TESTA_STR_DLVY_INST,
            Tag86StrDlvyInst.TESTB_STR_DLVY_INST
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "DLVY_INST", tagData.toFIXNameString());
            assertEquals( "86", tagData.toFIXIDString());
            assertEquals( "DlvyInst (no longer used)", tagData.toFIXDescriptionString());
