...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1111TriggerOrderType;
...
class Tag1111EnuTriggerOrderTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1111TriggerOrderType oneEnum : Enum1111TriggerOrderType.values()) {
            ...
            assertEquals( "TRIGGER_ORDER_TYPE", tagData.toFIXNameString());
            assertEquals( "TriggerOrderType", tagData.toFIXDescriptionString());
