...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1043CollApplType;
...
class Tag1043EnuCollApplTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1043CollApplType oneEnum : Enum1043CollApplType.values()) {
            ...
            assertEquals( "1043", tagData.toFIXIDString());
            assertEquals( "COLL_APPL_TYPE", tagData.toFIXNameString());
            assertEquals( "CollApplType", tagData.toFIXDescriptionString());
