...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum495TaxAdvantageType;
...
class Tag495EnuTaxAdvantageTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum495TaxAdvantageType oneEnum : Enum495TaxAdvantageType.values()) {
            ...
            assertEquals( "495", tagData.toFIXIDString());
            assertEquals( "TAX_ADVANTAGE_TYPE", tagData.toFIXNameString());
            assertEquals( "TaxAdvantageType", tagData.toFIXDescriptionString());
