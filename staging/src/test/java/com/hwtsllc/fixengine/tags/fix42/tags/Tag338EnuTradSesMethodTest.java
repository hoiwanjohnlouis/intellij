...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum338TradSesMethod;
...
class Tag338EnuTradSesMethodTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum338TradSesMethod oneEnum : Enum338TradSesMethod.values()) {
            ...
            assertEquals( "338", tagData.toFIXIDString());
            assertEquals( "TRAD_SES_METHOD", tagData.toFIXNameString());
            assertEquals( "TradSesMethod", tagData.toFIXDescriptionString());
