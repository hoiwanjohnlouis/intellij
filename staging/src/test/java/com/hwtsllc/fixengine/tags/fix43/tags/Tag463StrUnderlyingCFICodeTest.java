...
class Tag463StrUnderlyingCFICodeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag463StrUnderlyingCFICode( new MyStringType( oneElement ));
            assertEquals( "FIX463_STR_UNDERLYING_CFI_CODE", tagData.toFIXLabelString());
            assertEquals( "463", tagData.toFIXIDString());
            assertEquals( "UNDERLYING_CFI_CODE", tagData.toFIXNameString());
            assertEquals( "UnderlyingCFICode", tagData.toFIXDescriptionString());
