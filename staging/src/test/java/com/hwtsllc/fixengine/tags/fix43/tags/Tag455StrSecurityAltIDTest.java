...
class Tag455StrSecurityAltIDTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag455StrSecurityAltID( new MyStringType( oneElement ));
            assertEquals( "FIX455_STR_SECURITY_ALT_ID", tagData.toFIXLabelString());
            assertEquals( "455", tagData.toFIXIDString());
            assertEquals( "SECURITY_ALT_ID", tagData.toFIXNameString());
            assertEquals( "SecurityAltID", tagData.toFIXDescriptionString());
