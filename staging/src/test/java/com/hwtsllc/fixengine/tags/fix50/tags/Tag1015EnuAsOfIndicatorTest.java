...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1015AsOfIndicator;
...
class Tag1015EnuAsOfIndicatorTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1015AsOfIndicator oneEnum : Enum1015AsOfIndicator.values()) {
            tagData = new Tag1015EnuAsOfIndicator(oneEnum);
            assertEquals( "FIX1015_ENU_AS_OF_INDICATOR", tagData.toFIXLabelString());
            assertEquals( "1015", tagData.toFIXIDString());
            assertEquals( "AS_OF_INDICATOR", tagData.toFIXNameString());
            assertEquals( "AsOfIndicator", tagData.toFIXDescriptionString());
