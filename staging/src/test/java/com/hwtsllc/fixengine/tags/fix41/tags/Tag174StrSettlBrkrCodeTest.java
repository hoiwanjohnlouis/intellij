...
class Tag174StrSettlBrkrCodeTest {
    ...
    String [] TestArray = {
            Tag174StrSettlBrkrCode.TESTA_STR_SETTL_BRKR_CODE,
            Tag174StrSettlBrkrCode.TESTB_STR_SETTL_BRKR_CODE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "174", tagData.toFIXIDString());
            assertEquals( "SETTL_BRKR_CODE", tagData.toFIXNameString());
            assertEquals( "SettlBrkrCode (replaced)", tagData.toFIXDescriptionString());
