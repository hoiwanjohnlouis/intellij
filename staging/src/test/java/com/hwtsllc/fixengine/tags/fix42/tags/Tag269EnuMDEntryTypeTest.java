...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum269MDEntryType;
...
class Tag269EnuMDEntryTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum269MDEntryType oneEnum : Enum269MDEntryType.values()) {
            tagData = new Tag269EnuMDEntryType(oneEnum);
            assertEquals( "FIX269_ENU_MD_ENTRY_TYPE", tagData.toFIXLabelString());
            assertEquals( "269", tagData.toFIXIDString());
            assertEquals( "MD_ENTRY_TYPE", tagData.toFIXNameString());
            assertEquals( "MDEntryType", tagData.toFIXDescriptionString());
