...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1033DeskType;
...
class Tag1033EnuDeskTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1033DeskType oneEnum : Enum1033DeskType.values()) {
            ...
            assertEquals( "DESK_TYPE", tagData.toFIXNameString());
            assertEquals( "DeskType", tagData.toFIXDescriptionString());
