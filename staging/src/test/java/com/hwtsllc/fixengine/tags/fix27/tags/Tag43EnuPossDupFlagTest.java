...
import com.hwtsllc.fixengine.tags.fix27.enums.Enum43PossDupFlag;
...
class Tag43EnuPossDupFlagTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum43PossDupFlag oneEnum : Enum43PossDupFlag.values()) {
            ...
            assertEquals( "POSS_DUP_FLAG", tagData.toFIXNameString());
            assertEquals( "43", tagData.toFIXIDString());
            assertEquals( "PossDupFlag", tagData.toFIXDescriptionString());
