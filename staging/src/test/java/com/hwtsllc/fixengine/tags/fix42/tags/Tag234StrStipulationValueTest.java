...
class Tag234StrStipulationValueTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag234StrStipulationValue( new MyStringType( oneElement ));
            assertEquals( "FIX234_STR_STIPULATION_VALUE", tagData.toFIXLabelString());
            assertEquals( "234", tagData.toFIXIDString());
            assertEquals( "STIPULATION_VALUE", tagData.toFIXNameString());
            assertEquals( "StipulationValue", tagData.toFIXDescriptionString());
