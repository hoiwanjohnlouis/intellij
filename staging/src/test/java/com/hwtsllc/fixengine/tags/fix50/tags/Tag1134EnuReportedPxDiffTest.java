...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1134ReportedPxDiff;
...
class Tag1134EnuReportedPxDiffTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1134ReportedPxDiff oneEnum : Enum1134ReportedPxDiff.values()) {
            ...
            assertEquals( "1134", tagData.toFIXIDString());
            assertEquals( "REPORTED_PX_DIFF", tagData.toFIXNameString());
            assertEquals( "ReportedPxDiff", tagData.toFIXDescriptionString());
