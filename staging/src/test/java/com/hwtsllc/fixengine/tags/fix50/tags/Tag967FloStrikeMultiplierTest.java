...
class Tag967FloStrikeMultiplierTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( float oneElement : TestArray ) {
            ...
            assertEquals( "967", tagData.toFIXIDString());
            assertEquals( "STRIKE_MULTIPLIER", tagData.toFIXNameString());
            assertEquals( "StrikeMultiplier", tagData.toFIXDescriptionString());
