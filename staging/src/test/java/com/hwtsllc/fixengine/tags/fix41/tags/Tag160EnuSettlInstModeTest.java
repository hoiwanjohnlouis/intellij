...
import com.hwtsllc.fixengine.tags.fix41.enums.Enum160SettlInstMode;
...
class Tag160EnuSettlInstModeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum160SettlInstMode oneEnum : Enum160SettlInstMode.values()) {
            ...
            assertEquals( "SETTL_INST_MODE", tagData.toFIXNameString());
            assertEquals( "SettlInstMode", tagData.toFIXDescriptionString());
