...
class Tag971IntNTPositionLimitTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag971IntNTPositionLimit( new MyIntType( oneElement ));
            assertEquals( "FIX971_INT_NT_POSITION_LIMIT", tagData.toFIXLabelString());
            assertEquals( "971", tagData.toFIXIDString());
            assertEquals( "NT_POSITION_LIMIT", tagData.toFIXNameString());
            assertEquals( "NTPositionLimit", tagData.toFIXDescriptionString());
