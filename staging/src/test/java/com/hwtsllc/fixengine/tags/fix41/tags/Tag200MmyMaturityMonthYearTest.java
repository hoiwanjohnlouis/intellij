...
class Tag200MmyMaturityMonthYearTest {
    ...
    String [] TestArray = {
            Tag200MmyMaturityMonthYear.TESTA_MMY_MATURITY_MONTH_YEAR,
            Tag200MmyMaturityMonthYear.TESTB_MMY_MATURITY_MONTH_YEAR
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag200MmyMaturityMonthYear( new MyMonthYearType( oneElement ));
            assertEquals( "FIX200_MMY_MATURITY_MONTH_YEAR", tagData.toFIXLabelString());
