...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum265MDUpdateType;
...
class Tag265EnuMDUpdateTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum265MDUpdateType oneEnum : Enum265MDUpdateType.values()) {
            ...
            assertEquals( "265", tagData.toFIXIDString());
            assertEquals( "MD_UPDATE_TYPE", tagData.toFIXNameString());
            assertEquals( "MDUpdateType", tagData.toFIXDescriptionString());
