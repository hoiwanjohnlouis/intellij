...
class Tag195PxoLastForwardPointsTest {
    ...
    double [] TestArray = {
            ...
            Tag195PxoLastForwardPoints.TESTB_PXO_LAST_FORWARD_POINTS
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag195PxoLastForwardPoints( new MyPriceOffsetType( oneElement ));
            assertEquals( "FIX195_PXO_LAST_FORWARD_POINTS", tagData.toFIXLabelString());
            assertEquals( "195", tagData.toFIXIDString());
            assertEquals( "LAST_FORWARD_POINTS", tagData.toFIXNameString());
            assertEquals( "LastForwardPoints", tagData.toFIXDescriptionString());
