...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1028ManualOrderIndicator;
...
class Tag1028EnuManualOrderIndicatorTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1028ManualOrderIndicator oneEnum : Enum1028ManualOrderIndicator.values()) {
            ...
            assertEquals( "1028", tagData.toFIXIDString());
            assertEquals( "MANUAL_ORDER_INDICATOR", tagData.toFIXNameString());
            assertEquals( "ManualOrderIndicator", tagData.toFIXDescriptionString());
