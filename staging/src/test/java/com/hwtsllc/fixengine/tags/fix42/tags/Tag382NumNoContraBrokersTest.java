...
class Tag382NumNoContraBrokersTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag382NumNoContraBrokers( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX382_NUM_NO_CONTRA_BROKERS", tagData.toFIXLabelString());
            assertEquals( "382", tagData.toFIXIDString());
            assertEquals( "NO_CONTRA_BROKERS", tagData.toFIXNameString());
            assertEquals( "NoContraBrokers", tagData.toFIXDescriptionString());
