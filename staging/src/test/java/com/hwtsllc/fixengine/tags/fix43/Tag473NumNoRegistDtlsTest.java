...
class Tag473NumNoRegistDtlsTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag473NumNoRegistDtls( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX473_NUM_NO_REGIST_DTLS", tagData.toFIXLabelString());
            assertEquals( "473", tagData.toFIXIDString());
            assertEquals( "NO_REGIST_DTLS", tagData.toFIXNameString());
            assertEquals( "NoRegistDtls", tagData.toFIXDescriptionString());
