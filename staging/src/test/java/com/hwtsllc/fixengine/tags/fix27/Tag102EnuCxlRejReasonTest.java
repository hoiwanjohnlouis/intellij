...
import com.hwtsllc.fixengine.enums.fix27.Enum102CxlRejReason;
...
class Tag102EnuCxlRejReasonTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum102CxlRejReason oneEnum : Enum102CxlRejReason.values()) {
            ...
            assertEquals( "CXL_REJ_REASON", tagData.toFIXNameString() );
            assertEquals( "102", tagData.toFIXIDString() );
            assertEquals( "CxlRejReason", tagData.toFIXDescriptionString() );
