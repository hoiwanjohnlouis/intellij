...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum394BidType;
...
class Tag394EnuBidTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum394BidType oneEnum : Enum394BidType.values()) {
            tagData = new Tag394EnuBidType(oneEnum);
            assertEquals( "FIX394_ENU_BID_TYPE", tagData.toFIXLabelString());
            assertEquals( "394", tagData.toFIXIDString());
            assertEquals( "BID_TYPE", tagData.toFIXNameString());
            assertEquals( "BidType", tagData.toFIXDescriptionString());
