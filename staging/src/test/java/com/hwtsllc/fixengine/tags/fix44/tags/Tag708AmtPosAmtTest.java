...
class Tag708AmtPosAmtTest {
    ...
    double [] TestArray = {
            Tag708AmtPosAmt.TESTA_AMT_POS_AMT,
            Tag708AmtPosAmt.TESTB_AMT_POS_AMT
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            ...
            assertEquals( "708", tagData.toFIXIDString());
            assertEquals( "POS_AMT", tagData.toFIXNameString());
            assertEquals( "PosAmt", tagData.toFIXDescriptionString());
