...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum552NoSides;
...
class Tag552EnuNoSidesTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum552NoSides oneEnum : Enum552NoSides.values()) {
            ...
            assertEquals( "NO_SIDES", tagData.toFIXNameString());
            assertEquals( "NoSides", tagData.toFIXDescriptionString());
