...
class Tag350LenEncodedSecurityDescLenTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag350LenEncodedSecurityDescLen( new MyLengthType( oneElement ));
            assertEquals( "FIX350_LEN_ENCODED_SECURITY_DESC_LEN", tagData.toFIXLabelString());
            assertEquals( "350", tagData.toFIXIDString());
            assertEquals( "ENCODED_SECURITY_DESC_LEN", tagData.toFIXNameString());
            assertEquals( "EncodedSecurityDescLen", tagData.toFIXDescriptionString());
