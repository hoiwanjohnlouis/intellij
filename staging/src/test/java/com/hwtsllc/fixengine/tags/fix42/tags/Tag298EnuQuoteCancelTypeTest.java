...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum298QuoteCancelType;
...
class Tag298EnuQuoteCancelTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum298QuoteCancelType oneEnum : Enum298QuoteCancelType.values()) {
            ...
            assertEquals( "QUOTE_CANCEL_TYPE", tagData.toFIXNameString());
            assertEquals( "QuoteCancelType", tagData.toFIXDescriptionString());
