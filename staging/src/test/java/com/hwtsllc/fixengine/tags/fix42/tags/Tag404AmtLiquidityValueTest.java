...
class Tag404AmtLiquidityValueTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag404AmtLiquidityValue( new MyAmtType( oneElement ));
            assertEquals( "FIX404_AMT_LIQUIDITY_VALUE", tagData.toFIXLabelString());
            assertEquals( "404", tagData.toFIXIDString());
            assertEquals( "LIQUIDITY_VALUE", tagData.toFIXNameString());
            assertEquals( "LiquidityValue", tagData.toFIXDescriptionString());
