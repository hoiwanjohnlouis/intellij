...
class Tag630SeqHopRefIDTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag630SeqHopRefID( new MySeqNumType( oneElement ));
            assertEquals( "FIX630_SEQ_HOP_REF_ID", tagData.toFIXLabelString());
            assertEquals( "630", tagData.toFIXIDString());
            assertEquals( "HOP_REF_ID", tagData.toFIXNameString());
            assertEquals( "HopRefID", tagData.toFIXDescriptionString());
