...
import com.hwtsllc.fixengine.tags.fix41.enums.Enum166SettlLocation;
...
class Tag166EnuSettlLocationTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum166SettlLocation oneEnum : Enum166SettlLocation.values()) {
            ...
            assertEquals( "166", tagData.toFIXIDString());
            assertEquals( "SETTL_LOCATION", tagData.toFIXNameString());
            assertEquals( "SettlLocation (replaced)", tagData.toFIXDescriptionString());
