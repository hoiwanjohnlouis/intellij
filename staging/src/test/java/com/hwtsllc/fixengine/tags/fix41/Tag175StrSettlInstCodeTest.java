...
class Tag175StrSettlInstCodeTest {
    ...
    String [] TestArray = {
            Tag175StrSettlInstCode.TESTA_STR_SETTL_INST_CODE,
            Tag175StrSettlInstCode.TESTB_STR_SETTL_INST_CODE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "175", tagData.toFIXIDString());
            assertEquals( "SETTL_INST_CODE", tagData.toFIXNameString());
            assertEquals( "SettlInstCode (replaced)", tagData.toFIXDescriptionString());
