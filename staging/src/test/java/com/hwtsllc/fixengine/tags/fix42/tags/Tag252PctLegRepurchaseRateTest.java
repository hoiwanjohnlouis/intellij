...
class Tag252PctLegRepurchaseRateTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag252PctLegRepurchaseRate( new MyPercentageType( oneElement ));
            assertEquals( "FIX252_PCT_LEG_REPURCHASE_RATE", tagData.toFIXLabelString());
            assertEquals( "252", tagData.toFIXIDString());
            assertEquals( "LEG_REPURCHASE_RATE", tagData.toFIXNameString());
            assertEquals( "LegRepurchaseRate (Deprecated)", tagData.toFIXDescriptionString());
