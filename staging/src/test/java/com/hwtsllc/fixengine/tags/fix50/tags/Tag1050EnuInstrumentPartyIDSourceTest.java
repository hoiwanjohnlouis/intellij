...
class Tag1050EnuInstrumentPartyIDSourceTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( MyEnumPartyIDSource oneEnum : MyEnumPartyIDSource.values()) {
            ...
            assertEquals( "1050", tagData.toFIXIDString());
            assertEquals( "INSTRUMENT_PARTY_ID_SOURCE", tagData.toFIXNameString());
            assertEquals( "InstrumentPartyIDSource", tagData.toFIXDescriptionString());
