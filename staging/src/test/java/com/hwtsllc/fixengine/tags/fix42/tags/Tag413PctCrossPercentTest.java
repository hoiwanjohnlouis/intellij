...
class Tag413PctCrossPercentTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag413PctCrossPercent( new MyPercentageType( oneElement ));
            assertEquals( "FIX413_PCT_CROSS_PERCENT", tagData.toFIXLabelString());
            assertEquals( "413", tagData.toFIXIDString());
            assertEquals( "CROSS_PERCENT", tagData.toFIXNameString());
            assertEquals( "CrossPercent", tagData.toFIXDescriptionString());
