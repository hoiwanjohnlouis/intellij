...
import com.hwtsllc.fixengine.tags.fix27.enums.Enum71AllocTransType;
...
class Tag71EnuAllocTransTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum71AllocTransType oneEnum : Enum71AllocTransType.values()) {
            ...
            assertEquals( "ALLOC_TRANS_TYPE", tagData.toFIXNameString());
            assertEquals( "71", tagData.toFIXIDString());
            assertEquals( "AllocTransType", tagData.toFIXDescriptionString());
