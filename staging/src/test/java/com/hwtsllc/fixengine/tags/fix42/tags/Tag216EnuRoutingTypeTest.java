...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum216RoutingType;
...
class Tag216EnuRoutingTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum216RoutingType oneEnum : Enum216RoutingType.values()) {
            ...
            assertEquals( "ROUTING_TYPE", tagData.toFIXNameString());
            assertEquals( "RoutingType", tagData.toFIXDescriptionString());
