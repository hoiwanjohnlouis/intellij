...
import com.hwtsllc.fixengine.tags.fix27.enums.Enum29LastCapacity;
...
class Tag29EnuLastCapacityTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum29LastCapacity oneEnum : Enum29LastCapacity.values()) {
            ...
            assertEquals( "LAST_CAPACITY", tagData.toFIXNameString());
            assertEquals( "29", tagData.toFIXIDString());
            assertEquals( "LastCapacity", tagData.toFIXDescriptionString());
