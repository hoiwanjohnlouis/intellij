...
class Tag525EnuNestedPartyIDSourceTest {
    ...
    void FIXHeaderTest() {
        ...
        for (MyEnumPartyIDSource oneEnum : MyEnumPartyIDSource.values()) {
            ...
            assertEquals( "525", tagData.toFIXIDString());
            assertEquals( "NESTED_PARTY_ID_SOURCE", tagData.toFIXNameString());
            assertEquals( "NestedPartyIDSource", tagData.toFIXDescriptionString());
