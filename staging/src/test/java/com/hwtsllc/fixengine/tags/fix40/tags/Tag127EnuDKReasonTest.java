...
import com.hwtsllc.fixengine.tags.fix40.enums.Enum127DKReason;
...
class Tag127EnuDKReasonTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum127DKReason oneEnum : Enum127DKReason.values()) {
            ...
            assertEquals( "DK_REASON", tagData.toFIXNameString() );
            assertEquals( "127", tagData.toFIXIDString());
            assertEquals( "DKReason", tagData.toFIXDescriptionString());
