...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum650LegalConfirm;
...
class Tag650EnuLegalConfirmTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum650LegalConfirm oneEnum : Enum650LegalConfirm.values()) {
            ...
            assertEquals( "650", tagData.toFIXIDString());
            assertEquals( "LEGAL_CONFIRM", tagData.toFIXNameString());
            assertEquals( "LegalConfirm", tagData.toFIXDescriptionString());
