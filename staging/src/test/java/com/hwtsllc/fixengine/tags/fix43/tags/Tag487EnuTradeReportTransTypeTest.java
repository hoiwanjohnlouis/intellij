...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum487TradeReportTransType;
...
class Tag487EnuTradeReportTransTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum487TradeReportTransType oneEnum : Enum487TradeReportTransType.values()) {
            ...
            assertEquals( "487", tagData.toFIXIDString());
            assertEquals( "TRADE_REPORT_TRANS_TYPE", tagData.toFIXNameString());
            assertEquals( "TradeReportTransType", tagData.toFIXDescriptionString());
