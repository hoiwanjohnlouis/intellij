...
class Tag155FloSettlCurrFxRateTest {
    ...
    float [] TestArray = {
            Tag155FloSettlCurrFxRate.TESTA_FLO_SETTL_CURR_FX_RATE,
            Tag155FloSettlCurrFxRate.TESTB_FLO_SETTL_CURR_FX_RATE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( float oneElement : TestArray ) {
            ...
            assertEquals( "SettlCurrFxRate", tagData.toFIXDescriptionString());
