...
class Tag1049EnuInstrmtAssignmentMethodTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( MyEnumAssignmentMethod oneEnum : MyEnumAssignmentMethod.values()) {
            tagData = new Tag1049EnuInstrmtAssignmentMethod(oneEnum);
            assertEquals( "FIX1049_ENU_INSTRMT_ASSIGNMENT_METHOD", tagData.toFIXLabelString());
            assertEquals( "1049", tagData.toFIXIDString());
            assertEquals( "INSTRMT_ASSIGNMENT_METHOD", tagData.toFIXNameString());
            assertEquals( "InstrmtAssignmentMethod", tagData.toFIXDescriptionString());
