...
class Tag30StrLastMktTest {
    ...
    String [] TestArray = {
            Tag30StrLastMkt.TESTA_STR_LAST_MKT,
            Tag30StrLastMkt.TESTB_STR_LAST_MKT
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "LAST_MKT", tagData.toFIXNameString());
            assertEquals( "30", tagData.toFIXIDString());
            assertEquals( "LastMkt", tagData.toFIXDescriptionString());
