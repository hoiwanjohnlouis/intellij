...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum560SecurityRequestResult;
...
class Tag560EnuSecurityRequestResultTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum560SecurityRequestResult oneEnum : Enum560SecurityRequestResult.values()) {
            ...
            assertEquals( "SECURITY_REQUEST_RESULT", tagData.toFIXNameString());
            assertEquals( "SecurityRequestResult", tagData.toFIXDescriptionString());
