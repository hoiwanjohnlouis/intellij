...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1100TriggerType;
...
class Tag1100EnuTriggerTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1100TriggerType oneEnum : Enum1100TriggerType.values()) {
            tagData = new Tag1100EnuTriggerType(oneEnum);
            assertEquals( "FIX1100_ENU_TRIGGER_TYPE", tagData.toFIXLabelString());
            assertEquals( "1100", tagData.toFIXIDString());
            assertEquals( "TRIGGER_TYPE", tagData.toFIXNameString());
            assertEquals( "TriggerType", tagData.toFIXDescriptionString());
