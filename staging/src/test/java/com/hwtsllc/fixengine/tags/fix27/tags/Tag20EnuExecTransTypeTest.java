...
import com.hwtsllc.fixengine.tags.fix27.enums.Enum20ExecTransType;
...
class Tag20EnuExecTransTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum20ExecTransType oneEnum : Enum20ExecTransType.values()) {
            ...
            assertEquals( "EXEC_TRANS_TYPE", tagData.toFIXNameString());
            assertEquals( "20", tagData.toFIXIDString());
            assertEquals( "ExecTransType (replaced)", tagData.toFIXDescriptionString());
