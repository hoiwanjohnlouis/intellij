...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum380BusinessRejectReason;
...
class Tag380EnuBusinessRejectReasonTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum380BusinessRejectReason oneEnum : Enum380BusinessRejectReason.values()) {
            ...
            assertEquals( "BUSINESS_REJECT_REASON", tagData.toFIXNameString());
            assertEquals( "BusinessRejectReason", tagData.toFIXDescriptionString());
