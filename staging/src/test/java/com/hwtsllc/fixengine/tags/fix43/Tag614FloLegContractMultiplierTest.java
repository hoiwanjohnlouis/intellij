...
class Tag614FloLegContractMultiplierTest {
    ...
    float [] TestArray = {
            Tag614FloLegContractMultiplier.TESTA_FLO_LEG_CONTRACT_MULTIPLIER,
            Tag614FloLegContractMultiplier.TESTB_FLO_LEG_CONTRACT_MULTIPLIER
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( float oneElement : TestArray ) {
            ...
            assertEquals( "614", tagData.toFIXIDString());
            assertEquals( "LEG_CONTRACT_MULTIPLIER", tagData.toFIXNameString());
            assertEquals( "LegContractMultiplier", tagData.toFIXDescriptionString());
