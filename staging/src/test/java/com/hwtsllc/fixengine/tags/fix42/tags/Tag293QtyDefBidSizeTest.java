...
class Tag293QtyDefBidSizeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag293QtyDefBidSize( new MyQtyType( oneElement ));
            assertEquals( "FIX293_QTY_DEF_BID_SIZE", tagData.toFIXLabelString());
            assertEquals( "293", tagData.toFIXIDString());
            assertEquals( "DEF_BID_SIZE", tagData.toFIXNameString());
            assertEquals( "DefBidSize", tagData.toFIXDescriptionString());
