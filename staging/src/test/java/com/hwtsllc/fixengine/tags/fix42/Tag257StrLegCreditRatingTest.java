...
class Tag257StrLegCreditRatingTest {
    ...
    String [] TestArray = {
            Tag257StrLegCreditRating.TESTA_STR_LEG_CREDIT_RATING,
            Tag257StrLegCreditRating.TESTB_STR_LEG_CREDIT_RATING
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "257", tagData.toFIXIDString());
            assertEquals( "LEG_CREDIT_RATING", tagData.toFIXNameString());
            assertEquals( "LegCreditRating", tagData.toFIXDescriptionString());
