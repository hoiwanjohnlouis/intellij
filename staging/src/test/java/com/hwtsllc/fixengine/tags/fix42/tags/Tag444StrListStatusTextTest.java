...
class Tag444StrListStatusTextTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag444StrListStatusText( new MyStringType( oneElement ));
            assertEquals( "FIX444_STR_LIST_STATUS_TEXT", tagData.toFIXLabelString());
            assertEquals( "444", tagData.toFIXIDString());
            assertEquals( "LIST_STATUS_TEXT", tagData.toFIXNameString());
            assertEquals( "ListStatusText", tagData.toFIXDescriptionString());
