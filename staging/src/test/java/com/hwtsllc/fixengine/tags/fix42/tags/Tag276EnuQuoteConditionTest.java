...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum276QuoteCondition;
...
class Tag276EnuQuoteConditionTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum276QuoteCondition oneEnum : Enum276QuoteCondition.values()) {
            ...
            assertEquals( "QUOTE_CONDITION", tagData.toFIXNameString());
            assertEquals( "QuoteCondition", tagData.toFIXDescriptionString());
