...
class Tag555NumNoLegsTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag555NumNoLegs( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX555_NUM_NO_LEGS", tagData.toFIXLabelString());
            assertEquals( "555", tagData.toFIXIDString());
            assertEquals( "NO_LEGS", tagData.toFIXNameString());
            assertEquals( "NoLegs", tagData.toFIXDescriptionString());
