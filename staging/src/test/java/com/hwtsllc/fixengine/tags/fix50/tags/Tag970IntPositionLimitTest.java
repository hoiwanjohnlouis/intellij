...
class Tag970IntPositionLimitTest {
    ...
    int [] TestArray = {
            Tag970IntPositionLimit.TESTA_INT_POSITION_LIMIT,
            Tag970IntPositionLimit.TESTB_INT_POSITION_LIMIT
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "970", tagData.toFIXIDString());
            assertEquals( "POSITION_LIMIT", tagData.toFIXNameString());
            assertEquals( "PositionLimit", tagData.toFIXDescriptionString());
