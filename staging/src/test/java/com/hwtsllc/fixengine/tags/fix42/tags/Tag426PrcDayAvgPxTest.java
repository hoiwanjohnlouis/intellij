...
class Tag426PrcDayAvgPxTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag426PrcDayAvgPx( new MyPriceType( oneElement ));
            assertEquals( "FIX426_PRC_DAY_AVG_PX", tagData.toFIXLabelString());
            assertEquals( "426", tagData.toFIXIDString());
            assertEquals( "DAY_AVG_PX", tagData.toFIXNameString());
            assertEquals( "DayAvgPx", tagData.toFIXDescriptionString());
