...
import com.hwtsllc.fixengine.tags.fix41.enums.Enum208NotifyBrokerOfCredit;
...
class Tag208EnuNotifyBrokerOfCreditTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum208NotifyBrokerOfCredit oneEnum : Enum208NotifyBrokerOfCredit.values()) {
            ...
            assertEquals( "208", tagData.toFIXIDString());
            assertEquals( "NOTIFY_BROKER_OF_CREDIT", tagData.toFIXNameString());
            assertEquals( "NotifyBrokerOfCredit", tagData.toFIXDescriptionString());
