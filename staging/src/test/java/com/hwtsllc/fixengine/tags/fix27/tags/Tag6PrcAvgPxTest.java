...
class Tag6PrcAvgPxTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            tagData = new Tag6PrcAvgPx( new MyPriceType( oneElement ));
            assertEquals( "FIX6_PRC_AVG_PX", tagData.toFIXLabelString());
            assertEquals( "AVG_PX", tagData.toFIXNameString());
            assertEquals( "6", tagData.toFIXIDString());
            assertEquals( "AvgPx", tagData.toFIXDescriptionString());
