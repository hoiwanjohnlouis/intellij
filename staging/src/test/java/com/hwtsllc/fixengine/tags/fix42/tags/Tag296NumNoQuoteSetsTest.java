...
class Tag296NumNoQuoteSetsTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag296NumNoQuoteSets( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX296_NUM_NO_QUOTE_SETS", tagData.toFIXLabelString());
            assertEquals( "296", tagData.toFIXIDString());
            assertEquals( "NO_QUOTE_SETS", tagData.toFIXNameString());
            assertEquals( "NoQuoteSets", tagData.toFIXDescriptionString());
