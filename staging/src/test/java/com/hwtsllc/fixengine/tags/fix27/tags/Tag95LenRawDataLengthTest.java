...
class Tag95LenRawDataLengthTest {
    ...
    int [] TestArray = {
            Tag95LenRawDataLength.TESTA_LEN_RAW_DATA_LENGTH,
            Tag95LenRawDataLength.TESTB_LEN_RAW_DATA_LENGTH
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "RawDataLength", tagData.toFIXDescriptionString());
