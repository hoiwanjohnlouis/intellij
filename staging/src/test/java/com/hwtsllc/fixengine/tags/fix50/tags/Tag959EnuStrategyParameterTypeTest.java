...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum959StrategyParameterType;
...
class Tag959EnuStrategyParameterTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum959StrategyParameterType oneEnum : Enum959StrategyParameterType.values()) {
            ...
            assertEquals( "STRATEGY_PARAMETER_TYPE", tagData.toFIXNameString());
            assertEquals( "StrategyParameterType", tagData.toFIXDescriptionString());
