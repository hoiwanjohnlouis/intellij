...
class Tag538EnuNestedPartyRoleTest {
    ...
    void FIXHeaderTest() {
        ...
        for (MyEnumPartyRole oneEnum : MyEnumPartyRole.values()) {
            tagData = new Tag538EnuNestedPartyRole(oneEnum);
            assertEquals( "FIX538_ENU_NESTED_PARTY_ROLE", tagData.toFIXLabelString());
            assertEquals( "538", tagData.toFIXIDString());
            assertEquals( "NESTED_PARTY_ROLE", tagData.toFIXNameString());
            assertEquals( "NestedPartyRole", tagData.toFIXDescriptionString());
