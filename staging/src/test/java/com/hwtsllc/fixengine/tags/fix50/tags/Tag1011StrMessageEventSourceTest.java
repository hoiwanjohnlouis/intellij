...
class Tag1011StrMessageEventSourceTest {
    ...
    String [] TestArray = {
            Tag1011StrMessageEventSource.TESTA_STR_MESSAGE_EVENT_SOURCE,
            Tag1011StrMessageEventSource.TESTB_STR_MESSAGE_EVENT_SOURCE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "MessageEventSource", tagData.toFIXDescriptionString());
