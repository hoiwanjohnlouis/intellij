...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum559SecurityListRequestType;
...
class Tag559EnuSecurityListRequestTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum559SecurityListRequestType oneEnum : Enum559SecurityListRequestType.values()) {
            ...
            assertEquals( "559", tagData.toFIXIDString());
            assertEquals( "SECURITY_LIST_REQUEST_TYPE", tagData.toFIXNameString());
            assertEquals( "SecurityListRequestType", tagData.toFIXDescriptionString());
