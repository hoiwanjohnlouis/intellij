...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum550CrossPrioritization;
...
class Tag550EnuCrossPrioritizationTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum550CrossPrioritization oneEnum : Enum550CrossPrioritization.values()) {
            ...
            assertEquals( "CROSS_PRIORITIZATION", tagData.toFIXNameString());
            assertEquals( "CrossPrioritization", tagData.toFIXDescriptionString());
