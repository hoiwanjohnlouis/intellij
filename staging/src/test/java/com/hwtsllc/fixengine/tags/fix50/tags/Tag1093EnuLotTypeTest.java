...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1093LotType;
...
class Tag1093EnuLotTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1093LotType oneEnum : Enum1093LotType.values()) {
            ...
            assertEquals( "LOT_TYPE", tagData.toFIXNameString());
            assertEquals( "LotType", tagData.toFIXDescriptionString());
