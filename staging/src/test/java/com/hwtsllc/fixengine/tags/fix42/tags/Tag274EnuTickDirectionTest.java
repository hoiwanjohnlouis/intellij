...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum274TickDirection;
...
class Tag274EnuTickDirectionTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum274TickDirection oneEnum : Enum274TickDirection.values()) {
            ...
            assertEquals( "TICK_DIRECTION", tagData.toFIXNameString());
            assertEquals( "TickDirection", tagData.toFIXDescriptionString());
