...
class Tag182StrCashSettlAgentNameTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "182", tagData.toFIXIDString());
            assertEquals( "CASH_SETTL_AGENT_NAME", tagData.toFIXNameString());
            assertEquals( "CashSettlAgentName (replaced)", tagData.toFIXDescriptionString());
