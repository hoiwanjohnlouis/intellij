...
class Tag499StrCashDistribAgentCodeTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "499", tagData.toFIXIDString());
            assertEquals( "CASH_DISTRIB_AGENT_CODE", tagData.toFIXNameString());
            assertEquals( "CashDistribAgentCode", tagData.toFIXDescriptionString());
