...
class Tag199NumNoIOIQualifiersTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag199NumNoIOIQualifiers( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX199_NUM_NO_IOI_QUALIFIERS", tagData.toFIXLabelString());
            assertEquals( "199", tagData.toFIXIDString());
            assertEquals( "NO_IOI_QUALIFIERS", tagData.toFIXNameString());
            assertEquals( "NoIOIQualifiers", tagData.toFIXDescriptionString());
