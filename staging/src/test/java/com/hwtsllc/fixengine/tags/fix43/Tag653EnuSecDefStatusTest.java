...
import com.hwtsllc.fixengine.enums.fix43.Enum653SecDefStatus;
...
class Tag653EnuSecDefStatusTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum653SecDefStatus oneEnum : Enum653SecDefStatus.values()) {
            ...
            assertEquals( "SEC_DEF_STATUS", tagData.toFIXNameString());
            assertEquals( "SecDefStatus (replaced)", tagData.toFIXDescriptionString());
