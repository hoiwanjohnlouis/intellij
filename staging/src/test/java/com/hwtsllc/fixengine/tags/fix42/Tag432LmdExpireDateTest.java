...
class Tag432LmdExpireDateTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag432LmdExpireDate( new MyLocalMktDateType( oneElement ));
            assertEquals( "FIX432_LMD_EXPIRE_DATE", tagData.toFIXLabelString());
            assertEquals( "432", tagData.toFIXIDString());
            assertEquals( "EXPIRE_DATE", tagData.toFIXNameString());
            assertEquals( "ExpireDate", tagData.toFIXDescriptionString());
