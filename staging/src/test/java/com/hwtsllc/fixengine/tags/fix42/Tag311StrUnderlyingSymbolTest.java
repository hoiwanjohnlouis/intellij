...
class Tag311StrUnderlyingSymbolTest {
    ...
    String [] TestArray = {
            Tag311StrUnderlyingSymbol.TESTA_STR_UNDERLYING_SYMBOL,
            Tag311StrUnderlyingSymbol.TESTB_STR_UNDERLYING_SYMBOL
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "311", tagData.toFIXIDString());
            assertEquals( "UNDERLYING_SYMBOL", tagData.toFIXNameString());
            assertEquals( "UnderlyingSymbol", tagData.toFIXDescriptionString());
