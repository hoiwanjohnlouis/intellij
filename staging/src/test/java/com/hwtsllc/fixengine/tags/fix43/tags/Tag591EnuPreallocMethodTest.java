...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum591PreallocMethod;
...
class Tag591EnuPreallocMethodTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum591PreallocMethod oneEnum : Enum591PreallocMethod.values()) {
            ...
            assertEquals( "PREALLOC_METHOD", tagData.toFIXNameString());
            assertEquals( "PreallocMethod", tagData.toFIXDescriptionString());
