...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum529OrderRestrictions;
...
class Tag529EnuOrderRestrictionsTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum529OrderRestrictions oneEnum : Enum529OrderRestrictions.values()) {
            ...
            assertEquals( "529", tagData.toFIXIDString());
            assertEquals( "ORDER_RESTRICTIONS", tagData.toFIXNameString());
            assertEquals( "OrderRestrictions", tagData.toFIXDescriptionString());
