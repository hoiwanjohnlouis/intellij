...
class Tag244IntUnderlyingRepurchaseTermTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "244", tagData.toFIXIDString());
            assertEquals( "UNDERLYING_REPURCHASE_TERM", tagData.toFIXNameString());
            assertEquals( "UnderlyingRepurchaseTerm (Deprecated)", tagData.toFIXDescriptionString());
