...
class Tag151QtyLeavesQtyTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag151QtyLeavesQty( new MyQtyType( oneElement ));
            assertEquals( "FIX151_QTY_LEAVES_QTY", tagData.toFIXLabelString());
            assertEquals( "151", tagData.toFIXIDString());
            assertEquals( "LEAVES_QTY", tagData.toFIXNameString());
            assertEquals( "LeavesQty", tagData.toFIXDescriptionString());
