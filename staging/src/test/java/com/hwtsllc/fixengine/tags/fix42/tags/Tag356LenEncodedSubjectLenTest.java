...
class Tag356LenEncodedSubjectLenTest {
    ...
    int [] TestArray = {
            Tag356LenEncodedSubjectLen.TESTA_LEN_ENCODED_SUBJECT_LEN,
            Tag356LenEncodedSubjectLen.TESTB_LEN_ENCODED_SUBJECT_LEN
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "EncodedSubjectLen", tagData.toFIXDescriptionString());
