...
class Tag316PrcUnderlyingStrikePriceTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            ...
            assertEquals( "316", tagData.toFIXIDString());
            assertEquals( "UNDERLYING_STRIKE_PRICE", tagData.toFIXNameString());
            assertEquals( "UnderlyingStrikePrice", tagData.toFIXDescriptionString());
