...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum385MsgDirection;
...
class Tag385EnuMsgDirectionTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum385MsgDirection oneEnum : Enum385MsgDirection.values()) {
            ...
            assertEquals( "MSG_DIRECTION", tagData.toFIXNameString());
            assertEquals( "MsgDirection", tagData.toFIXDescriptionString());
