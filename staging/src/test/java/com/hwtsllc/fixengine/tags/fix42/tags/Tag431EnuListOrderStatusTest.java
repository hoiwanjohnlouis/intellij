...
import com.hwtsllc.fixengine.tags.fix42.enums.Enum431ListOrderStatus;
...
class Tag431EnuListOrderStatusTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum431ListOrderStatus oneEnum : Enum431ListOrderStatus.values()) {
            ...
            assertEquals( "LIST_ORDER_STATUS", tagData.toFIXNameString());
            assertEquals( "ListOrderStatus", tagData.toFIXDescriptionString());
