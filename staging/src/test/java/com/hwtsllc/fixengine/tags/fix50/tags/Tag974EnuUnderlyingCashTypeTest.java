...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum974UnderlyingCashType;
...
class Tag974EnuUnderlyingCashTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum974UnderlyingCashType oneEnum : Enum974UnderlyingCashType.values()) {
            tagData = new Tag974EnuUnderlyingCashType(oneEnum);
            assertEquals( "FIX974_ENU_UNDERLYING_CASH_TYPE", tagData.toFIXLabelString());
            assertEquals( "974", tagData.toFIXIDString());
            assertEquals( "UNDERLYING_CASH_TYPE", tagData.toFIXNameString());
            assertEquals( "UnderlyingCashType", tagData.toFIXDescriptionString());
