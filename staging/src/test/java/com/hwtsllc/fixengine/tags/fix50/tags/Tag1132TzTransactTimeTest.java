...
import com.hwtsllc.fixengine2022.datatypes.MyTZTimestampType;
...
class Tag1132TzTransactTimeTest {
    ...
    String [] TestArray = {
            Tag1132TzTransactTime.TESTA_TZ_TRANSACT_TIME,
            Tag1132TzTransactTime.TESTB_TZ_TRANSACT_TIME
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "TZTransactTime", tagData.toFIXDescriptionString());
    ...
    void TagToStringTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertNotEquals( MyTestValues.JUNK_TZT_DATA_VALUE, tagData.toString());
        }
    }
    @Test
