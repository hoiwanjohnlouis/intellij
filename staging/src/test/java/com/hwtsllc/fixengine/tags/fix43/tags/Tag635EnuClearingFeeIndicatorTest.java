...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum635ClearingFeeIndicator;
...
class Tag635EnuClearingFeeIndicatorTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum635ClearingFeeIndicator oneEnum : Enum635ClearingFeeIndicator.values()) {
            ...
            assertEquals( "CLEARING_FEE_INDICATOR", tagData.toFIXNameString());
            assertEquals( "ClearingFeeIndicator", tagData.toFIXDescriptionString());
