...
import com.hwtsllc.fixengine.enums.fix42.Enum427GTBookingInst;
...
class Tag427EnuGTBookingInstTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum427GTBookingInst oneEnum : Enum427GTBookingInst.values()) {
            ...
            assertEquals( "427", tagData.toFIXIDString());
            assertEquals( "GT_BOOKING_INST", tagData.toFIXNameString());
            assertEquals( "GTBookingInst", tagData.toFIXDescriptionString());
