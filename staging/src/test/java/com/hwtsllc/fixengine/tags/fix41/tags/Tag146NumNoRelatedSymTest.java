...
class Tag146NumNoRelatedSymTest {
    ...
    int [] TestArray = {
            Tag146NumNoRelatedSym.TESTA_NUM_NO_RELATED_SYM,
            Tag146NumNoRelatedSym.TESTB_NUM_NO_RELATED_SYM
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            ...
            assertEquals( "146", tagData.toFIXIDString());
            assertEquals( "NO_RELATED_SYM", tagData.toFIXNameString());
            assertEquals( "NoRelatedSym", tagData.toFIXDescriptionString());
