...
class Tag628StrHopCompIDTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag628StrHopCompID( new MyStringType( oneElement ));
            assertEquals( "FIX628_STR_HOP_COMP_ID", tagData.toFIXLabelString());
            assertEquals( "628", tagData.toFIXIDString());
            assertEquals( "HOP_COMP_ID", tagData.toFIXNameString());
            assertEquals( "HopCompID", tagData.toFIXDescriptionString());
