...
class Tag1087QtyDisplayMinIncrTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag1087QtyDisplayMinIncr( new MyQtyType( oneElement ));
            assertEquals( "FIX1087_QTY_DISPLAY_MIN_INCR", tagData.toFIXLabelString());
            assertEquals( "1087", tagData.toFIXIDString());
            assertEquals( "DISPLAY_MIN_INCR", tagData.toFIXNameString());
            assertEquals( "DisplayMinIncr", tagData.toFIXDescriptionString());
