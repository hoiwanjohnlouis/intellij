...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum636WorkingIndicator;
...
class Tag636EnuWorkingIndicatorTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum636WorkingIndicator oneEnum : Enum636WorkingIndicator.values()) {
            tagData = new Tag636EnuWorkingIndicator(oneEnum);
            assertEquals( "FIX636_ENU_WORKING_INDICATOR", tagData.toFIXLabelString());
            assertEquals( "636", tagData.toFIXIDString());
            assertEquals( "WORKING_INDICATOR", tagData.toFIXNameString());
            assertEquals( "WorkingIndicator", tagData.toFIXDescriptionString());
