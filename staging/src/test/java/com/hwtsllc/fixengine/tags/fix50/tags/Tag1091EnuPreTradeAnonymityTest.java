...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1091PreTradeAnonymity;
...
class Tag1091EnuPreTradeAnonymityTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1091PreTradeAnonymity oneEnum : Enum1091PreTradeAnonymity.values()) {
            tagData = new Tag1091EnuPreTradeAnonymity(oneEnum);
            assertEquals( "FIX1091_ENU_PRE_TRADE_ANONYMITY", tagData.toFIXLabelString());
            assertEquals( "1091", tagData.toFIXIDString());
            assertEquals( "PRE_TRADE_ANONYMITY", tagData.toFIXNameString());
            assertEquals( "PreTradeAnonymity", tagData.toFIXDescriptionString());
