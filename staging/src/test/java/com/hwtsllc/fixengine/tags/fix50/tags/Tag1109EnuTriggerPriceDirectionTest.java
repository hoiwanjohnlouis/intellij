...
import com.hwtsllc.fixengine.tags.fix50.enums.Enum1109TriggerPriceDirection;
...
class Tag1109EnuTriggerPriceDirectionTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( Enum1109TriggerPriceDirection oneEnum : Enum1109TriggerPriceDirection.values()) {
            ...
            assertEquals( "1109", tagData.toFIXIDString());
            assertEquals( "TRIGGER_PRICE_DIRECTION", tagData.toFIXNameString());
            assertEquals( "TriggerPriceDirection", tagData.toFIXDescriptionString());
