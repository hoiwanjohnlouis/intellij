...
class Tag451PxoNetChgPrevDayTest {
    ...
    double [] TestArray = {
            Tag451PxoNetChgPrevDay.TESTA_PXO_NET_CHG_PREV_DAY,
            Tag451PxoNetChgPrevDay.TESTB_PXO_NET_CHG_PREV_DAY
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( double oneElement : TestArray ) {
            ...
            assertEquals( "451", tagData.toFIXIDString());
            assertEquals( "NET_CHG_PREV_DAY", tagData.toFIXNameString());
            assertEquals( "NetChgPrevDay", tagData.toFIXDescriptionString());
