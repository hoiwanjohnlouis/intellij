...
import com.hwtsllc.fixengine.tags.fix43.enums.Enum585MassStatusReqType;
...
class Tag585EnuMassStatusReqTypeTest {
    ...
    void FIXHeaderTest() {
        ...
        for (Enum585MassStatusReqType oneEnum : Enum585MassStatusReqType.values()) {
            ...
            assertEquals( "MASS_STATUS_REQ_TYPE", tagData.toFIXNameString());
            assertEquals( "MassStatusReqType", tagData.toFIXDescriptionString());
