...
class Tag73NumNoOrdersTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( int oneElement : TestArray ) {
            tagData = new Tag73NumNoOrders( new MyNumInGroupType( oneElement ));
            assertEquals( "FIX73_NUM_NO_ORDERS", tagData.toFIXLabelString());
            assertEquals( "NO_ORDERS", tagData.toFIXNameString());
            assertEquals( "73", tagData.toFIXIDString());
            assertEquals( "NoOrders", tagData.toFIXDescriptionString());
