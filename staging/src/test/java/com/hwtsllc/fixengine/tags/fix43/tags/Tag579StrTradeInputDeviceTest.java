...
class Tag579StrTradeInputDeviceTest {
    ...
    String [] TestArray = {
            Tag579StrTradeInputDevice.TESTA_STR_TRADE_INPUT_DEVICE,
            Tag579StrTradeInputDevice.TESTB_STR_TRADE_INPUT_DEVICE
    };
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            ...
            assertEquals( "579", tagData.toFIXIDString());
            assertEquals( "TRADE_INPUT_DEVICE", tagData.toFIXNameString());
            assertEquals( "TradeInputDevice", tagData.toFIXDescriptionString());
