...
class Tag379StrBusinessRejectRefIDTest {
    ...
    void FIXHeaderTest() {
        ...
        for ( String oneElement : TestArray ) {
            tagData = new Tag379StrBusinessRejectRefID( new MyStringType( oneElement ));
            assertEquals( "FIX379_STR_BUSINESS_REJECT_REF_ID", tagData.toFIXLabelString());
            assertEquals( "379", tagData.toFIXIDString());
            assertEquals( "BUSINESS_REJECT_REF_ID", tagData.toFIXNameString());
            assertEquals( "BusinessRejectRefID", tagData.toFIXDescriptionString());
